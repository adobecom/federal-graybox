var yn=async n=>{let{placeholders:e}=n,{locale:r}=C(),a=`${X()}${r.prefix}/federal/globalnav/placeholders.json`,[i,o]=await Promise.all([e,ce(a)]);return new Map([...o,...i])},ce=async n=>{try{let e=await fetch(n);if(!e.ok)throw new f(`Federal placeholders not found at ${n}`);let r=pe(await e.json());if(r instanceof f)throw r;return new Map(r.data.map(({key:t,value:a})=>[t,a]))}catch(e){if(e instanceof f)console.error(e.message);else{let r=new f(e.message);console.error(r.message)}return L(`Failed to fetch placeholders from ${n}`),new Map([])}},pe=n=>{try{let{data:e}=n;if(!e.every(({key:t,value:a})=>typeof t=="string"&&typeof a=="string"))throw new Error("data is not valid");return n}catch(e){return new f(e.message)}};function xn(n,e){let r=/{{(.*?)}}|%7B%7B(.*?)%7D%7D/g;return r.test(n)?n.replace(r,(a,i,o)=>{let s=i??o??"";return e.get(s)??s}):n}var[wn,kn]=(()=>{let n;return[e=>{n||(n=e)},()=>{if(!n)throw new Error("Placeholders not initialized. Call setPlaceholders() first.");return n}]})();var A=window.matchMedia("(min-width: 1024px)"),$={brand:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" id="Layer_1" viewBox="0 0 64.57 35"><defs><style>.cls-1{fill: #eb1000;}</style></defs><path class="cls-1" d="M6.27,10.22h4.39l6.2,14.94h-4.64l-3.92-9.92-2.59,6.51h3.08l1.23,3.41H0l6.27-14.94ZM22.03,13.32c.45,0,.94.04,1.43.16v-3.7h3.88v14.72c-.89.4-2.81.89-4.73.89-3.48,0-6.47-1.98-6.47-5.93s2.88-6.13,5.89-6.13ZM22.52,22.19c.36,0,.65-.07.94-.16v-5.42c-.29-.11-.58-.16-.96-.16-1.27,0-2.45.94-2.45,2.92s1.2,2.81,2.47,2.81ZM34.25,13.32c3.23,0,5.98,2.18,5.98,6.02s-2.74,6.02-5.98,6.02-6-2.18-6-6.02,2.72-6.02,6-6.02ZM34.25,22.13c1.11,0,2.14-.89,2.14-2.79s-1.03-2.79-2.14-2.79-2.12.89-2.12,2.79.96,2.79,2.12,2.79ZM41.16,9.78h3.9v3.7c.47-.09.96-.16,1.45-.16,3.03,0,5.84,1.98,5.84,5.86,0,4.1-2.99,6.18-6.53,6.18-1.52,0-3.46-.31-4.66-.87v-14.72ZM45.91,22.17c1.34,0,2.56-.96,2.56-2.94,0-1.85-1.2-2.72-2.5-2.72-.36,0-.65.04-.91.16v5.35c.22.09.51.16.85.16ZM58.97,13.32c2.92,0,5.6,1.87,5.6,5.64,0,.51-.02,1-.09,1.49h-7.27c.4,1.32,1.56,1.94,3.01,1.94,1.18,0,2.27-.29,3.5-.82v2.97c-1.14.58-2.5.82-3.9.82-3.7,0-6.58-2.23-6.58-6.02s2.61-6.02,5.73-6.02ZM60.93,18.02c-.2-1.27-1.05-1.78-1.92-1.78s-1.58.54-1.87,1.78h3.79Z"/></svg>',company:'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="22" viewBox="0 0 24 22" fill="none"><path d="M14.2353 21.6209L12.4925 16.7699H8.11657L11.7945 7.51237L17.3741 21.6209H24L15.1548 0.379395H8.90929L0 21.6209H14.2353Z" fill="#EB1000"/></svg>',search:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" focusable="false"><path d="M14 2A8 8 0 0 0 7.4 14.5L2.4 19.4a1.5 1.5 0 0 0 2.1 2.1L9.5 16.6A8 8 0 1 0 14 2Zm0 14.1A6.1 6.1 0 1 1 20.1 10 6.1 6.1 0 0 1 14 16.1Z"></path></svg>',home:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" height="25" viewBox="0 0 18 18" width="25"><path fill="#6E6E6E" d="M17.666,10.125,9.375,1.834a.53151.53151,0,0,0-.75,0L.334,10.125a.53051.53051,0,0,0,0,.75l.979.9785A.5.5,0,0,0,1.6665,12H2v4.5a.5.5,0,0,0,.5.5h4a.5.5,0,0,0,.5-.5v-5a.5.5,0,0,1,.5-.5h3a.5.5,0,0,1,.5.5v5a.5.5,0,0,0,.5.5h4a.5.5,0,0,0,.5-.5V12h.3335a.5.5,0,0,0,.3535-.1465l.979-.9785A.53051.53051,0,0,0,17.666,10.125Z"/></svg>',chevronLeft:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" focusable="false"><path d="M12.5 4l-5 6 5 6" stroke="currentColor" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>',chevronRight:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="3" height="6" viewBox="0 0 3 6" focusable="false"><path d="M.5.5 2.5 3 .5 5.5" stroke="currentColor" stroke-width="1" fill="none"/></svg>',chevronDown:'<svg class="chevron-down" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="6" height="3.375" viewBox="0 0 6 3.375" focusable="false"><path d="M.5.5 3 2.875 5.5.5" stroke="currentColor" stroke-width="1" fill="none"/></svg>'},ge=["/tools/ost?","/miniplans"],Cn=n=>ge.some(e=>n.includes(e));var Ln=n=>{let e=[],r=n.nextElementSibling??null;for(;r!==null;)e.push(r),r=r.nextElementSibling??null;return e},j=n=>({eval:n,or:e=>j(r=>{try{return n(r)}catch{return e(r)}})}),S=(n,e)=>n.reduce(([r,t],a)=>{try{let[i,o]=e(a);return[[...r,i],[...t,...o]]}catch(i){return i instanceof c?[r,[i,...t]]:[r,t]}},[[],[]]),[En,ue]=(()=>{let n,e=!1;return[r=>{e||(n=r,e=!0)},()=>{if(!n)throw new Error("PersonalizationConfig not initialized. Call setPersonalizationConfig() first.");return n}]})(),[Tn,Sn]=(()=>{let n=e=>e;return[e=>{n=e},()=>n]})(),E=n=>{try{return Sn()(n)}catch{return n}},D=async n=>{try{if(n===null)return new c("URL is null");let e=`${n.origin}${n.pathname.replace(/(\.html$|$)/,".plain.html")}${n.hash}`,r=Sn()(e),t=R(r),a=await fetch(t);if(!a.ok)return L(`Request for ${t} failed`),new c(`Request for ${t} failed`);let i=await a.text(),o=await kn(),s=xn(i,o),{body:l}=new DOMParser().parseFromString(s,"text/html");try{let{handleCommands:d,commands:v}=ue();d(v,l)}catch(d){L(`Personalization not applied: ${d?.message}`)}return l}catch(e){return new c(e?.message)}},z,X=()=>{if(z)return z;let n=["https://www.adobe.com","https://business.adobe.com","https://blog.adobe.com","https://milo.adobe.com","https://news.adobe.com","graybox.adobe.com"];if(z)return z;let e=window.location.origin;z=n.some(a=>{let i=e.replace(".stage","");return a.startsWith("https://")?i===a:i.endsWith(a)})?e:"https://www.adobe.com";let t=window.location.hostname.includes(".aem.")?"aem":"hlx";return(e.includes("localhost")||e.includes(`.${t}.`))&&(z=`https://main--federal--adobecom.aem.${e.endsWith(".live")?"live":"page"}`),z},R=(n="")=>{if(n.includes("c2-poc--milo--adobecom"))return n.replace("c2-poc--milo--adobecom","main--federal--adobecom");if(n.includes("c2-poc-feds-gnav--milo--adobecom"))return n.replace("c2-poc-feds-gnav--milo--adobecom","main--federal--adobecom");if(n.includes("localhost:3000"))return n.replace("localhost:3000","main--federal--adobecom.aem.page");if(typeof n!="string"||!n.includes("/federal/"))return n;if(n.startsWith("/"))return`${X()}${n}`;try{let{pathname:e,search:r,hash:t}=new URL(n);return`${X()}${e}${r}${t}`}catch(e){let r=e instanceof Error?e.message:String(e);console.warn(`getFederatedUrl errored parsing the URL: ${n}: ${r}`)}return n},Mn=(n,e)=>{let r=(t,a)=>{let i=`${t}[${a}^="./media_"]`;e.querySelectorAll(i).forEach(s=>{let l=s.getAttribute(a);if(!(l===null||l===""))try{let d=R(new URL(l,new URL(n,window.location.href)).href);s.setAttribute(a,d)}catch(d){console.warn(`[MediaPathError]: Failed to process relative media path (${l}) for ${t}`,d)}})};r("img","src"),r("source","srcset")},Pn=async n=>{let e=async(r,t)=>{if(r instanceof c)return r;try{let i=[...r.querySelectorAll('a[href*="#_inline"]')].map(async o=>{try{if(t.has(o.href))return;let s=R(o.href),l=new URL(s),d=await D(l);if(t.add(o.href),d instanceof c)throw d;await e(d,t),o.replaceWith(...d.children);return}catch{return}},[]);return await Promise.all(i),r}catch(a){return new c(JSON.stringify(a))}};return e(n,new Set)},An=(n,e)=>n.map((r,t)=>`<li>${e(r,t)}</li>`).join(""),K=n=>{let e=n.normalize("NFKC").toLocaleLowerCase().trim().replace(/[^\p{L}\p{N}\p{M}]+/gu,"-").replace(/^-+|-+$/g,"");return e===""?"id":/^\p{N}/u.test(e)?`id-${e}`:e},k=(n,e)=>{let r=n!==null&&n!==""?` daa-lh="${n}"`:"",t=e!==null&&e!==""?` daa-ll="${e}"`:"";return`${r}${t}`};function fe(n,{id:e,as:r,callback:t,crossorigin:a,rel:i,fetchpriority:o}={rel:"stylesheet"}){let s=document.head.querySelector(`link[href="${n}"]`);if(s)return t?.("noop"),s;let l=document.createElement("link");return l.setAttribute("rel",i),e!==void 0&&l.setAttribute("id",e),r!==void 0&&l.setAttribute("as",r),a!==void 0&&l.setAttribute("crossorigin",a),o!==void 0&&l.setAttribute("fetchpriority",o),l.setAttribute("href",n),t&&(l.onload=d=>t(d.type),l.onerror=d=>t(typeof d=="string"?"error":d.type)),document.head.appendChild(l),l}function me(n,e){return fe(n,{rel:"stylesheet",callback:e})}function on(n,e=!1){e&&me(n)}var sn=(n,e,{mode:r,id:t}={})=>new Promise((a,i)=>{let o=document.querySelector(`head > script[src="${n}"]`);if(!o){let{head:d}=document;o=document.createElement("script"),o.setAttribute("src",n),t!=null&&o.setAttribute("id",t),e!=null&&o.setAttribute("type",e),r&&["async","defer"].includes(r)&&o.setAttribute(r,""),d.append(o)}let s=o.dataset.loaded;if(s!=null){a(o);return}let l=d=>{o.removeEventListener("load",l),o.removeEventListener("error",l),d.type==="error"?i(new Error(`error loading script: ${o.src}`)):d.type==="load"&&(o.dataset.loaded="true",a(o))};o.addEventListener("load",l),o.addEventListener("error",l)});function N(n,e=document){let r=n&&n.includes(":")?"property":"name";return e.head.querySelector(`meta[${r}="${n}"]`)?.content??null}var ve=n=>{let e=n,r=i=>i==null||typeof i!="object";if(r(e)||r(e.locale)||typeof e.locale.prefix!="string"||r(e.env)||typeof e.env.name!="string")return!1;if(e.unav!==void 0){if(typeof e.unav!="object"||e.unav===null)return!1;let i=e.unav;if(i.profile!==void 0){if(typeof i.profile!="object"||i.profile===null)return!1;let o=i.profile;if(o.signInCtaStyle!==void 0&&o.signInCtaStyle!=="primary"&&o.signInCtaStyle!=="secondary"||o.messageEventListener!==void 0&&typeof o.messageEventListener!="function")return!1}}return!(e.jarvis!==void 0&&(typeof e.jarvis!="object"||e.jarvis===null||typeof e.jarvis.id!="string"))},[ln,C]=(()=>{let n,e=!1;return[r=>{if(!e){if(!ve(r))throw new Error("MiloConfig validation failed: Invalid structure");n=r,e=!0}},()=>{if(!n)throw new Error("MiloConfig not initialized. Call setMiloConfig() first.");return n}]})(),he={en:"US","en-gb":"GB","es-mx":"MX","fr-ca":"CA",da:"DK",et:"EE",ar:"DZ",el:"GR",iw:"IL",he:"IL",id:"ID",ms:"MY",nb:"NO",sl:"SI",sv:"SE",cs:"CZ",uk:"UA",hi:"IN","zh-hans":"CN","zh-hant":"TW",ja:"JP",ko:"KR",fil:"PH",th:"TH",vi:"VN"},_n={ar:"AR_es",be_en:"BE_en",be_fr:"BE_fr",be_nl:"BE_nl",br:"BR_pt",ca:"CA_en",ch_de:"CH_de",ch_fr:"CH_fr",ch_it:"CH_it",cl:"CL_es",co:"CO_es",la:"DO_es",mx:"MX_es",pe:"PE_es",africa:"MU_en",dk:"DK_da",de:"DE_de",ee:"EE_et",eg_ar:"EG_ar",eg_en:"EG_en",es:"ES_es",fr:"FR_fr",gr_el:"GR_el",gr_en:"GR_en",ie:"IE_en",il_he:"IL_iw",it:"IT_it",lv:"LV_lv",lt:"LT_lt",lu_de:"LU_de",lu_en:"LU_en",lu_fr:"LU_fr",my_en:"MY_en",my_ms:"MY_ms",hu:"HU_hu",mt:"MT_en",mena_en:"DZ_en",mena_ar:"DZ_ar",nl:"NL_nl",no:"NO_nb",pl:"PL_pl",pt:"PT_pt",ro:"RO_ro",si:"SI_sl",sk:"SK_sk",fi:"FI_fi",se:"SE_sv",tr:"TR_tr",uk:"GB_en",at:"AT_de",cz:"CZ_cs",bg:"BG_bg",ru:"RU_ru",ua:"UA_uk",au:"AU_en",in_en:"IN_en",in_hi:"IN_hi",id_en:"ID_en",id_id:"ID_id",nz:"NZ_en",sa_ar:"SA_ar",sa_en:"SA_en",sg:"SG_en",cn:"CN_zh-Hans",tw:"TW_zh-Hant",hk_zh:"HK_zh-hant",jp:"JP_ja",kr:"KR_ko",za:"ZA_en",ng:"NG_en",cr:"CR_es",ec:"EC_es",pr:"US_es",gt:"GT_es",cis_en:"TM_en",cis_ru:"TM_ru",sea:"SG_en",th_en:"TH_en",th_th:"TH_th"};function be(n){let e=he[n];return!e&&_n[n]&&(e=n),!e&&n.includes("-")&&([e]=n.split("-")),e||"US"}var an="langstore/";function In(n){let r=(n?.prefix||"US_en").replace("/","")??"",[t="US",a="en"]=(_n[r]??r).split("_",2);if(r.startsWith(an)||window.location.pathname.startsWith(`/${an}`)){let i=r.replace(an,"").toLowerCase();t=be(i),a=i}return t=t.toUpperCase(),a=a.toLowerCase(),{language:a,country:t,locale:`${a}_${t}`}}var G=n=>{let e=n.querySelector("#feds-menu-wrapper");e?.classList.remove("feds-menu-active"),e?.hidePopover?.(),n.querySelector(".feds-popup:popover-open")?.hidePopover?.()};function $n(){let n=N("gnav-source")?.split("#")[0]?.split("/").pop()?.trim();if(n!==void 0&&n!==""&&n!=="gnav")return n;let e=window.adobeid?.client_id;return typeof e=="string"&&e!==""?e:""}var V={elementNull:"Error when parsing Link. Element is null",notAnchor:"Cannot parse non-anchor as Link",textContentNotFound:"Error when parsing Link. Element has no textContent",hrefNotFound:"Element has no href"},T=n=>{if(n===null)throw new c(V.elementNull);if(n.tagName!=="A")throw new c(V.notAnchor);let[e,r]=n?.textContent?.split("|").map(i=>i.trim())??["",""];if(e==="")throw new c(V.textContentNotFound);let t=n?.getAttribute("href")??"";if(t==="")throw new c(V.hrefNotFound);let a=n.getAttribute("daa-ll");return[{type:"Link",text:e,href:t,daaLl:a,ariaLabel:r},[]]};var dn=n=>{if(!n)throw new c(M.elementNull);if(!n.classList.contains("product-card"))throw new c(M.notAProductCard);return j(xe).or(ye).or(we).eval(n)},M={elementNull:"Element not found",noTitleAnchor:"Title anchor not found",noHref:"Title Anchor has no href",noTitle:"Title text not found",noSubtitleP:"Subtitle <p> not found",noSubtitle:"Subtitle text not found",notAHeader:"Expected a Header class",notAProductCard:"Expected a product-card class"},ye=n=>{let e=new Set;if(!n)throw new c(M.elementNull);let r=n.querySelector("p a")??n.querySelector("div ~ div > a");if(!r)throw new c(M.noTitleAnchor);let t=r.textContent??"";t===""&&e.add(new f(M.noTitle));let a=r.getAttribute("href")??"";a===""&&e.add(new f(M.noHref));let i=r.getAttribute("daa-ll"),o=r.getAttribute("daa-lh"),s=r?.closest("p")?.nextElementSibling;s||e.add(new f(M.noSubtitleP));let l=s?.textContent??"";l===""&&e.add(new f(M.noSubtitle));let d=n.querySelectorAll(":scope > div:nth-child(2) > :first-child p")??[],v=Array.from(d).map(p=>{let u=p.querySelector("strong")!==null;return{text:p?.textContent?.trim()??"",isFilled:u}}),[y,g=null]=(n.firstElementChild?.firstElementChild?.textContent?.split("|")??[]).map(p=>p.trim());return[{type:"ProductCardLink",iconHref:y,iconAlt:g,title:t,href:a,subtitle:l,badges:v,daaLl:i,daaLh:o},[...e]]},xe=n=>{if(!n)throw new c(M.elementNull);let e=[...n.classList];if(!e.includes("header"))throw new c(M.notAHeader);let r=n.querySelector("a")?.textContent??"",t=n.querySelector("a")?.getAttribute("daa-ll")??null,a=n.querySelector("a")?.getAttribute("daa-lh")??null;if(r==="")throw new c(M.noTitle);return[{type:"ProductCardHeader",title:r,classes:e,daaLl:t,daaLh:a},[]]},we=n=>{if(!n)throw new c(M.elementNull);if(!n.classList.contains("blue"))throw new Error("Not a Blue Product Card");let e=n.querySelector("a"),[r,t]=T(e),a=e?.getAttribute("daa-ll")??null,i=e?.getAttribute("daa-lh")??null;return[{type:"ProductCardBlue",link:r,daaLl:a,daaLh:i},t]};var cn=n=>{switch(n.type){case"ProductCardHeader":return ke(n);case"ProductCardLink":return Ce(n);case"ProductCardBlue":return Le(n);default:return console.error(n),""}},ke=({title:n,classes:e,daaLl:r,daaLh:t})=>{let a=e.slice(1).map(o=>`feds-product-card--${o}`).join(" "),i=k(t,r??n);return`
    <div role="heading" class="feds-product-card ${a}"${i}>
      <div class="feds-product-card__content">
        <div class="feds-product-card__title">${n}</div>
      </div>
    </div>
  `},Ce=({iconHref:n,iconAlt:e,title:r,href:t,subtitle:a,badges:i=[],daaLl:o,daaLh:s})=>{let l=e!==null&&n!==null,d=k(s,o??r),v=l?`
  ...
  `},Le=({link:n,daaLl:e,daaLh:r})=>{let t=k(r,e??n.text);return`
  <a href="${E(n.href)}" class="feds-product-card feds-product-card--blue"${t}>
    <div class="feds-product-card__content">
        <div class="feds-product-card__title">${n.text}</div>
      </div>
  </a>
`};var q={elementNull:"Error when parsing Brand. Element is null",noLinkSection:"Error when parsing Brand. No link section found",noLink:"Error when parsing Brand. No link found",noImageSection:"Error when parsing Brand. No image section found",missingImageSections:"Error when parsing Brand. Missing mobile or desktop image section",missingThemeImages:"Error when parsing Brand. Missing mobile or desktop image section"},pn=n=>{let e=new Set;if(n===null)throw new c(q.elementNull);let r=!!n.classList.contains("dark-bg"),[t,a]=n.querySelectorAll(":scope > div");if(t===void 0)throw new c(q.noLinkSection);let i=t.querySelector("a");if(i===null)throw new c(q.noLink);let o=i.getAttribute("href")??"",s=i.textContent?.trim()??"";a===void 0&&e.add(new f(q.noImageSection));let[l,d]=a?.querySelectorAll(":scope > div")??[];(l===void 0||d===void 0)&&e.add(new f(q.missingImageSections));let v=l?.querySelectorAll('a[href$=".svg"]'),y=d?.querySelectorAll('a[href$=".svg"]'),g=v?.[0]?.getAttribute("href")??"",p=v?.[0]?.textContent?.split("|")[1]?.trim()??"",u=v?.[1]?.getAttribute("href")??"",h=v?.[1]?.textContent?.split("|")[1]?.trim()??"",x=y?.[0]?.getAttribute("href")??"",m=y?.[0]?.textContent?.split("|")[1]?.trim()??"",b=y?.[1]?.getAttribute("href")??"",w=y?.[1]?.textContent?.split("|")[1]?.trim()??"";return(!g||!x||!u||!b)&&e.add(new f(q.missingThemeImages)),[{type:"Brand",data:{href:o,label:s,isDarkBg:r,imageData:{type:"svg",lightThemeImageSrc:x,lightThemeImageAlt:m,darkThemeImageSrc:b,darkThemeImageAlt:w,mobileLightThemeImageSrc:g,mobileLightThemeImageAlt:p,mobileDarkThemeImageSrc:u,mobileDarkThemeImageAlt:h}}},[...e]]};var Ee=`
<?xml
...
`.trim(),Se=n=>{let{href:e,label:r,isDarkBg:t,imageData:a}=n,i=a.lightThemeImageSrc?.trim()||a.darkThemeImageSrc?.trim()||"",o=a.darkThemeImageSrc?.trim()||a.lightThemeImageSrc?.trim()||"",s=a.mobileLightThemeImageSrc?.trim()||a.mobileDarkThemeImageSrc?.trim()||"",l=a.mobileDarkThemeImageSrc?.trim()||a.mobileLightThemeImageSrc?.trim()||"",d=a.lightThemeImageAlt||a.darkThemeImageAlt||"",v=a.darkThemeImageAlt||a.lightThemeImageAlt||"",y=a.mobileLightThemeImageAlt||a.mobileDarkThemeImageAlt||"",g=a.mobileDarkThemeImageAlt||a.mobileLightThemeImageAlt||"",p=!!i,u=!!o,h=!!s,x=!!l,m=p?`<img src="${R(i)}" alt="${d}" />`:"",b=u?`<img src="${R(o)}" alt="${v}" />`:"",w=h?`<img src="${R(s)}" alt="${y}" />`:"",U=x?`<img src="${R(l)}" alt="${g}" />`:"";return`<div class="feds-brand-container${t?" feds-dark-bg":""}">
  ...
  </div>`.trim()},gn=n=>{let{data:e}=n;return Se(e)};var un=["appswitcher","help"],Y={cs:["cz"],da:["dk"],de:["at"],en:["africa","au","ca","ie","in","mt","ng","nz","sg","za"],es:["ar","cl","co","cr","ec","gt","la","mx","pe","pr"],et:["ee"],ja:["jp"],ko:["kr"],nb:["no"],pt:["br"],sl:["si"],sv:["se"],uk:["ua"],zh:["cn","tw"]},[F,Rn]=(()=>{let n,e,r,t=new Promise(a=>{e=a,r=setTimeout(()=>{n={},a(n)},5e3)});return[a=>{a&&!n&&(n=a,clearTimeout(r),e?.(n))},()=>t]})();function J(n,e=!1){let s=(/uc_carts=/.test(document.cookie)?n:n?.filter(d=>d!=="cart"))??[],l=s.length??3;if(e){let d=s.filter(y=>un.includes(y)).length;return`calc(92px + ${d*32}px + ${d*.25}rem)`}return`calc(${l*32}px + ${(l-1)*.25}rem)`}var Q=n=>{if(!n.prefix||n.prefix==="/")return"en_US";let e=n.prefix.replace("/","");if(e.includes("_")){let[t,a]=e.split("_").reverse();return`${t.toLowerCase()}_${a.toUpperCase()}`}if(e==="uk")return"en_GB";let r=Object.keys(Y).find(t=>Y[t].includes(e));return r?`${r.toLowerCase()}_${e.toUpperCase()}`:`${e.toLowerCase()}_${e.toUpperCase()}`},Me={Mac:"macOS",Win:"windows",Linux:"linux",CrOS:"chromeOS",Android:"android",iPad:"iPadOS",iPhone:"iOS"},nn=()=>{let n=navigator.userAgent;for(let[e,r]of Object.entries(Me))if(n.includes(e))return r;return"linux"},en=async()=>{let n=window;return n.alloy?await n.alloy("getIdentity").then(e=>e?.identity?.ECID).catch(()=>{}):void 0};var Hn=()=>{try{return C().signInContext||{}}catch{return{}}},Pe=()=>{let n=C();return N("signin-cta-style")==="primary"||n?.unav?.profile?.signInCtaStyle==="primary"?"primary":"secondary"},Ae=()=>{let e=C()?.unav?.profile?.messageEventListener;return e||(r=>{let{name:t,payload:a,executeDefaultAction:i}=r.detail;if(!(!t||t!=="System"||!a||typeof i!="function"))switch(a.subType){case"AppInitiated":window.adobeProfile?.getUserProfile().then(o=>{F(o)}).catch(()=>{F({})});break;case"SignOut":i();break;case"ProfileSwitch":Promise.resolve(i()).then(o=>{o&&window.location.reload()});break;default:break}})};function _e(){let{unav:n}=C();return n?.unavHelpChildren||[{type:"Support"},{type:"Community"}]}var W=()=>{let n=C();return{profile:{name:"profile",attributes:{accountMenuContext:{sharedContextConfig:{enableLocalSection:!0,enableProfileSwitcher:!0,miniAppContext:{logger:{trace:()=>{},debug:()=>{},info:()=>{},warn:()=>{},error:()=>{}}},complexConfig:n?.unav?.profile?.complexConfig||null,...n?.unav?.profile?.config},messageEventListener:Ae()},signInCtaStyle:Pe(),isSignUpRequired:!1,callbacks:{onSignIn:()=>{window.adobeIMS?.signIn(Hn())},onSignUp:()=>{window.adobeIMS?.signIn(Hn())}}}},appswitcher:{name:"app-switcher"},notifications:{name:"notifications",attributes:{notificationsConfig:{applicationContext:{appID:n?.unav?.uncAppId||"adobecom",...n?.unav?.uncConfig}}}},help:{name:"help",attributes:{children:_e()}},jarvis:{name:"jarvis",attributes:{appid:n?.jarvis?.id,callbacks:n?.jarvis?.callbacks}},cart:{name:"cart"}}};var zn=(n,e)=>{n[0]&&"attributes"in n[0]&&n[0].attributes&&typeof n[0].attributes=="object"&&"isSignUpRequired"in n[0].attributes&&(n[0].attributes.isSignUpRequired=e)},rn=async(n,e)=>{try{let r=n.querySelector(".feds-utilities");if(!(r instanceof HTMLElement))return new f('missing ".feds-utilities" container');let t=new Set,a=document.head.querySelector('meta[name="universal-nav"]'),i=a instanceof HTMLMetaElement?a.content??"":"";a instanceof HTMLMetaElement||t.add(new f('metadata "universal-nav" is missing'));let o=i.trim();a instanceof HTMLMetaElement&&o.length===0&&t.add(new f('metadata "universal-nav" has no value'));let s=!window.adobeIMS?.isSignedInUser(),l=o.split(",").map(m=>m.trim()).filter(m=>Object.keys(W()).includes(m)||m==="signup");if(s){let m=J(l,s);r.style.setProperty("min-width",m)}let d;try{d=C()}catch{throw new Error("MiloConfig not available for UNAV initialization")}let v=Q(d.locale),y=d.env.name==="prod"?"prod":"stage",g=await en(),p=new URLSearchParams(window.location.search).get("unavVersion");/^\d+(\.\d+)?$/.test(p??"")||(p="1.5"),await Promise.all([sn(`https://${y}.adobeccstatic.com/unav/${p}/UniversalNav.js`),on(`https://${y}.adobeccstatic.com/unav/${p}/UniversalNav.css`,!0)]);let u=()=>{let m=W(),b=[m.profile];return zn(b,!1),l?.forEach(w=>{if(w==="profile")return;if(w==="signup"){zn(b,!0);return}let U=m[w];U&&b.push(U)}),b},h=()=>({target:r,env:y,locale:v,countryCode:In(d?.locale)?.country||"US",imsClientId:window?.adobeid?.client_id,theme:"light",analyticsContext:{consumer:{name:"adobecom",version:"1.0",platform:"Web",device:nn(),os_version:navigator.platform},event:{visitor_guid:g}},children:u(),isSectionDividerRequired:!!d?.unav?.showSectionDivider,showTrayExperience:!A.matches});await window?.UniversalNav?.(h()),s||r?.style.removeProperty("min-width");let x=m=>{window?.UniversalNav?.reload(h())};return A.addEventListener("change",()=>{x()}),{reloadUnav:x,errors:t}}catch(r){let t=r instanceof Error?r.message:"failed to load universal nav";return new f(t)}};function H(n,e){return[...n.querySelectorAll(e)]}function Z(n,e,r){H(n,e).forEach(t=>r?t.removeAttribute("tabindex"):t.setAttribute("tabindex","-1"))}var B={ArrowLeft:-1,ArrowRight:1,ArrowUp:-1,ArrowDown:1},Un=new Set(["ArrowLeft","ArrowRight"]),Ie=new Set(["ArrowUp","ArrowDown"]),$e='.tabs [role="tab"][aria-selected="true"]';function fn(n,e,r){return(n+e+r)%r}function Re(n,e,r,t){let a=B[r];if(Un.has(r)){let p=e+a;return p>=0&&p<n.length?p:null}let i=getComputedStyle(t).gridTemplateColumns.split(" ").length,o=[...t.children],s=p=>{let u=n[p].parentElement;return u?o.indexOf(u):-1},l=s(e)%i,d=Math.floor(s(e)/i)+(r==="ArrowDown"?1:-1),v=Math.floor((o.length-1)/i);if(d<0||d>v)return null;let y=null,g=1/0;for(let p=0;p<n.length;p++){let u=Math.abs(s(p)%i-l);Math.floor(s(p)/i)===d&&u<g&&(g=u,y=p)}return y}function mn(n){Z(n,'.tab-content [role="tabpanel"] a',!1);let e=[];H(n,".feds-popup[popover]").forEach(g=>{let p=()=>{g.matches(":popover-open")||Z(g,'[role="tabpanel"] a',!1)};g.addEventListener("toggle",p),e.push(()=>g.removeEventListener("toggle",p))});let r=(g,p)=>{g.focus(),p.preventDefault()},t=()=>n.querySelector(".feds-popup:popover-open"),a=g=>g.querySelector($e),i=g=>g.querySelector('[role="tabpanel"]:not([hidden])');function o(g){let p=t(),u=n.querySelector("#feds-menu-wrapper");if(!u)return!1;let h=u.querySelector(".feds-gnav-items"),x=p?p.querySelector(".feds-popup-back-button"):null,m=h?.classList.contains("subscreen-opening")===!0;if(p!==null&&m&&x!==null)return x.click(),g.preventDefault(),!0;let b=p??(u?.matches(":popover-open")?u:null);if(!b)return!1;b.hidePopover?.();let w=p?`[popovertarget="${b.id}"]`:".feds-nav-toggle";return n.querySelector(w)?.focus(),g.preventDefault(),!0}function s(g,p,u){if(!Un.has(p))return!1;let h=H(n,".feds-gnav-items > li > .feds-link"),x=h.indexOf(g);return x<0?!1:(r(h[fn(x,B[p],h.length)],u),!0)}function l(g,p,u,h){let x=H(p,'.tabs :is([role="tab"], .product-links a)'),m=x.indexOf(g);if(m<0)return!1;if(B[u]){let b=x[fn(m,B[u],x.length)];return b.matches('[role="tab"]')&&b.click(),r(b,h),!0}if(u==="Tab"&&!h.shiftKey&&g.matches('[aria-selected="true"]')){let b=i(p);if(!b)return!1;Z(b,"a",!0);let w=b.querySelector("a");return w&&r(w,h),!0}return!1}function d(g,p,u,h){let x=i(p);if(!x)return!1;let m=H(x,"a"),b=m.indexOf(g);if(b<0)return!1;if(B[u]){let w=Re(m,b,u,x);return w!==null?(r(m[w],h),!0):u==="ArrowUp"?(Z(x,"a",!1),r(a(p)??m[0],h),!0):!1}if(u==="Tab"&&!h.shiftKey){if(b+1<m.length)r(m[b+1],h);else{let w=H(p,'.tabs [role="tab"]'),U=a(p),tn=w[w.indexOf(U)+1]??p.querySelector(".product-links a");if(tn)r(tn,h);else return!1}return!0}if(u==="Tab"&&h.shiftKey){if(b>0)r(m[b-1],h);else{Z(x,"a",!1);let w=a(p)??H(p,'.tabs :is([role="tab"], .product-links a)')[0];w&&r(w,h)}return!0}return!1}function v(g,p,u,h){if(!Ie.has(u))return!1;let x=H(p,".feds-gnav-cards a"),m=x.indexOf(g);return m<0?!1:(r(x[fn(m,B[u],x.length)],h),!0)}function y(g){let p=document.activeElement??g.target;if(g.key==="Escape"){o(g);return}let u=t();u&&(u.matches(":has(.product-list)")&&(l(p,u,g.key,g)||d(p,u,g.key,g))||u.matches(":has(.feds-gnav-cards)")&&v(p,u,g.key,g))||s(p,g.key,g)}return n.addEventListener("keydown",y),e.push(()=>n.removeEventListener("keydown",y)),()=>e.forEach(g=>g())}var He="feds-milo",L=(n,e="default",r="e")=>{let{locale:t}=C(),a=N("gnav-source")??`${t.contentRoot??""}/gnav`;window.lana||console.warn("lana logging unavailable in the gnav"),window?.lana?.log(`${n} | gnav-source: ${a} | href: ${window.location.href}`,{clientId:He,sampleRate:1,tags:e,errorType:r})};var c=class n extends Error{constructor(e){super(e),Object.setPrototypeOf(this,n.prototype)}},f=class n extends Error{constructor(e,r="Minor"){super(e),Object.setPrototypeOf(this,n.prototype),r==="Critical"&&L(e)}};var Dn=n=>e=>{if(e===null)throw new Error("");let r=e.querySelector(ze(n));if(!r)throw new Error("");let t=r.textContent??"",[a="",i=""]=t.split("|").map(y=>y.trim());if(a==="")throw new Error("");let o=r.getAttribute("href")??"";if(o==="")throw new Error("");let s=r.getAttribute("daa-ll"),l=r.getAttribute("aria-label")?.trim()??"",d=l!==""?l:i!==""?i:void 0,v=[];return[{type:n.type,text:a,href:o,ariaLabel:d,daaLl:typeof s=="string"&&s.trim()!==""?s:a},v]},vn=Dn({type:"PrimaryCTA"}),_=Dn({type:"SecondaryCTA"}),Nn=n=>j(vn).or(_).eval(n),ze=({type:n})=>{switch(n){case"PrimaryCTA":return"strong > a";case"SecondaryCTA":return"em > a";default:throw new Error("")}};var hn=({text:n,href:e,daaLl:r,ariaLabel:t})=>`
<a href="${E(e)}"
...
`,qn=n=>n.type==="PrimaryCTA"?hn(n):I(n);var O=({text:n,href:e,daaLl:r,svgIcon:t=""})=>`<a class="feds-link" href="${E(e)}"${k(null,r??n)}>${n}${t}</a>`;var Bn=n=>{let[e,r]=Ue(n);return[{type:"LinksCard",card:e},r]},Ue=n=>{let e=n.querySelector("h2, h3, h4")||null;if(!e)throw new c("Expected links card title");let r=n.querySelector("em > a"),t=[...n.querySelectorAll("a")].filter(l=>l!==r);if(t.length===0)throw new c("Expected at least one link");let[a,i]=S(t,T),[o,s]=(()=>{try{return _(n)}catch{return[null,[]]}})();return o&&(o.daaLl=`${e.textContent??""} - ${o?.daaLl}`),[{type:"LinksCardItem",title:e.textContent??"",links:a,footerCTA:o},[...i,...s]]};var On=n=>{let e=[...n.querySelectorAll("li > div")],r=[...n.querySelectorAll("li > a")],[t,a]=S(e,De),[i,o]=S(r,T);return[{type:"ProductList",categories:t,links:i},[...a,...o]]},De=n=>{let e=n.firstElementChild;if(e?.nodeName!=="H2")throw new c("Expected H2");let r=e.textContent??"",t=e.textContent??"",a=Ln(e),[i,o]=S(a,dn);return[{type:"ProductCategory",name:r,daaLl:t,links:i},o]};var jn=n=>{let[e,r]=Ne(n);return[{type:"FeaturedCard",card:e},r]},Ne=n=>{let e=n.querySelector("h5")||null;if(!e)throw new f("Eye brow element not found");let r=n.querySelector("h4")||null,t=r?.nextElementSibling||null;if(!r)throw new c("Expected title");if(!t)throw new c("Expected subtitle");let a=t.nextElementSibling?.firstElementChild||null;if(!a)throw new c("Expected card link after subtitle");let[i,o]=T(a),[s,l]=_(n);return[{type:"Card",title:r.textContent??"",subtitle:t.textContent??"",bodyLink:i,footerCTA:s,eyeBrow:e.textContent??""},[...l,...o]]};var P={MissingBackgroundImageSection:"Promo card is missing background image section",MissingBackgroundImage:"Promo card is missing background image",MissingBackgroundImageAlt:"Promo card background image is missing alt text",MissingBackgroundImageSrc:"Promo card background image is missing src",MissingContentSection:"Promo card is missing card details section",MissingIcon:"Promo card is missing icon",MissingIconSrc:"Promo card icon is missing src",MissingIconAlt:"Promo card icon is missing alt text",MissingTitleElement:"Promo card is missing title element",MissingTitleText:"Promo card is missing title text",MissingSecondaryCtaAnchor:"Promo card is missing secondary CTA anchor",MissingPriceLink:"Promo card is missing price link"},Gn=n=>{let[e,r]=n.querySelectorAll(":scope > div"),t=new Set;if(e===void 0)throw new c(P.MissingBackgroundImageSection);let a=e.querySelector(":scope picture:not(:scope p picture) img")??null;a===null&&t.add(new f(P.MissingBackgroundImage));let i=a?.getAttribute("alt")??"";i===""&&t.add(new f(P.MissingBackgroundImageAlt));let o=a?.getAttribute("src")??"";if(o===""&&t.add(new f(P.MissingBackgroundImageSrc)),r===void 0)throw new c(P.MissingContentSection);let s=r.querySelector('a[href$=".svg"]')??null;s===null&&t.add(new f(P.MissingIcon));let[l,d]=(s?.textContent?.split("|")??["",""]).map(w=>w.trim());l===""&&t.add(new f(P.MissingIconSrc)),d===""&&t.add(new f(P.MissingIconAlt));let v=r.querySelector('p > a:not([href$=".svg"])')??null,y=v?.textContent?.trim()??"",g=v?.getAttribute("href")??"",p=g?Cn(g):!1;v===null&&t.add(new f(P.MissingPriceLink));let u=r.querySelector("p > strong")??null;if(u===null)throw new c(P.MissingTitleElement);let h=u?.textContent??"";h===""&&t.add(new f(P.MissingTitleText)),r.querySelector("em > a")===null&&t.add(new f(P.MissingSecondaryCtaAnchor));let[m,b]=(()=>{try{return _(n)}catch{return[null,[]]}})();return b.forEach(w=>t.add(w)),m&&(m.daaLl=`${h} - ${m?.daaLl}`),[{type:"PromoCard",card:{bgImageAlt:i,bgImageSrc:o,iconAlt:d,iconSrc:l,title:h,cta:m,priceText:y,priceHref:g,isPriceMerchLink:p}},[...t]]};var Wn=n=>{let e=new Set;if(n===null)throw new c(Fn.elementNull);let r=n.querySelector("h2")?.textContent??"";r===""&&e.add(new f(Fn.noTitle));let t=(async()=>{try{let a=n.querySelector("a"),i=new URL(a?.href??""),o=await D(i);if(o instanceof c)throw new Error(o.message);let s=await Pn(o);if(s instanceof c)throw new Error(s.message);return Mn(i.href,s),n.classList.contains("product-list")?On(s):qe(s)}catch(a){throw new c(a?.message)}})();if(t instanceof c)throw t;return[{type:"MegaMenu",title:r,content:t},[...e]]},Fn={elementNull:"Element is null",noTitle:"Large Menu has no Title"},qe=n=>{let e=[...n.children];if(e.length===0)throw new c("No mega menu items found (did you forget to add them correctly?)");let[r,t]=S(e,a=>Be(a));if(r.length===0)throw new c("Failed to parse gnav cards sections");return[{type:"GnavCards",sections:r},t]},Be=n=>{let e=[...n.querySelectorAll(".featured-card, .links-card, .promo-card")];if(e.length===0)throw new c("Column contains no cards (did you forget to label them correctly?)");let[r,t]=S(e,a=>Oe(a));if(r.length===0)throw new c("Failed to parse cards in column");return[{type:"GnavColumn",cards:r},t]},Oe=n=>{if(n.classList.contains("featured-card"))return jn(n);if(n.classList.contains("links-card"))return Bn(n);if(n.classList.contains("promo-card"))return Gn(n);throw new c("Unsupported gnav cards section")};var Zn=({card:n})=>je(n),je=({title:n,subtitle:e,eyeBrow:r,footerCTA:t,bodyLink:a})=>`
  <article class="featured-card" ${k(r,"")}>
    <div>
      <div class="featured-eyebrow">${r}</div>
      <h4>${n}</h4>
      <div class="featured-subtitle">${e}</div>
      <span>${O({...a,svgIcon:$.chevronRight})}</span>
    </div>
...
`.trim();var Kn=({card:n})=>Fe(n),Fe=({bgImageAlt:n,bgImageSrc:e,iconAlt:r,iconSrc:t,title:a,cta:i,priceText:o,priceHref:s,isPriceMerchLink:l})=>`
...
`.trim();var We=n=>{switch(n.type){case"FeaturedCard":return Zn(n);case"LinksCard":return Xn(n);case"PromoCard":return Kn(n);default:}return""},Vn=({sections:n})=>`
  <div class="feds-gnav-cards">
    ${n.map(e=>`<li>${e.cards.map(r=>We(r)).join("")}</li>`).join("")}
  </div>
`;var Yn=({categories:n,links:e})=>{let r=`
  ...
  <div id="${K(n)}" popover class="feds-popup">
  </div>
`,Qn=(n,e,r)=>{let t=`
        <button
          type="button"
  ...
  `,a=n.type==="ProductList"&&n.links.length>0?n.links[n.links.length-1]:null,i=`
  ...
  `.trim(),o="";switch(n.type){case"ProductList":o=Yn(n);break;case"GnavCards":o=Vn(n);break;default:}return`${i}${o}`};var ne={elementNull:"Error when parsing text. Element is null",textContentNull:"Error when parsing text. Element has no textContent"},ee=n=>{if(n===null)return[{type:"Text",content:""},[new f(ne.elementNull,"Minor")]];let e=n.textContent;return e===null?[{type:"Text",content:""},[new f(ne.textContentNull,"Minor")]]:[{type:"Text",content:e},[]]};var re=({content:n})=>n;var te=n=>{if(n===null)throw new c(Xe.elementNull);let e=n.querySelector(".gnav-brand");if(e!==null)return pn(e);let r=n.querySelector(".large-menu");return r!==null?Wn(r):n.querySelector("strong")!==null?vn(n):n.querySelector("em")!==null?_(n):n.querySelector("a")===null?ee(n):T(n.querySelector("a"))},bn=(n,e)=>{switch(n.type){case"Text":return re(n);case"Link":return O(n);case"SecondaryCTA":return I(n);case"PrimaryCTA":return hn(n);case"Brand":return gn(n);case"MegaMenu":return Jn(n,e);default:return console.error(`Failed to recognize component: ${n}`),""}},Xe={elementNull:"Element is null"};var ae=(n,e)=>{let[r,t]=S([...document.querySelectorAll(".breadcrumbs ul > li > a")??[]],T),[a,i]=S([...n.children],te),o=n.querySelector(".product-entry-cta"),[s,l]=(()=>{try{return Nn(o)}catch{return[null,[]]}})(),d=!1,v=[t,i,l].flat();return{breadcrumbs:r,components:a,productCTA:s,localnav:d,errors:v,unavEnabled:e}};var oe=n=>{let e=[...n.querySelectorAll('.tabs button[role="tab"]')],r=[...n.querySelectorAll(".tab-content ul")],t=e.map((a,i)=>()=>{let o=r[i].closest(":popover-open");if(e.forEach(d=>{d.setAttribute("aria-selected","false")}),r.forEach(d=>{d.setAttribute("hidden","true")}),r[i]?.removeAttribute("hidden"),a.setAttribute("aria-selected","true"),!o||!A.matches)return;let s=ie();if(!s)return;let l=o?.clientHeight??0;s.style.height=`${l+72}px`});return e.forEach((a,i)=>{a.addEventListener("click",t[i])}),Ke(n),()=>{e.forEach((a,i)=>{a.removeEventListener("click",t[i])})}},ie=()=>[...document.adoptedStyleSheets.flatMap(n=>[...n.cssRules])].find(n=>n?.selectorText==="header.global-navigation nav::after"),Ke=n=>{let e=[...n.querySelectorAll(".feds-gnav-items > li > button")],r=n.querySelector(".feds-gnav-items"),t=ie(),a=new ResizeObserver(i=>{if(i.length<1)return;let o=n.querySelector(".feds-popup:popover-open");if(!o){t.style.height="100%";return}let l=o.clientHeight<1?"100%":`${o.clientHeight+72}px`;t.style.height=l});e.forEach(i=>{if(!t)return;let o=i.nextElementSibling;o&&(a.observe(o),o.addEventListener("toggle",s=>{s.newState!=="open"&&!n.querySelector(".feds-popup:popover-open")?t.style.height="100%":t.style.height=`${o.clientHeight+72}px`}))}),e.forEach(i=>{i.addEventListener("click",()=>{if(A.matches||!r)return;let o=i.nextElementSibling;o&&(r.classList.remove("subscreen-closing"),r.classList.add("subscreen-opening"),o.querySelector(".feds-popup-back-button")?.addEventListener("click",()=>{r.classList.remove("subscreen-opening"),r.classList.add("subscreen-closing"),setTimeout(()=>o.hidePopover(),240)}))})}),A.addEventListener("change",()=>{r?.classList.remove("subscreen-opening"),r?.classList.remove("subscreen-closing")}),n.querySelector(".feds-nav-toggle")?.addEventListener("click",()=>{r?.classList.remove("subscreen-opening"),r?.classList.remove("subscreen-closing")})};var se=async n=>{let e=new Set,r=n.querySelectorAll("a.merch");if(r.length===0)return e;try{let t=C(),{base:a}=t;if(!a)return e.add(new f("base not found in config, cannot initialize merch links")),e;let i=await import(`${a}/blocks/merch/merch.js`),{default:o}=i;if(!o)return e.add(new f("decorateMerchLink not found in merch module")),e;r.forEach(s=>{o(s)})}catch(t){e.add(new f(`Error initializing merch links: ${t}`))}return e};var le=async({gnavSource:n,asideSource:e})=>{let r=await D(n);if(r instanceof c)return r;let t=await D(e);return{mainNav:r,aside:t}};var Ve=`/**
...
`,de=document.createElement("style");de.textContent=Ve;document.head.appendChild(de);var xo=async n=>{let{gnavSource:e,mountpoint:r,unavEnabled:t,miloConfig:a,personalization:i}=n;if(!(e instanceof URL))throw L(`gnavSource is invalid: ${e}`),new c("gnavSource needs to be a URL object");try{ln(a)}catch(v){throw L(`Failed to initialize MiloConfig: ${v}`),new c(`Failed to initialize MiloConfig: ${v}`)}En(i),Tn(n.localizeLink??(v=>v)),wn(yn(n));let o=await le(n);if(o instanceof c)throw L(o.message),o;let{mainNav:s,aside:l}=o;if(s instanceof c)throw L(s.message),s;let d=ae(s,t);if(d instanceof c)throw L(d.message),d;return await Ye(d)(r),Qe(n)},Ye=n=>async e=>{let r=Je(n);e.innerHTML=r,e.classList.add("site-pivot"),e.querySelector("nav")?.showPopover();let t=[...e.querySelectorAll(".mega-menu ~ .feds-popup")];t.forEach(s=>{s.innerHTML=""});let a=n.components.filter(s=>s.type==="MegaMenu"),i=a.map(s=>s.content),o=await Promise.all(i.map(async(s,l)=>{let[d,v]=await s,y=a[l].title;return t[l].innerHTML=Qn(d,t[l].id,y),v}).flat());return e},Je=({components:n,productCTA:e,unavEnabled:r})=>`
<nav popover="manual" data-lenis-prevent>
  <ul>
    ${(()=>{let t=n.find(l=>l.type==="Brand")??null,a=n.filter(l=>l.type!=="Brand"),i=`
        <button
      ...
      `.trim(),o=t?bn(t):"",s=An(a,bn);return`
...
`,Qe=async n=>{let e=new Set,r=await rn(n.mountpoint);r instanceof f?(e.add(r),L(r.message)):r.errors.forEach(o=>e.add(o)),oe(n.mountpoint),mn(n.mountpoint),nr(n.mountpoint),er(n.mountpoint),rr(n.mountpoint),ar(n.mountpoint),or(n.mountpoint,n.mepMartech??"");let t=()=>{document.querySelector("nav[popover]")?.removeAttribute("popover"),G(n.mountpoint)};document.querySelector(".dialog-modal")&&t(),document.addEventListener("click",o=>{o.target instanceof Element&&o.target.closest('a[href*="#openPrivacy"]')&&t()}),window.addEventListener("milo:modal:loaded",t),window.addEventListener("milo:modal:closed",()=>{let o=document.querySelector("nav");o?.setAttribute("popover","manual"),o?.showPopover?.()}),(await se(n.mountpoint)).forEach(o=>{e.add(o),L(o.message)});let i=r instanceof f?()=>{}:r.reloadUnav;return{closeEverything:tr,reloadUnav:i,errors:e,setGnavTopPosition:o=>{},getGnavTopPosition:()=>0}},nr=n=>{let e=n.querySelector("#feds-menu-wrapper"),r=n.querySelector(".feds-nav-toggle");e?.addEventListener("toggle",()=>{let a=e.matches(":popover-open");r?.setAttribute("aria-expanded",String(a)),r?.setAttribute("daa-ll",a?"hamburgermenu|close":"hamburgermenu|open"),e.setAttribute("aria-hidden",String(!a)),a&&e.classList.add("feds-menu-active")}),e?.addEventListener("transitionend",()=>{e.matches(":popover-open")||e.classList.remove("feds-menu-active")}),n.querySelectorAll(".feds-popup[popover]").forEach(a=>{a.addEventListener("toggle",()=>{let i=n.querySelector(`[popovertarget="${a.id}"]`),o=a.matches(":popover-open");i?.setAttribute("aria-expanded",String(o)),i?.setAttribute("daa-ll",o?"header|Close":"header|Open")})})},er=n=>{A.addEventListener("change",()=>{G(n)})},rr=n=>{[...n.querySelector(".feds-utilities #universal-nav")?.children??[]].forEach(e=>{e.addEventListener("click",()=>G(n)),e.addEventListener("keydown",r=>{r.key==="Enter"&&G(n)})})};var tr=()=>{},ar=n=>{let e=n.closest("header");if(!e)return;let r=n.querySelector("#feds-menu-wrapper"),t=()=>r?.matches(":popover-open")??!1,a=()=>window.scrollY>100,i=()=>{if(t()){e.classList.remove("feds-header-scrolled");return}if(a()){e.classList.add("feds-header-scrolled");return}e.classList.remove("feds-header-scrolled")};i(),window.addEventListener("scroll",i,{passive:!0}),r?.addEventListener("toggle",i)},or=(n,e)=>{let r=n.closest("header");r!==null&&r.setAttribute("daa-lh",`gnav|${$n()}${e}`)};export{xo as main,Qe as postRenderingTasks,Ye as renderGnav,Je as renderGnavString};
