var kn=async n=>{let{placeholders:e}=n,{locale:a}=S(),t=`${Y()}${a.prefix}/federal/globalnav/placeholders.json`,[i,o]=await Promise.all([e,ge(t)]);return new Map([...o,...i])},ge=async n=>{try{let e=await fetch(n);if(!e.ok)throw new g(`Federal placeholders not found at ${n}`);let a=fe(await e.json());if(a instanceof g)throw a;return new Map(a.data.map(({key:r,value:t})=>[r,t]))}catch(e){if(e instanceof g)console.error(e.message);else{let a=new g(e.message);console.error(a.message)}return T(`Failed to fetch placeholders from ${n}`),new Map([])}},fe=n=>{try{let{data:e}=n;if(!e.every(({key:r,value:t})=>typeof r=="string"&&typeof t=="string"))throw new Error("data is not valid");return n}catch(e){return new g(e.message)}};function Cn(n,e){let a=/{{(.*?)}}|%7B%7B(.*?)%7D%7D/g;return a.test(n)?n.replace(a,(t,i,o)=>{let s=i??o??"";return e.get(s)??s}):n}var[Ln,j]=(()=>{let n;return[e=>{n||(n=e)},()=>{if(!n)throw new Error("Placeholders not initialized. Call setPlaceholders() first.");return n}]})();var E=window.matchMedia("(min-width: 1024px)"),D={brand:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" id="Layer_1" viewBox="0 0 64.57 35"><defs><style>.cls-1{fill: #eb1000;}</style></defs><path class="cls-1" d="M6.27,10.22h4.39l6.2,14.94h-4.64l-3.92-9.92-2.59,6.51h3.08l1.23,3.41H0l6.27-14.94ZM22.03,13.32c.45,0,.94.04,1.43.16v-3.7h3.88v14.72c-.89.4-2.81.89-4.73.89-3.48,0-6.47-1.98-6.47-5.93s2.88-6.13,5.89-6.13ZM22.52,22.19c.36,0,.65-.07.94-.16v-5.42c-.29-.11-.58-.16-.96-.16-1.27,0-2.45.94-2.45,2.92s1.2,2.81,2.47,2.81ZM34.25,13.32c3.23,0,5.98,2.18,5.98,6.02s-2.74,6.02-5.98,6.02-6-2.18-6-6.02,2.72-6.02,6-6.02ZM34.25,22.13c1.11,0,2.14-.89,2.14-2.79s-1.03-2.79-2.14-2.79-2.12.89-2.12,2.79.96,2.79,2.12,2.79ZM41.16,9.78h3.9v3.7c.47-.09.96-.16,1.45-.16,3.03,0,5.84,1.98,5.84,5.86,0,4.1-2.99,6.18-6.53,6.18-1.52,0-3.46-.31-4.66-.87v-14.72ZM45.91,22.17c1.34,0,2.56-.96,2.56-2.94,0-1.85-1.2-2.72-2.5-2.72-.36,0-.65.04-.91.16v5.35c.22.09.51.16.85.16ZM58.97,13.32c2.92,0,5.6,1.87,5.6,5.64,0,.51-.02,1-.09,1.49h-7.27c.4,1.32,1.56,1.94,3.01,1.94,1.18,0,2.27-.29,3.5-.82v2.97c-1.14.58-2.5.82-3.9.82-3.7,0-6.58-2.23-6.58-6.02s2.61-6.02,5.73-6.02ZM60.93,18.02c-.2-1.27-1.05-1.78-1.92-1.78s-1.58.54-1.87,1.78h3.79Z"/></svg>',company:'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="22" viewBox="0 0 24 22" fill="none"><path d="M14.2353 21.6209L12.4925 16.7699H8.11657L11.7945 7.51237L17.3741 21.6209H24L15.1548 0.379395H8.90929L0 21.6209H14.2353Z" fill="#EB1000"/></svg>',search:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" focusable="false"><path d="M14 2A8 8 0 0 0 7.4 14.5L2.4 19.4a1.5 1.5 0 0 0 2.1 2.1L9.5 16.6A8 8 0 1 0 14 2Zm0 14.1A6.1 6.1 0 1 1 20.1 10 6.1 6.1 0 0 1 14 16.1Z"></path></svg>',home:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" height="25" viewBox="0 0 18 18" width="25"><path fill="#6E6E6E" d="M17.666,10.125,9.375,1.834a.53151.53151,0,0,0-.75,0L.334,10.125a.53051.53051,0,0,0,0,.75l.979.9785A.5.5,0,0,0,1.6665,12H2v4.5a.5.5,0,0,0,.5.5h4a.5.5,0,0,0,.5-.5v-5a.5.5,0,0,1,.5-.5h3a.5.5,0,0,1,.5.5v5a.5.5,0,0,0,.5.5h4a.5.5,0,0,0,.5-.5V12h.3335a.5.5,0,0,0,.3535-.1465l.979-.9785A.53051.53051,0,0,0,17.666,10.125Z"/></svg>',chevronLeft:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" focusable="false"><path d="M12.5 4l-5 6 5 6" stroke="currentColor" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>',chevronRight:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="3" height="6" viewBox="0 0 3 6" focusable="false"><path d="M.5.5 2.5 3 .5 5.5" stroke="currentColor" stroke-width="1" fill="none"/></svg>',chevronDown:'<svg class="chevron-down" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="6" height="3.375" viewBox="0 0 6 3.375" focusable="false"><path d="M.5.5 3 2.875 5.5.5" stroke="currentColor" stroke-width="1" fill="none"/></svg>'},ue=["/tools/ost?","/miniplans"],En=n=>ue.some(e=>n.includes(e));var Sn=n=>{let e=[],a=n.nextElementSibling??null;for(;a!==null;)e.push(a),a=a.nextElementSibling??null;return e},F=n=>({eval:n,or:e=>F(a=>{try{return n(a)}catch{return e(a)}})}),z=(n,e)=>n.reduce(([a,r],t)=>{try{let[i,o]=e(t);return[[...a,i],[...r,...o]]}catch(i){return i instanceof c?[a,[i,...r]]:[a,r]}},[[],[]]),[Tn,me]=(()=>{let n,e=!1;return[a=>{e||(n=a,e=!0)},()=>{if(!n)throw new Error("PersonalizationConfig not initialized. Call setPersonalizationConfig() first.");return n}]})(),[Mn,_n]=(()=>{let n=e=>e;return[e=>{n=e},()=>n]})(),_=n=>{try{return _n()(n)}catch{return n}},q=async n=>{try{if(n===null)return new c("URL is null");let e=`${n.origin}${n.pathname.replace(/(\.html$|$)/,".plain.html")}${n.hash}`,a=_n()(e),r=A(a),t=await fetch(r);if(!t.ok)return T(`Request for ${r} failed`),new c(`Request for ${r} failed`);let i=await t.text(),o=await j(),s=Cn(i,o),{body:l}=new DOMParser().parseFromString(s,"text/html");try{let{handleCommands:d,commands:v}=me();d(v,l)}catch(d){T(`Personalization not applied: ${d?.message}`)}return l}catch(e){return new c(e?.message)}},U,Y=()=>{if(U)return U;let n=["https://www.adobe.com","https://business.adobe.com","https://blog.adobe.com","https://milo.adobe.com","https://news.adobe.com","graybox.adobe.com"];if(U)return U;let e=window.location.origin;U=n.some(t=>{let i=e.replace(".stage","");return t.startsWith("https://")?i===t:i.endsWith(t)})?e:"https://www.adobe.com";let r=window.location.hostname.includes(".aem.")?"aem":"hlx";return(e.includes("localhost")||e.includes(`.${r}.`))&&(U=`https://main--federal--adobecom.aem.${e.endsWith(".live")?"live":"page"}`),U},A=(n="")=>{if(n.includes("stage.adobe.com"))return n.replace("c2-poc--milo--adobecom","main--federal--adobecom");if(n.includes("c2-poc-feds-gnav--milo--adobecom"))return n.replace("c2-poc-feds-gnav--milo--adobecom","main--federal--adobecom");if(n.includes("localhost:3000"))return n.replace("localhost:3000","main--federal--adobecom.aem.page");if(typeof n!="string"||!n.includes("/federal/"))return n;if(n.startsWith("/"))return`${Y()}${n}`;try{let{pathname:e,search:a,hash:r}=new URL(n);return`${Y()}${e}${a}${r}`}catch(e){let a=e instanceof Error?e.message:String(e);console.warn(`getFederatedUrl errored parsing the URL: ${n}: ${a}`)}return n},An=(n,e)=>{let a=(r,t)=>{let i=`${r}[${t}^="./media_"]`;e.querySelectorAll(i).forEach(s=>{let l=s.getAttribute(t);if(!(l===null||l===""))try{let d=A(new URL(l,new URL(n,window.location.href)).href);s.setAttribute(t,d)}catch(d){console.warn(`[MediaPathError]: Failed to process relative media path (${l}) for ${r}`,d)}})};a("img","src"),a("source","srcset")},Pn=async n=>{let e=async(a,r)=>{if(a instanceof c)return a;try{let i=[...a.querySelectorAll('a[href*="#_inline"]')].map(async o=>{try{if(r.has(o.href))return;let s=A(o.href),l=new URL(s),d=await q(l);if(r.add(o.href),d instanceof c)throw d;await e(d,r),o.replaceWith(...d.children);return}catch{return}},[]);return await Promise.all(i),a}catch(t){return new c(JSON.stringify(t))}};return e(n,new Set)},zn=(n,e)=>n.map((a,r)=>`<li>${e(a,r)}</li>`).join(""),M=n=>{let e=n.normalize("NFKC").toLocaleLowerCase().trim().replace(/[^\p{L}\p{N}\p{M}]+/gu,"-").replace(/^-+|-+$/g,"");return e===""?"id":/^\p{N}/u.test(e)?`id-${e}`:e},C=(n,e)=>{let a=n!==null&&n!==""?` daa-lh="${n}"`:"",r=e!==null&&e!==""?` daa-ll="${e}"`:"";return`${a}${r}`},X=(n,e)=>{if(!n&&!e)return"";let a=[];return e!=null&&e!==""?a.push(`aria-label="${e}"`):n?.["aria-label"]&&a.push(`aria-label="${n["aria-label"]}"`),n&&Object.entries(n).forEach(([r,t])=>{r!=="aria-label"&&t&&a.push(`${r}="${t}"`)}),a.length>0?` ${a.join(" ")}`:""};function ve(n,{id:e,as:a,callback:r,crossorigin:t,rel:i,fetchpriority:o}={rel:"stylesheet"}){let s=document.head.querySelector(`link[href="${n}"]`);if(s)return r?.("noop"),s;let l=document.createElement("link");return l.setAttribute("rel",i),e!==void 0&&l.setAttribute("id",e),a!==void 0&&l.setAttribute("as",a),t!==void 0&&l.setAttribute("crossorigin",t),o!==void 0&&l.setAttribute("fetchpriority",o),l.setAttribute("href",n),r&&(l.onload=d=>r(d.type),l.onerror=d=>r(typeof d=="string"?"error":d.type)),document.head.appendChild(l),l}function he(n,e){return ve(n,{rel:"stylesheet",callback:e})}function dn(n,e=!1){e&&he(n)}var pn=(n,e,{mode:a,id:r}={})=>new Promise((t,i)=>{let o=document.querySelector(`head > script[src="${n}"]`);if(!o){let{head:d}=document;o=document.createElement("script"),o.setAttribute("src",n),r!=null&&o.setAttribute("id",r),e!=null&&o.setAttribute("type",e),a&&["async","defer"].includes(a)&&o.setAttribute(a,""),d.append(o)}let s=o.dataset.loaded;if(s!=null){t(o);return}let l=d=>{o.removeEventListener("load",l),o.removeEventListener("error",l),d.type==="error"?i(new Error(`error loading script: ${o.src}`)):d.type==="load"&&(o.dataset.loaded="true",t(o))};o.addEventListener("load",l),o.addEventListener("error",l)});function B(n,e=document){let a=n&&n.includes(":")?"property":"name";return e.head.querySelector(`meta[${a}="${n}"]`)?.content??null}var be=n=>{let e=n,a=i=>i==null||typeof i!="object";if(a(e)||a(e.locale)||typeof e.locale.prefix!="string"||a(e.env)||typeof e.env.name!="string")return!1;if(e.unav!==void 0){if(typeof e.unav!="object"||e.unav===null)return!1;let i=e.unav;if(i.profile!==void 0){if(typeof i.profile!="object"||i.profile===null)return!1;let o=i.profile;if(o.signInCtaStyle!==void 0&&o.signInCtaStyle!=="primary"&&o.signInCtaStyle!=="secondary"||o.messageEventListener!==void 0&&typeof o.messageEventListener!="function")return!1}}return!(e.jarvis!==void 0&&(typeof e.jarvis!="object"||e.jarvis===null||typeof e.jarvis.id!="string"))},[cn,S]=(()=>{let n,e=!1;return[a=>{if(!e){if(!be(a))throw new Error("MiloConfig validation failed: Invalid structure");n=a,e=!0}},()=>{if(!n)throw new Error("MiloConfig not initialized. Call setMiloConfig() first.");return n}]})(),ye={en:"US","en-gb":"GB","es-mx":"MX","fr-ca":"CA",da:"DK",et:"EE",ar:"DZ",el:"GR",iw:"IL",he:"IL",id:"ID",ms:"MY",nb:"NO",sl:"SI",sv:"SE",cs:"CZ",uk:"UA",hi:"IN","zh-hans":"CN","zh-hant":"TW",ja:"JP",ko:"KR",fil:"PH",th:"TH",vi:"VN"},$n={ar:"AR_es",be_en:"BE_en",be_fr:"BE_fr",be_nl:"BE_nl",br:"BR_pt",ca:"CA_en",ch_de:"CH_de",ch_fr:"CH_fr",ch_it:"CH_it",cl:"CL_es",co:"CO_es",la:"DO_es",mx:"MX_es",pe:"PE_es",africa:"MU_en",dk:"DK_da",de:"DE_de",ee:"EE_et",eg_ar:"EG_ar",eg_en:"EG_en",es:"ES_es",fr:"FR_fr",gr_el:"GR_el",gr_en:"GR_en",ie:"IE_en",il_he:"IL_iw",it:"IT_it",lv:"LV_lv",lt:"LT_lt",lu_de:"LU_de",lu_en:"LU_en",lu_fr:"LU_fr",my_en:"MY_en",my_ms:"MY_ms",hu:"HU_hu",mt:"MT_en",mena_en:"DZ_en",mena_ar:"DZ_ar",nl:"NL_nl",no:"NO_nb",pl:"PL_pl",pt:"PT_pt",ro:"RO_ro",si:"SI_sl",sk:"SK_sk",fi:"FI_fi",se:"SE_sv",tr:"TR_tr",uk:"GB_en",at:"AT_de",cz:"CZ_cs",bg:"BG_bg",ru:"RU_ru",ua:"UA_uk",au:"AU_en",in_en:"IN_en",in_hi:"IN_hi",id_en:"ID_en",id_id:"ID_id",nz:"NZ_en",sa_ar:"SA_ar",sa_en:"SA_en",sg:"SG_en",cn:"CN_zh-Hans",tw:"TW_zh-Hant",hk_zh:"HK_zh-hant",jp:"JP_ja",kr:"KR_ko",za:"ZA_en",ng:"NG_en",cr:"CR_es",ec:"EC_es",pr:"US_es",gt:"GT_es",cis_en:"TM_en",cis_ru:"TM_ru",sea:"SG_en",th_en:"TH_en",th_th:"TH_th"};function xe(n){let e=ye[n];return!e&&$n[n]&&(e=n),!e&&n.includes("-")&&([e]=n.split("-")),e||"US"}var ln="langstore/";function In(n){let a=(n?.prefix||"US_en").replace("/","")??"",[r="US",t="en"]=($n[a]??a).split("_",2);if(a.startsWith(ln)||window.location.pathname.startsWith(`/${ln}`)){let i=a.replace(ln,"").toLowerCase();r=xe(i),t=i}return r=r.toUpperCase(),t=t.toLowerCase(),{language:t,country:r,locale:`${t}_${r}`}}var W=n=>{let e=n.querySelector("#feds-menu-wrapper");e?.classList.remove("feds-menu-active"),e?.hidePopover?.(),n.querySelector(".feds-popup:popover-open")?.hidePopover?.()};function Rn(){let n=B("gnav-source")?.split("#")[0]?.split("/").pop()?.trim();if(n!==void 0&&n!==""&&n!=="gnav")return n;let e=window.adobeid?.client_id;return typeof e=="string"&&e!==""?e:""}var J={elementNull:"Error when parsing Link. Element is null",notAnchor:"Cannot parse non-anchor as Link",textContentNotFound:"Error when parsing Link. Element has no textContent",hrefNotFound:"Element has no href"},P=n=>{if(n===null)throw new c(J.elementNull);if(n.tagName!=="A")throw new c(J.notAnchor);let[e,a]=n?.textContent?.split("|").map(i=>i.trim())??["",""];if(e==="")throw new c(J.textContentNotFound);let r=n?.getAttribute("href")??"";if(r==="")throw new c(J.hrefNotFound);let t=n.getAttribute("daa-ll");return[{type:"Link",text:e,href:r,daaLl:t,ariaLabel:a},[]]};var gn=n=>{if(!n)throw new c($.elementNull);if(!n.classList.contains("product-card"))throw new c($.notAProductCard);return F(ke).or(we).or(Ce).eval(n)},$={elementNull:"Element not found",noTitleAnchor:"Title anchor not found",noHref:"Title Anchor has no href",noTitle:"Title text not found",noSubtitleP:"Subtitle <p> not found",noSubtitle:"Subtitle text not found",notAHeader:"Expected a Header class",notAProductCard:"Expected a product-card class"},we=n=>{let e=new Set;if(!n)throw new c($.elementNull);let a=n.querySelector("p a")??n.querySelector("div ~ div > a");if(!a)throw new c($.noTitleAnchor);let r=a.textContent??"";r===""&&e.add(new g($.noTitle));let t=a.getAttribute("href")??"";t===""&&e.add(new g($.noHref));let i=a.getAttribute("daa-ll"),o=a.getAttribute("daa-lh"),s=a?.closest("p")?.nextElementSibling;s||e.add(new g($.noSubtitleP));let l=s?.textContent??"";l===""&&e.add(new g($.noSubtitle));let d=n.querySelectorAll(":scope > div:nth-child(2) > :first-child p")??[],v=Array.from(d).map(h=>{let p=h.querySelector("strong")!==null;return{text:h?.textContent?.trim()??"",isFilled:p}}),[y,w=null]=(n.firstElementChild?.firstElementChild?.textContent?.split("|")??[]).map(h=>h.trim());return[{type:"ProductCardLink",iconHref:y,iconAlt:w,title:r,href:t,subtitle:l,badges:v,daaLl:i,daaLh:o},[...e]]},ke=n=>{if(!n)throw new c($.elementNull);let e=[...n.classList];if(!e.includes("header"))throw new c($.notAHeader);let a=n.querySelector("a")?.textContent??"",r=n.querySelector("a")?.getAttribute("daa-ll")??null,t=n.querySelector("a")?.getAttribute("daa-lh")??null;if(a==="")throw new c($.noTitle);return[{type:"ProductCardHeader",title:a,classes:e,daaLl:r,daaLh:t},[]]},Ce=n=>{if(!n)throw new c($.elementNull);if(!n.classList.contains("blue"))throw new Error("Not a Blue Product Card");let e=n.querySelector("a"),[a,r]=P(e),t=e?.getAttribute("daa-ll")??null,i=e?.getAttribute("daa-lh")??null;return[{type:"ProductCardBlue",link:a,daaLl:t,daaLh:i},r]};var fn=n=>{switch(n.type){case"ProductCardHeader":return Le(n);case"ProductCardLink":return Ee(n);case"ProductCardBlue":return Se(n);default:return console.error(n),""}},Le=({title:n,classes:e,daaLl:a,daaLh:r})=>{let t=e.slice(1).map(o=>`feds-product-card--${o}`).join(" "),i=C(r,a??n);return`
  ...
  <a href="${_(n.href)}" class="feds-product-card feds-product-card--blue"${r}>
    <div class="feds-product-card__content">
        <div class="feds-product-card__title">${n.text}</div>
      </div>
  </a>
`};var G={elementNull:"Error when parsing Brand. Element is null",noLinkSection:"Error when parsing Brand. No link section found",noLink:"Error when parsing Brand. No link found",noImageSection:"Error when parsing Brand. No image section found",missingImageSections:"Error when parsing Brand. Missing mobile or desktop image section",missingThemeImages:"Error when parsing Brand. Missing mobile or desktop image section"},un=n=>{let e=new Set;if(n===null)throw new c(G.elementNull);let a=!!n.classList.contains("dark-bg"),[r,t]=n.querySelectorAll(":scope > div");if(r===void 0)throw new c(G.noLinkSection);let i=r.querySelector("a");if(i===null)throw new c(G.noLink);let o=i.getAttribute("href")??"",s=i.textContent?.trim()??"";t===void 0&&e.add(new g(G.noImageSection));let[l,d]=t?.querySelectorAll(":scope > div")??[];(l===void 0||d===void 0)&&e.add(new g(G.missingImageSections));let v=l?.querySelectorAll('a[href$=".svg"]'),y=d?.querySelectorAll('a[href$=".svg"]'),w=v?.[0]?.getAttribute("href")??"",h=v?.[0]?.textContent?.split("|")[1]?.trim()??"",p=v?.[1]?.getAttribute("href")??"",m=v?.[1]?.textContent?.split("|")[1]?.trim()??"",u=y?.[0]?.getAttribute("href")??"",f=y?.[0]?.textContent?.split("|")[1]?.trim()??"",b=y?.[1]?.getAttribute("href")??"",x=y?.[1]?.textContent?.split("|")[1]?.trim()??"";return(!w||!u||!p||!b)&&e.add(new g(G.missingThemeImages)),[{type:"Brand",data:{href:o,label:s,isDarkBg:a,imageData:{type:"svg",lightThemeImageSrc:u,lightThemeImageAlt:f,darkThemeImageSrc:b,darkThemeImageAlt:x,mobileLightThemeImageSrc:w,mobileLightThemeImageAlt:h,mobileDarkThemeImageSrc:p,mobileDarkThemeImageAlt:m}}},[...e]]};var Te=`
<?xml
...
`.trim(),_e=n=>{let{href:e,label:a,isDarkBg:r,imageData:t}=n,i=t.lightThemeImageSrc?.trim()||t.darkThemeImageSrc?.trim()||"",o=t.darkThemeImageSrc?.trim()||t.lightThemeImageSrc?.trim()||"",s=t.mobileLightThemeImageSrc?.trim()||t.mobileDarkThemeImageSrc?.trim()||"",l=t.mobileDarkThemeImageSrc?.trim()||t.mobileLightThemeImageSrc?.trim()||"",d=t.lightThemeImageAlt||t.darkThemeImageAlt||"",v=t.darkThemeImageAlt||t.lightThemeImageAlt||"",y=t.mobileLightThemeImageAlt||t.mobileDarkThemeImageAlt||"",w=t.mobileDarkThemeImageAlt||t.mobileLightThemeImageAlt||"",h=!!i,p=!!o,m=!!s,u=!!l,f=h?`<img src="${A(i)}" alt="${d}" />`:"",b=p?`<img src="${A(o)}" alt="${v}" />`:"",x=m?`<img src="${A(s)}" alt="${y}" />`:"",k=u?`<img src="${A(l)}" alt="${w}" />`:"";return`<div class="feds-brand-container${r?" feds-dark-bg":""}">
  ...
  </div>`.trim()},mn=n=>{let{data:e}=n;return _e(e)};var vn=["appswitcher","help"],Q={cs:["cz"],da:["dk"],de:["at"],en:["africa","au","ca","ie","in","mt","ng","nz","sg","za"],es:["ar","cl","co","cr","ec","gt","la","mx","pe","pr"],et:["ee"],ja:["jp"],ko:["kr"],nb:["no"],pt:["br"],sl:["si"],sv:["se"],uk:["ua"],zh:["cn","tw"]},[Z,Hn]=(()=>{let n,e,a,r=new Promise(t=>{e=t,a=setTimeout(()=>{n={},t(n)},5e3)});return[t=>{t&&!n&&(n=t,clearTimeout(a),e?.(n))},()=>r]})();function nn(n,e=!1){let s=(/uc_carts=/.test(document.cookie)?n:n?.filter(d=>d!=="cart"))??[],l=s.length??3;if(e){let d=s.filter(y=>vn.includes(y)).length;return`calc(92px + ${d*32}px + ${d*.25}rem)`}return`calc(${l*32}px + ${(l-1)*.25}rem)`}var en=n=>{if(!n.prefix||n.prefix==="/")return"en_US";let e=n.prefix.replace("/","");if(e.includes("_")){let[r,t]=e.split("_").reverse();return`${r.toLowerCase()}_${t.toUpperCase()}`}if(e==="uk")return"en_GB";let a=Object.keys(Q).find(r=>Q[r].includes(e));return a?`${a.toLowerCase()}_${e.toUpperCase()}`:`${e.toLowerCase()}_${e.toUpperCase()}`},Ae={Mac:"macOS",Win:"windows",Linux:"linux",CrOS:"chromeOS",Android:"android",iPad:"iPadOS",iPhone:"iOS"},an=()=>{let n=navigator.userAgent;for(let[e,a]of Object.entries(Ae))if(n.includes(e))return a;return"linux"},rn=async()=>{let n=window;return n.alloy?await n.alloy("getIdentity").then(e=>e?.identity?.ECID).catch(()=>{}):void 0};var Dn=()=>{try{return S().signInContext||{}}catch{return{}}},Pe=()=>{let n=S();return B("signin-cta-style")==="primary"||n?.unav?.profile?.signInCtaStyle==="primary"?"primary":"secondary"},ze=()=>{let e=S()?.unav?.profile?.messageEventListener;return e||(a=>{let{name:r,payload:t,executeDefaultAction:i}=a.detail;if(!(!r||r!=="System"||!t||typeof i!="function"))switch(t.subType){case"AppInitiated":window.adobeProfile?.getUserProfile().then(o=>{Z(o)}).catch(()=>{Z({})});break;case"SignOut":i();break;case"ProfileSwitch":Promise.resolve(i()).then(o=>{o&&window.location.reload()});break;default:break}})};function $e(){let{unav:n}=S();return n?.unavHelpChildren||[{type:"Support"},{type:"Community"}]}var K=()=>{let n=S();return{profile:{name:"profile",attributes:{accountMenuContext:{sharedContextConfig:{enableLocalSection:!0,enableProfileSwitcher:!0,miniAppContext:{logger:{trace:()=>{},debug:()=>{},info:()=>{},warn:()=>{},error:()=>{}}},complexConfig:n?.unav?.profile?.complexConfig||null,...n?.unav?.profile?.config},messageEventListener:ze()},signInCtaStyle:Pe(),isSignUpRequired:!1,callbacks:{onSignIn:()=>{window.adobeIMS?.signIn(Dn())},onSignUp:()=>{window.adobeIMS?.signIn(Dn())}}}},appswitcher:{name:"app-switcher"},notifications:{name:"notifications",attributes:{notificationsConfig:{applicationContext:{appID:n?.unav?.uncAppId||"adobecom",...n?.unav?.uncConfig}}}},help:{name:"help",attributes:{children:$e()}},jarvis:{name:"jarvis",attributes:{appid:n?.jarvis?.id,callbacks:n?.jarvis?.callbacks}},cart:{name:"cart"}}};var Un=(n,e)=>{n[0]&&"attributes"in n[0]&&n[0].attributes&&typeof n[0].attributes=="object"&&"isSignUpRequired"in n[0].attributes&&(n[0].attributes.isSignUpRequired=e)},tn=async(n,e)=>{try{let a=n.querySelector(".feds-utilities");if(!(a instanceof HTMLElement))return new g('missing ".feds-utilities" container');let r=new Set,t=document.head.querySelector('meta[name="universal-nav"]'),i=t instanceof HTMLMetaElement?t.content??"":"";t instanceof HTMLMetaElement||r.add(new g('metadata "universal-nav" is missing'));let o=i.trim();t instanceof HTMLMetaElement&&o.length===0&&r.add(new g('metadata "universal-nav" has no value'));let s=!window.adobeIMS?.isSignedInUser(),l=o.split(",").map(f=>f.trim()).filter(f=>Object.keys(K()).includes(f)||f==="signup");if(s){let f=nn(l,s);a.style.setProperty("min-width",f)}let d;try{d=S()}catch{throw new Error("MiloConfig not available for UNAV initialization")}let v=en(d.locale),y=d.env.name==="prod"?"prod":"stage",w=await rn(),h=new URLSearchParams(window.location.search).get("unavVersion");/^\d+(\.\d+)?$/.test(h??"")||(h="1.5"),await Promise.all([pn(`https://${y}.adobeccstatic.com/unav/${h}/UniversalNav.js`),dn(`https://${y}.adobeccstatic.com/unav/${h}/UniversalNav.css`,!0)]);let p=()=>{let f=K(),b=[f.profile];return Un(b,!1),l?.forEach(x=>{if(x==="profile")return;if(x==="signup"){Un(b,!0);return}let k=f[x];k&&b.push(k)}),b},m=()=>({target:a,env:y,locale:v,countryCode:In(d?.locale)?.country||"US",imsClientId:window?.adobeid?.client_id,theme:"light",analyticsContext:{consumer:{name:"adobecom",version:"1.0",platform:"Web",device:an(),os_version:navigator.platform},event:{visitor_guid:w}},children:p(),isSectionDividerRequired:!!d?.unav?.showSectionDivider,showTrayExperience:!E.matches});await window?.UniversalNav?.(m()),s||a?.style.removeProperty("min-width");let u=f=>{window?.UniversalNav?.reload(m())};return E.addEventListener("change",()=>{u()}),{reloadUnav:u,errors:r}}catch(a){let r=a instanceof Error?a.message:"failed to load universal nav";return new g(r)}};function N(n,e){return[...n.querySelectorAll(e)]}function V(n,e,a){N(n,e).forEach(r=>a?r.removeAttribute("tabindex"):r.setAttribute("tabindex","-1"))}var on={ArrowLeft:-1,ArrowRight:1,ArrowUp:-1,ArrowDown:1},Nn=new Set(["ArrowLeft","ArrowRight"]),Ie=new Set(["ArrowUp","ArrowDown"]),Re='.tabs [role="tab"][aria-selected="true"]';function hn(n,e,a){return(n+e+a)%a}function He(n,e,a,r){let t=on[a];if(Nn.has(a)){let h=e+t;return h>=0&&h<n.length?h:null}let i=getComputedStyle(r).gridTemplateColumns.split(" ").length,o=[...r.children],s=h=>{let p=n[h].parentElement;return p?o.indexOf(p):-1},l=s(e)%i,d=Math.floor(s(e)/i)+(a==="ArrowDown"?1:-1),v=Math.floor((o.length-1)/i);if(d<0||d>v)return null;let y=null,w=1/0;for(let h=0;h<n.length;h++){let p=Math.abs(s(h)%i-l);Math.floor(s(h)/i)===d&&p<w&&(w=p,y=h)}return y}function bn(n){V(n,'.tab-content [role="tabpanel"] a',!1);let e=[];N(n,".feds-popup[popover]").forEach(p=>{let m=()=>{p.matches(":popover-open")||V(p,'[role="tabpanel"] a',!1)};p.addEventListener("toggle",m),e.push(()=>p.removeEventListener("toggle",m));let u=!1,f=x=>{x.key==="Tab"&&!x.shiftKey&&(u=!0)};p.addEventListener("keydown",f),e.push(()=>p.removeEventListener("keydown",f));let b=x=>{if(u&&!p.contains(x.relatedTarget)){if(p.hidePopover?.(),!E.matches){let k=p.closest(".feds-gnav-items");k?.classList.remove("subscreen-opening"),k?.classList.add("subscreen-closing")}u=!1}};p.addEventListener("focusout",b),e.push(()=>p.removeEventListener("focusout",b))});let a=(p,m)=>{p.focus(),m.preventDefault()},r=()=>n.querySelector(".feds-popup:popover-open"),t=p=>p.querySelector(Re),i=p=>p.querySelector('[role="tabpanel"]:not([hidden])');function o(p){let m=r(),u=n.querySelector("#feds-menu-wrapper");if(!u)return!1;let f=u.querySelector(".feds-gnav-items"),b=m?m.querySelector(".feds-popup-back-button"):null,x=f?.classList.contains("subscreen-opening")===!0;if(m!==null&&x&&b!==null)return b.click(),p.preventDefault(),!0;let k=m??(u?.matches(":popover-open")?u:null);if(!k)return!1;k.hidePopover?.();let L=m?`[popovertarget="${k.id}"]`:".feds-nav-toggle";return n.querySelector(L)?.focus(),p.preventDefault(),!0}function s(p,m,u){if(!Nn.has(m))return!1;let f=N(n,".feds-gnav-items > li > .feds-link"),b=f.indexOf(p);return b<0?!1:(a(f[hn(b,on[m],f.length)],u),!0)}function l(p,m,u,f){let b=N(m,'.tabs :is([role="tab"], .product-links a)'),x=b.indexOf(p);if(x<0)return!1;let k=E.matches?{ArrowLeft:0,ArrowRight:0,ArrowUp:-1,ArrowDown:1}:{ArrowLeft:-1,ArrowRight:1,ArrowUp:0,ArrowDown:0};if(k[u]){let L=b[hn(x,k[u],b.length)];return L.matches('[role="tab"]')&&L.click(),a(L,f),!0}if(u in k)return f.preventDefault(),!0;if(u==="Tab"&&!f.shiftKey&&p.matches('[aria-selected="true"]')){let L=i(m);if(!L)return!1;V(L,"a",!0);let sn=L.querySelector("a");return sn&&a(sn,f),!0}return!1}function d(p,m,u,f){let b=i(m);if(!b)return!1;let x=N(b,"a"),k=x.indexOf(p);if(k<0)return!1;if(on[u]){let L=He(x,k,u,b);return L!==null?(a(x[L],f),!0):u==="ArrowUp"?(V(b,"a",!1),a(t(m)??x[0],f),!0):!1}if(u==="Tab"&&!f.shiftKey){if(k+1<x.length)a(x[k+1],f);else return!1;return!0}if(u==="Tab"&&f.shiftKey){if(k>0)a(x[k-1],f);else{V(b,"a",!1);let L=t(m)??N(m,'.tabs :is([role="tab"], .product-links a)')[0];L&&a(L,f)}return!0}return!1}function v(p,m,u,f){if(!Ie.has(u))return!1;let b=N(m,".feds-gnav-cards a"),x=b.indexOf(p);return x<0?!1:(a(b[hn(x,on[u],b.length)],f),!0)}function y(p){let m=document.activeElement??p.target;if(p.key==="Escape"){o(p);return}let u=r();u&&(u.matches(":has(.product-list)")&&(l(m,u,p.key,p)||d(m,u,p.key,p))||u.matches(":has(.feds-gnav-cards)")&&v(m,u,p.key,p))||s(m,p.key,p)}let w=n.querySelector(".trap-focus-gnav"),h=p=>{n.querySelector(".feds-menu-active")&&(p.preventDefault(),n.querySelector(".feds-nav-toggle")?.focus())};return w?.addEventListener("focus",h),e.push(()=>w?.removeEventListener("focus",h)),n.addEventListener("keydown",y),e.push(()=>n.removeEventListener("keydown",y)),()=>e.forEach(p=>p())}var De="feds-milo",T=(n,e="default",a="e")=>{let{locale:r}=S(),t=B("gnav-source")??`${r.contentRoot??""}/gnav`;window.lana||console.warn("lana logging unavailable in the gnav"),window?.lana?.log(`${n} | gnav-source: ${t} | href: ${window.location.href}`,{clientId:De,sampleRate:1,tags:e,errorType:a})};var c=class n extends Error{constructor(e){super(e),Object.setPrototypeOf(this,n.prototype)}},g=class n extends Error{constructor(e,a="Minor"){super(e),Object.setPrototypeOf(this,n.prototype),a==="Critical"&&T(e)}};var jn=n=>e=>{if(e===null)throw new Error("");let a=e.querySelector(Ue(n));if(!a)throw new Error("");let r=a.textContent??"",[t="",i=""]=r.split("|").map(y=>y.trim());if(t==="")throw new Error("");let o=a.getAttribute("href")??"";if(o==="")throw new Error("");let s=a.getAttribute("daa-ll"),l=a.getAttribute("aria-label")?.trim()??"",d=l!==""?l:i!==""?i:void 0,v=[];return[{type:n.type,text:t,href:o,ariaLabel:d,daaLl:typeof s=="string"&&s.trim()!==""?s:t},v]},yn=jn({type:"PrimaryCTA"}),R=jn({type:"SecondaryCTA"}),qn=n=>F(yn).or(R).eval(n),Ue=({type:n})=>{switch(n){case"PrimaryCTA":return"strong > a";case"SecondaryCTA":return"em > a";default:throw new Error("")}};var xn=({text:n,href:e,daaLl:a,ariaLabel:r,ariaAttrs:t})=>`
<a href="${_(e)}"
...
`,Bn=n=>n.type==="PrimaryCTA"?xn(n):H(n);var O=({text:n,href:e,daaLl:a,ariaLabel:r,ariaAttrs:t,svgIcon:i=""})=>`<a class="feds-link" href="${_(e)}"${X(t,r)}${C(null,a??n)}>${n}${i}</a>`;var Gn=n=>{let[e,a]=Ne(n);return[{type:"LinksCard",card:e},a]},Ne=n=>{let e=n.querySelector("h2, h3, h4")||null;if(!e)throw new c("Expected links card title");let a=n.querySelector("em > a"),r=[...n.querySelectorAll("a")].filter(l=>l!==a);if(r.length===0)throw new c("Expected at least one link");let[t,i]=z(r,P),[o,s]=(()=>{try{return R(n)}catch{return[null,[]]}})();return o&&(o.daaLl=`${e.textContent??""} - ${o?.daaLl}`),[{type:"LinksCardItem",title:e.textContent??"",links:t,footerCTA:o},[...i,...s]]};var On=(n,e="",a=new Map)=>{let r=[...n.querySelectorAll("li > div")],t=[...n.querySelectorAll("li > a")],[i,o]=z(r,je),[s,l]=z(t,P);return[{type:"ProductList",megaMenuTitle:e,categories:i,links:s,placeholders:a},[...o,...l]]},je=n=>{let e=n.firstElementChild;if(e?.nodeName!=="H2")throw new c("Expected H2");let a=e.textContent??"",r=e.textContent??"",t=Sn(e),[i,o]=z(t,gn);return[{type:"ProductCategory",name:a,daaLl:r,links:i},o]};var Fn=n=>{let[e,a]=qe(n);return[{type:"FeaturedCard",card:e},a]},qe=n=>{let e=n.querySelector("h5")||null;if(!e)throw new g("Eye brow element not found");let a=n.querySelector("h4")||null,r=a?.nextElementSibling||null;if(!a)throw new c("Expected title");if(!r)throw new c("Expected subtitle");let t=r.nextElementSibling?.firstElementChild||null;if(!t)throw new c("Expected card link after subtitle");let[i,o]=P(t),[s,l]=R(n);return[{type:"Card",title:a.textContent??"",subtitle:r.textContent??"",bodyLink:i,footerCTA:s,eyeBrow:e.textContent??""},[...l,...o]]};var I={MissingBackgroundImageSection:"Promo card is missing background image section",MissingBackgroundImage:"Promo card is missing background image",MissingBackgroundImageAlt:"Promo card background image is missing alt text",MissingBackgroundImageSrc:"Promo card background image is missing src",MissingContentSection:"Promo card is missing card details section",MissingIcon:"Promo card is missing icon",MissingIconSrc:"Promo card icon is missing src",MissingIconAlt:"Promo card icon is missing alt text",MissingTitleElement:"Promo card is missing title element",MissingTitleText:"Promo card is missing title text",MissingSecondaryCtaAnchor:"Promo card is missing secondary CTA anchor",MissingPriceLink:"Promo card is missing price link"},Xn=n=>{let[e,a]=n.querySelectorAll(":scope > div"),r=new Set;if(e===void 0)throw new c(I.MissingBackgroundImageSection);let t=e.querySelector(":scope picture:not(:scope p picture) img")??null;t===null&&r.add(new g(I.MissingBackgroundImage));let i=t?.getAttribute("alt")??"";i===""&&r.add(new g(I.MissingBackgroundImageAlt));let o=t?.getAttribute("src")??"";if(o===""&&r.add(new g(I.MissingBackgroundImageSrc)),a===void 0)throw new c(I.MissingContentSection);let s=a.querySelector('a[href$=".svg"]')??null;s===null&&r.add(new g(I.MissingIcon));let[l,d]=(s?.textContent?.split("|")??["",""]).map(x=>x.trim());l===""&&r.add(new g(I.MissingIconSrc)),d===""&&r.add(new g(I.MissingIconAlt));let v=a.querySelector('p > a:not([href$=".svg"])')??null,y=v?.textContent?.trim()??"",w=v?.getAttribute("href")??"",h=w?En(w):!1;v===null&&r.add(new g(I.MissingPriceLink));let p=a.querySelector("p > strong")??null;if(p===null)throw new c(I.MissingTitleElement);let m=p?.textContent??"";m===""&&r.add(new g(I.MissingTitleText)),a.querySelector("em > a")===null&&r.add(new g(I.MissingSecondaryCtaAnchor));let[f,b]=(()=>{try{return R(n)}catch{return[null,[]]}})();return b.forEach(x=>r.add(x)),f&&(f.daaLl=`${m} - ${f?.daaLl}`),[{type:"PromoCard",card:{bgImageAlt:i,bgImageSrc:o,iconAlt:d,iconSrc:l,title:m,cta:f,priceText:y,priceHref:w,isPriceMerchLink:h}},[...r]]};var Zn=n=>{let e=new Set;if(n===null)throw new c(Wn.elementNull);let a=n.querySelector("h2")?.textContent??"";a===""&&e.add(new g(Wn.noTitle));let r=(async()=>{try{let t=n.querySelector("a"),i=new URL(t?.href??""),o=await q(i);if(o instanceof c)throw new Error(o.message);let s=await Pn(o);if(s instanceof c)throw new Error(s.message);if(An(i.href,s),n.classList.contains("product-list")){let l=await j();return On(s,a,l)}return Be(s,a)}catch(t){throw new c(t?.message)}})();if(r instanceof c)throw r;return[{type:"MegaMenu",title:a,content:r},[...e]]},Wn={elementNull:"Element is null",noTitle:"Large Menu has no Title"},Be=(n,e)=>{let a=[...n.children];if(a.length===0)throw new c("No mega menu items found (did you forget to add them correctly?)");let[r,t]=z(a,i=>Ge(i));if(r.length===0)throw new c("Failed to parse gnav cards sections");return[{type:"GnavCards",megaMenuTitle:e,sections:r},t]},Ge=n=>{let e=[...n.querySelectorAll(".featured-card, .links-card, .promo-card")];if(e.length===0)throw new c("Column contains no cards (did you forget to label them correctly?)");let[a,r]=z(e,t=>Oe(t));if(a.length===0)throw new c("Failed to parse cards in column");return[{type:"GnavColumn",cards:a},r]},Oe=n=>{if(n.classList.contains("featured-card"))return Fn(n);if(n.classList.contains("links-card"))return Gn(n);if(n.classList.contains("promo-card"))return Xn(n);throw new c("Unsupported gnav cards section")};var Kn=({card:n},e)=>Fe(n,e),Fe=({title:n,subtitle:e,eyeBrow:a,footerCTA:r,bodyLink:t},i)=>{let o=`featured-eyebrow-${M(a)}`;return`
...
`.trim()};var Vn=({card:n})=>Xe(n),Xe=({title:n,links:e,footerCTA:a})=>`
  <article class="links-card" ${C(n,"")}>
    <div>
      <h2 id="links-card-${M(n)}" class="links-card-title" role="heading" aria-level="2">${n}</h2>
      <ul class="links-card-links" aria-labelledby="links-card-${M(n)}">
        ${e.map(r=>`<li>${O(r)}</li>`).join("")}
      </ul>
    </div>
    ${a===null?"":`
    <div class="links-card-footer">
      ${H({...a,ariaAttrs:{"aria-describedby":`links-card-${M(n)}`}})}
    </div>`}
  </article>
...
`;var Qn=({categories:n,links:e,placeholders:a})=>{let r=`
    <ul class="tabs" role="tablist">
      ${n.map(Ke).join("")}
      ${e.length?`<li class="product-links"><a class="feds-link" href="${_(e[e.length-1].href)}"${C(null,e[e.length-1].daaLl??e[e.length-1].text)}>${e[e.length-1].text}${D.chevronRight}</a></li>`:""}
    </ul>
  `.trim(),t=`
  ...
  <div id="${M(n)}" popover class="feds-popup">
  </div>
`,ee=(n,e)=>{let{megaMenuTitle:a}=n,r=`
  ...
  `.trim(),o="";switch(n.type){case"ProductList":o=Qn(n);break;case"GnavCards":o=Jn(n);break;default:}return`${i}${o}`};var ae={elementNull:"Error when parsing text. Element is null",textContentNull:"Error when parsing text. Element has no textContent"},re=n=>{if(n===null)return[{type:"Text",content:""},[new g(ae.elementNull,"Minor")]];let e=n.textContent;return e===null?[{type:"Text",content:""},[new g(ae.textContentNull,"Minor")]]:[{type:"Text",content:e},[]]};var te=({content:n})=>n;var oe=n=>{if(n===null)throw new c(Ve.elementNull);let e=n.querySelector(".gnav-brand");if(e!==null)return un(e);let a=n.querySelector(".large-menu");return a!==null?Zn(a):n.querySelector("strong")!==null?yn(n):n.querySelector("em")!==null?R(n):n.querySelector("a")===null?re(n):P(n.querySelector("a"))},wn=(n,e)=>{switch(n.type){case"Text":return te(n);case"Link":return O(n);case"SecondaryCTA":return H(n);case"PrimaryCTA":return xn(n);case"Brand":return mn(n);case"MegaMenu":return ne(n,e);default:return console.error(`Failed to recognize component: ${n}`),""}},Ve={elementNull:"Element is null"};var ie=(n,e,a=new Map)=>{let[r,t]=z([...document.querySelectorAll(".breadcrumbs ul > li > a")??[]],P),[i,o]=z([...n.children],oe),s=n.querySelector(".product-entry-cta"),[l,d]=(()=>{try{return qn(s)}catch{return[null,[]]}})(),v=!1,y=[t,o,d].flat();return{breadcrumbs:r,components:i,productCTA:l,localnav:v,errors:y,unavEnabled:e,placeholders:a}};var se=n=>{let e=n.querySelector(".feds-skip-link"),a=l=>{let d=document.querySelector("#main-content");d instanceof HTMLElement&&(l.preventDefault(),d.hasAttribute("tabindex")||d.setAttribute("tabindex","-1"),setTimeout(()=>{d.focus(),d.scrollIntoView({behavior:"smooth",block:"start"})},100))};e?.addEventListener("click",a);let r=[...n.querySelectorAll('.tabs button[role="tab"]')],t=[...n.querySelectorAll(".tab-content ul")],i=r.map((l,d)=>()=>{let v=t[d].closest(":popover-open");if(r.forEach(h=>{h.setAttribute("aria-selected","false")}),t.forEach(h=>{h.setAttribute("hidden","true")}),t[d]?.removeAttribute("hidden"),l.setAttribute("aria-selected","true"),!v||!E.matches)return;let y=le();if(!y)return;let w=v?.clientHeight??0;y.style.height=`${w+72}px`});r.forEach((l,d)=>{l.addEventListener("click",i[d])});let o=n.querySelector('.tabs[role="tablist"]'),s=()=>{o&&(E.matches?o.setAttribute("aria-orientation","vertical"):o.removeAttribute("aria-orientation"))};return s(),E.addEventListener("change",s),Ye(n),()=>{e?.removeEventListener("click",a),r.forEach((l,d)=>{l.removeEventListener("click",i[d])}),E.removeEventListener("change",s)}},le=()=>[...document.adoptedStyleSheets.flatMap(n=>[...n.cssRules])].find(n=>n?.selectorText==="header.global-navigation nav::after"),Ye=n=>{let e=[...n.querySelectorAll(".feds-gnav-items > li > button")],a=n.querySelector(".feds-gnav-items"),r=le(),t=new ResizeObserver(i=>{if(i.length<1)return;let o=n.querySelector(".feds-popup:popover-open");if(!o){r.style.height="100%";return}let l=o.clientHeight<1?"100%":`${o.clientHeight+72}px`;r.style.height=l});e.forEach(i=>{if(!r)return;let o=i.nextElementSibling;o&&(t.observe(o),o.addEventListener("toggle",s=>{if(s.newState!=="open"&&!n.querySelector(".feds-popup:popover-open")){if(r.style.height="100%",E.matches)return;a?.classList.remove("subscreen-opening"),a?.classList.add("subscreen-closing")}else r.style.height=`${o.clientHeight+72}px`}))}),e.forEach(i=>{i.addEventListener("click",()=>{if(E.matches||!a)return;let o=i.nextElementSibling;o&&(a.classList.remove("subscreen-closing"),a.classList.add("subscreen-opening"),o.querySelector(".feds-popup-back-button")?.addEventListener("click",()=>{a.classList.remove("subscreen-opening"),a.classList.add("subscreen-closing"),setTimeout(()=>o.hidePopover(),240)}))})}),E.addEventListener("change",()=>{a?.classList.remove("subscreen-opening"),a?.classList.remove("subscreen-closing")}),n.querySelector(".feds-nav-toggle")?.addEventListener("click",()=>{a?.classList.remove("subscreen-opening"),a?.classList.remove("subscreen-closing")})};var de=async n=>{let e=new Set,a=n.querySelectorAll("a.merch");if(a.length===0)return e;try{let r=S(),{base:t}=r;if(!t)return e.add(new g("base not found in config, cannot initialize merch links")),e;let i=await import(`${t}/blocks/merch/merch.js`),{default:o}=i;if(!o)return e.add(new g("decorateMerchLink not found in merch module")),e;a.forEach(s=>{o(s)})}catch(r){e.add(new g(`Error initializing merch links: ${r}`))}return e};var pe=async({gnavSource:n,asideSource:e})=>{let a=await q(n);if(a instanceof c)return a;let r=await q(e);return{mainNav:a,aside:r}};var ce=new CSSStyleSheet;ce.replaceSync(String.raw`/**
...
`);document.adoptedStyleSheets=[...document.adoptedStyleSheets,ce];var ko=async n=>{let{gnavSource:e,mountpoint:a,unavEnabled:r,miloConfig:t,personalization:i}=n;if(!(e instanceof URL))throw T(`gnavSource is invalid: ${e}`),new c("gnavSource needs to be a URL object");try{cn(t)}catch(v){throw T(`Failed to initialize MiloConfig: ${v}`),new c(`Failed to initialize MiloConfig: ${v}`)}Tn(i),Mn(n.localizeLink??(v=>v)),Ln(kn(n));let o=await pe(n);if(o instanceof c)throw T(o.message),o;let{mainNav:s,aside:l}=o;if(s instanceof c)throw T(s.message),s;let d=ie(s,r,await j());if(d instanceof c)throw T(d.message),d;return await Je(d)(a),na(n)},Je=n=>async e=>{let a=Qe(n);document.querySelector("main")?.setAttribute("id","main-content"),e.innerHTML=a,e.classList.add("site-pivot"),e.querySelector("nav")?.showPopover();let r=[...e.querySelectorAll(".mega-menu ~ .feds-popup")];r.forEach(s=>{s.innerHTML=""});let i=n.components.filter(s=>s.type==="MegaMenu").map(s=>s.content),o=await Promise.all(i.map(async(s,l)=>{try{let[d,v]=await s;return r[l].innerHTML=ee(d,r[l].id),v}catch(d){return[d]}}).flat());return e},Qe=({components:n,productCTA:e,unavEnabled:a,placeholders:r})=>`
<nav popover="manual" data-lenis-prevent>
  ...
  <ul role="presentation">
    ${(()=>{let t=n.find(d=>d.type==="Brand")??null,i=n.filter(d=>d.type!=="Brand"),o=`
      ...
      `.trim(),s=t?wn(t):"",l=zn(i,wn);return`
...
`,na=async n=>{let e=new Set,a=await tn(n.mountpoint);a instanceof g?(e.add(a),T(a.message)):a.errors.forEach(o=>e.add(o)),se(n.mountpoint),bn(n.mountpoint),ea(n.mountpoint),aa(n.mountpoint),ra(n.mountpoint),oa(n.mountpoint),ia(n.mountpoint,n.mepMartech??"");let r=()=>{document.querySelector("nav[popover]")?.removeAttribute("popover"),W(n.mountpoint)};document.querySelector(".dialog-modal")&&r(),document.addEventListener("click",o=>{o.target instanceof Element&&o.target.closest('a[href*="#openPrivacy"]')&&r()}),window.addEventListener("milo:modal:loaded",r),window.addEventListener("milo:modal:closed",()=>{let o=document.querySelector("nav");o?.setAttribute("popover","manual"),o?.showPopover?.()}),(await de(n.mountpoint)).forEach(o=>{e.add(o),T(o.message)});let i=a instanceof g?()=>{}:a.reloadUnav;return{closeEverything:ta,reloadUnav:i,errors:e,setGnavTopPosition:o=>{},getGnavTopPosition:()=>0}},ea=n=>{let e=n.querySelector("#feds-menu-wrapper"),a=n.querySelector(".feds-nav-toggle");e?.addEventListener("toggle",()=>{let t=e.matches(":popover-open");a?.setAttribute("aria-expanded",String(t)),a?.setAttribute("daa-ll",t?"hamburgermenu|close":"hamburgermenu|open"),t&&e.classList.add("feds-menu-active")}),e?.addEventListener("transitionend",()=>{e.matches(":popover-open")||e.classList.remove("feds-menu-active")}),n.querySelectorAll(".feds-popup[popover]").forEach(t=>{t.addEventListener("toggle",()=>{let i=n.querySelector(`[popovertarget="${t.id}"]`),o=t.matches(":popover-open");i?.setAttribute("aria-expanded",String(o)),i?.setAttribute("daa-ll",o?"header|Close":"header|Open")})})},aa=n=>{E.addEventListener("change",()=>{W(n)})},ra=n=>{[...n.querySelector(".feds-utilities #universal-nav")?.children??[]].forEach(e=>{e.addEventListener("click",()=>W(n)),e.addEventListener("keydown",a=>{a.key==="Enter"&&W(n)})})};var ta=()=>{},oa=n=>{let e=n.closest("header");if(!e)return;let a=n.querySelector("#feds-menu-wrapper"),r=()=>a?.matches(":popover-open")??!1,t=()=>window.scrollY>100,i=()=>{if(r()){e.classList.remove("feds-header-scrolled");return}if(t()){e.classList.add("feds-header-scrolled");return}e.classList.remove("feds-header-scrolled")};i(),window.addEventListener("scroll",i,{passive:!0}),a?.addEventListener("toggle",i)},ia=(n,e)=>{let a=n.closest("header");a!==null&&a.setAttribute("daa-lh",`gnav|${Rn()}${e}`)};export{ko as main,na as postRenderingTasks,Je as renderGnav,Qe as renderGnavString};
