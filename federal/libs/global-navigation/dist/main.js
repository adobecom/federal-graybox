var wn=async n=>{let{placeholders:e}=n,{locale:a}=L(),t=`${J()}${a.prefix}/federal/globalnav/placeholders.json`,[i,o]=await Promise.all([e,ce(t)]);return new Map([...o,...i])},ce=async n=>{try{let e=await fetch(n);if(!e.ok)throw new g(`Federal placeholders not found at ${n}`);let a=ge(await e.json());if(a instanceof g)throw a;return new Map(a.data.map(({key:r,value:t})=>[r,t]))}catch(e){if(e instanceof g)console.error(e.message);else{let a=new g(e.message);console.error(a.message)}return E(`Failed to fetch placeholders from ${n}`),new Map([])}},ge=n=>{try{let{data:e}=n;if(!e.every(({key:r,value:t})=>typeof r=="string"&&typeof t=="string"))throw new Error("data is not valid");return n}catch(e){return new g(e.message)}};function kn(n,e){let a=/{{(.*?)}}|%7B%7B(.*?)%7D%7D/g;return a.test(n)?n.replace(a,(t,i,o)=>{let s=i??o??"";return e.get(s)??s}):n}var[Cn,j]=(()=>{let n;return[e=>{n||(n=e)},()=>{if(!n)throw new Error("Placeholders not initialized. Call setPlaceholders() first.");return n}]})();var P=window.matchMedia("(min-width: 1024px)"),D={brand:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" id="Layer_1" viewBox="0 0 64.57 35"><defs><style>.cls-1{fill: #eb1000;}</style></defs><path class="cls-1" d="M6.27,10.22h4.39l6.2,14.94h-4.64l-3.92-9.92-2.59,6.51h3.08l1.23,3.41H0l6.27-14.94ZM22.03,13.32c.45,0,.94.04,1.43.16v-3.7h3.88v14.72c-.89.4-2.81.89-4.73.89-3.48,0-6.47-1.98-6.47-5.93s2.88-6.13,5.89-6.13ZM22.52,22.19c.36,0,.65-.07.94-.16v-5.42c-.29-.11-.58-.16-.96-.16-1.27,0-2.45.94-2.45,2.92s1.2,2.81,2.47,2.81ZM34.25,13.32c3.23,0,5.98,2.18,5.98,6.02s-2.74,6.02-5.98,6.02-6-2.18-6-6.02,2.72-6.02,6-6.02ZM34.25,22.13c1.11,0,2.14-.89,2.14-2.79s-1.03-2.79-2.14-2.79-2.12.89-2.12,2.79.96,2.79,2.12,2.79ZM41.16,9.78h3.9v3.7c.47-.09.96-.16,1.45-.16,3.03,0,5.84,1.98,5.84,5.86,0,4.1-2.99,6.18-6.53,6.18-1.52,0-3.46-.31-4.66-.87v-14.72ZM45.91,22.17c1.34,0,2.56-.96,2.56-2.94,0-1.85-1.2-2.72-2.5-2.72-.36,0-.65.04-.91.16v5.35c.22.09.51.16.85.16ZM58.97,13.32c2.92,0,5.6,1.87,5.6,5.64,0,.51-.02,1-.09,1.49h-7.27c.4,1.32,1.56,1.94,3.01,1.94,1.18,0,2.27-.29,3.5-.82v2.97c-1.14.58-2.5.82-3.9.82-3.7,0-6.58-2.23-6.58-6.02s2.61-6.02,5.73-6.02ZM60.93,18.02c-.2-1.27-1.05-1.78-1.92-1.78s-1.58.54-1.87,1.78h3.79Z"/></svg>',company:'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="22" viewBox="0 0 24 22" fill="none"><path d="M14.2353 21.6209L12.4925 16.7699H8.11657L11.7945 7.51237L17.3741 21.6209H24L15.1548 0.379395H8.90929L0 21.6209H14.2353Z" fill="#EB1000"/></svg>',search:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" focusable="false"><path d="M14 2A8 8 0 0 0 7.4 14.5L2.4 19.4a1.5 1.5 0 0 0 2.1 2.1L9.5 16.6A8 8 0 1 0 14 2Zm0 14.1A6.1 6.1 0 1 1 20.1 10 6.1 6.1 0 0 1 14 16.1Z"></path></svg>',home:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" height="25" viewBox="0 0 18 18" width="25"><path fill="#6E6E6E" d="M17.666,10.125,9.375,1.834a.53151.53151,0,0,0-.75,0L.334,10.125a.53051.53051,0,0,0,0,.75l.979.9785A.5.5,0,0,0,1.6665,12H2v4.5a.5.5,0,0,0,.5.5h4a.5.5,0,0,0,.5-.5v-5a.5.5,0,0,1,.5-.5h3a.5.5,0,0,1,.5.5v5a.5.5,0,0,0,.5.5h4a.5.5,0,0,0,.5-.5V12h.3335a.5.5,0,0,0,.3535-.1465l.979-.9785A.53051.53051,0,0,0,17.666,10.125Z"/></svg>',chevronLeft:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" focusable="false"><path d="M12.5 4l-5 6 5 6" stroke="currentColor" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>',chevronRight:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="3" height="6" viewBox="0 0 3 6" focusable="false"><path d="M.5.5 2.5 3 .5 5.5" stroke="currentColor" stroke-width="1" fill="none"/></svg>',chevronDown:'<svg class="chevron-down" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="6" height="3.375" viewBox="0 0 6 3.375" focusable="false"><path d="M.5.5 3 2.875 5.5.5" stroke="currentColor" stroke-width="1" fill="none"/></svg>'},fe=["/tools/ost?","/miniplans"],Ln=n=>fe.some(e=>n.includes(e));var En=n=>{let e=[],a=n.nextElementSibling??null;for(;a!==null;)e.push(a),a=a.nextElementSibling??null;return e},X=n=>({eval:n,or:e=>X(a=>{try{return n(a)}catch{return e(a)}})}),A=(n,e)=>n.reduce(([a,r],t)=>{try{let[i,o]=e(t);return[[...a,i],[...r,...o]]}catch(i){return i instanceof c?[a,[i,...r]]:[a,r]}},[[],[]]),[Sn,ue]=(()=>{let n,e=!1;return[a=>{e||(n=a,e=!0)},()=>{if(!n)throw new Error("PersonalizationConfig not initialized. Call setPersonalizationConfig() first.");return n}]})(),[Tn,Mn]=(()=>{let n=e=>e;return[e=>{n=e},()=>n]})(),T=n=>{try{return Mn()(n)}catch{return n}},q=async n=>{try{if(n===null)return new c("URL is null");let e=`${n.origin}${n.pathname.replace(/(\.html$|$)/,".plain.html")}${n.hash}`,a=Mn()(e),r=M(a),t=await fetch(r);if(!t.ok)return E(`Request for ${r} failed`),new c(`Request for ${r} failed`);let i=await t.text(),o=await j(),s=kn(i,o),{body:l}=new DOMParser().parseFromString(s,"text/html");try{let{handleCommands:d,commands:v}=ue();d(v,l)}catch(d){E(`Personalization not applied: ${d?.message}`)}return l}catch(e){return new c(e?.message)}},U,J=()=>{if(U)return U;let n=["https://www.adobe.com","https://business.adobe.com","https://blog.adobe.com","https://milo.adobe.com","https://news.adobe.com","graybox.adobe.com"];if(U)return U;let e=window.location.origin;U=n.some(t=>{let i=e.replace(".stage","");return t.startsWith("https://")?i===t:i.endsWith(t)})?e:"https://www.adobe.com";let r=window.location.hostname.includes(".aem.")?"aem":"hlx";return(e.includes("localhost")||e.includes(`.${r}.`))&&(U=`https://main--federal--adobecom.aem.${e.endsWith(".live")?"live":"page"}`),U},M=(n="")=>{if(n.includes("stage.adobe.com"))return n.replace("c2-poc--milo--adobecom","main--federal--adobecom");if(n.includes("c2-poc-feds-gnav--milo--adobecom"))return n.replace("c2-poc-feds-gnav--milo--adobecom","main--federal--adobecom");if(n.includes("localhost:3000"))return n.replace("localhost:3000","main--federal--adobecom.aem.page");if(typeof n!="string"||!n.includes("/federal/"))return n;if(n.startsWith("/"))return`${J()}${n}`;try{let{pathname:e,search:a,hash:r}=new URL(n);return`${J()}${e}${a}${r}`}catch(e){let a=e instanceof Error?e.message:String(e);console.warn(`getFederatedUrl errored parsing the URL: ${n}: ${a}`)}return n},_n=(n,e)=>{let a=(r,t)=>{let i=`${r}[${t}^="./media_"]`;e.querySelectorAll(i).forEach(s=>{let l=s.getAttribute(t);if(!(l===null||l===""))try{let d=M(new URL(l,new URL(n,window.location.href)).href);s.setAttribute(t,d)}catch(d){console.warn(`[MediaPathError]: Failed to process relative media path (${l}) for ${r}`,d)}})};a("img","src"),a("source","srcset")},Pn=async n=>{let e=async(a,r)=>{if(a instanceof c)return a;try{let i=[...a.querySelectorAll('a[href*="#_inline"]')].map(async o=>{try{if(r.has(o.href))return;let s=M(o.href),l=new URL(s),d=await q(l);if(r.add(o.href),d instanceof c)throw d;await e(d,r),o.replaceWith(...d.children);return}catch{return}},[]);return await Promise.all(i),a}catch(t){return new c(JSON.stringify(t))}};return e(n,new Set)},An=(n,e)=>n.map((a,r)=>`<li>${e(a,r)}</li>`).join(""),S=n=>{let e=n.normalize("NFKC").toLocaleLowerCase().trim().replace(/[^\p{L}\p{N}\p{M}]+/gu,"-").replace(/^-+|-+$/g,"");return e===""?"id":/^\p{N}/u.test(e)?`id-${e}`:e},C=(n,e)=>{let a=n!==null&&n!==""?` daa-lh="${n}"`:"",r=e!==null&&e!==""?` daa-ll="${e}"`:"";return`${a}${r}`},W=(n,e)=>{if(!n&&!e)return"";let a=[];return e!=null&&e!==""?a.push(`aria-label="${e}"`):n?.["aria-label"]&&a.push(`aria-label="${n["aria-label"]}"`),n&&Object.entries(n).forEach(([r,t])=>{r!=="aria-label"&&t&&a.push(`${r}="${t}"`)}),a.length>0?` ${a.join(" ")}`:""};function me(n,{id:e,as:a,callback:r,crossorigin:t,rel:i,fetchpriority:o}={rel:"stylesheet"}){let s=document.head.querySelector(`link[href="${n}"]`);if(s)return r?.("noop"),s;let l=document.createElement("link");return l.setAttribute("rel",i),e!==void 0&&l.setAttribute("id",e),a!==void 0&&l.setAttribute("as",a),t!==void 0&&l.setAttribute("crossorigin",t),o!==void 0&&l.setAttribute("fetchpriority",o),l.setAttribute("href",n),r&&(l.onload=d=>r(d.type),l.onerror=d=>r(typeof d=="string"?"error":d.type)),document.head.appendChild(l),l}function ve(n,e){return me(n,{rel:"stylesheet",callback:e})}function ln(n,e=!1){e&&ve(n)}var dn=(n,e,{mode:a,id:r}={})=>new Promise((t,i)=>{let o=document.querySelector(`head > script[src="${n}"]`);if(!o){let{head:d}=document;o=document.createElement("script"),o.setAttribute("src",n),r!=null&&o.setAttribute("id",r),e!=null&&o.setAttribute("type",e),a&&["async","defer"].includes(a)&&o.setAttribute(a,""),d.append(o)}let s=o.dataset.loaded;if(s!=null){t(o);return}let l=d=>{o.removeEventListener("load",l),o.removeEventListener("error",l),d.type==="error"?i(new Error(`error loading script: ${o.src}`)):d.type==="load"&&(o.dataset.loaded="true",t(o))};o.addEventListener("load",l),o.addEventListener("error",l)});function B(n,e=document){let a=n&&n.includes(":")?"property":"name";return e.head.querySelector(`meta[${a}="${n}"]`)?.content??null}var he=n=>{let e=n,a=i=>i==null||typeof i!="object";if(a(e)||a(e.locale)||typeof e.locale.prefix!="string"||a(e.env)||typeof e.env.name!="string")return!1;if(e.unav!==void 0){if(typeof e.unav!="object"||e.unav===null)return!1;let i=e.unav;if(i.profile!==void 0){if(typeof i.profile!="object"||i.profile===null)return!1;let o=i.profile;if(o.signInCtaStyle!==void 0&&o.signInCtaStyle!=="primary"&&o.signInCtaStyle!=="secondary"||o.messageEventListener!==void 0&&typeof o.messageEventListener!="function")return!1}}return!(e.jarvis!==void 0&&(typeof e.jarvis!="object"||e.jarvis===null||typeof e.jarvis.id!="string"))},[pn,L]=(()=>{let n,e=!1;return[a=>{if(!e){if(!he(a))throw new Error("MiloConfig validation failed: Invalid structure");n=a,e=!0}},()=>{if(!n)throw new Error("MiloConfig not initialized. Call setMiloConfig() first.");return n}]})(),be={en:"US","en-gb":"GB","es-mx":"MX","fr-ca":"CA",da:"DK",et:"EE",ar:"DZ",el:"GR",iw:"IL",he:"IL",id:"ID",ms:"MY",nb:"NO",sl:"SI",sv:"SE",cs:"CZ",uk:"UA",hi:"IN","zh-hans":"CN","zh-hant":"TW",ja:"JP",ko:"KR",fil:"PH",th:"TH",vi:"VN"},zn={ar:"AR_es",be_en:"BE_en",be_fr:"BE_fr",be_nl:"BE_nl",br:"BR_pt",ca:"CA_en",ch_de:"CH_de",ch_fr:"CH_fr",ch_it:"CH_it",cl:"CL_es",co:"CO_es",la:"DO_es",mx:"MX_es",pe:"PE_es",africa:"MU_en",dk:"DK_da",de:"DE_de",ee:"EE_et",eg_ar:"EG_ar",eg_en:"EG_en",es:"ES_es",fr:"FR_fr",gr_el:"GR_el",gr_en:"GR_en",ie:"IE_en",il_he:"IL_iw",it:"IT_it",lv:"LV_lv",lt:"LT_lt",lu_de:"LU_de",lu_en:"LU_en",lu_fr:"LU_fr",my_en:"MY_en",my_ms:"MY_ms",hu:"HU_hu",mt:"MT_en",mena_en:"DZ_en",mena_ar:"DZ_ar",nl:"NL_nl",no:"NO_nb",pl:"PL_pl",pt:"PT_pt",ro:"RO_ro",si:"SI_sl",sk:"SK_sk",fi:"FI_fi",se:"SE_sv",tr:"TR_tr",uk:"GB_en",at:"AT_de",cz:"CZ_cs",bg:"BG_bg",ru:"RU_ru",ua:"UA_uk",au:"AU_en",in_en:"IN_en",in_hi:"IN_hi",id_en:"ID_en",id_id:"ID_id",nz:"NZ_en",sa_ar:"SA_ar",sa_en:"SA_en",sg:"SG_en",cn:"CN_zh-Hans",tw:"TW_zh-Hant",hk_zh:"HK_zh-hant",jp:"JP_ja",kr:"KR_ko",za:"ZA_en",ng:"NG_en",cr:"CR_es",ec:"EC_es",pr:"US_es",gt:"GT_es",cis_en:"TM_en",cis_ru:"TM_ru",sea:"SG_en",th_en:"TH_en",th_th:"TH_th"};function ye(n){let e=be[n];return!e&&zn[n]&&(e=n),!e&&n.includes("-")&&([e]=n.split("-")),e||"US"}var sn="langstore/";function $n(n){let a=(n?.prefix||"US_en").replace("/","")??"",[r="US",t="en"]=(zn[a]??a).split("_",2);if(a.startsWith(sn)||window.location.pathname.startsWith(`/${sn}`)){let i=a.replace(sn,"").toLowerCase();r=ye(i),t=i}return r=r.toUpperCase(),t=t.toLowerCase(),{language:t,country:r,locale:`${t}_${r}`}}var Z=n=>{let e=n.querySelector("#feds-menu-wrapper");e?.classList.remove("feds-menu-active"),e?.hidePopover?.(),n.querySelector(".feds-popup:popover-open")?.hidePopover?.()};function In(){let n=B("gnav-source")?.split("#")[0]?.split("/").pop()?.trim();if(n!==void 0&&n!==""&&n!=="gnav")return n;let e=window.adobeid?.client_id;return typeof e=="string"&&e!==""?e:""}var Q={elementNull:"Error when parsing Link. Element is null",notAnchor:"Cannot parse non-anchor as Link",textContentNotFound:"Error when parsing Link. Element has no textContent",hrefNotFound:"Element has no href"},_=n=>{if(n===null)throw new c(Q.elementNull);if(n.tagName!=="A")throw new c(Q.notAnchor);let[e,a]=n?.textContent?.split("|").map(i=>i.trim())??["",""];if(e==="")throw new c(Q.textContentNotFound);let r=n?.getAttribute("href")??"";if(r==="")throw new c(Q.hrefNotFound);let t=n.getAttribute("daa-ll");return[{type:"Link",text:e,href:r,daaLl:t,ariaLabel:a},[]]};var cn=n=>{if(!n)throw new c(z.elementNull);if(!n.classList.contains("product-card"))throw new c(z.notAProductCard);return X(we).or(xe).or(ke).eval(n)},z={elementNull:"Element not found",noTitleAnchor:"Title anchor not found",noHref:"Title Anchor has no href",noTitle:"Title text not found",noSubtitleP:"Subtitle <p> not found",noSubtitle:"Subtitle text not found",notAHeader:"Expected a Header class",notAProductCard:"Expected a product-card class"},xe=n=>{let e=new Set;if(!n)throw new c(z.elementNull);let a=n.querySelector("p a")??n.querySelector("div ~ div > a");if(!a)throw new c(z.noTitleAnchor);let r=a.textContent??"";r===""&&e.add(new g(z.noTitle));let t=a.getAttribute("href")??"";t===""&&e.add(new g(z.noHref));let i=a.getAttribute("daa-ll"),o=a.getAttribute("daa-lh"),s=a?.closest("p")?.nextElementSibling;s||e.add(new g(z.noSubtitleP));let l=s?.textContent??"";l===""&&e.add(new g(z.noSubtitle));let d=n.querySelectorAll(":scope > div:nth-child(2) > :first-child p")??[],v=Array.from(d).map(y=>{let p=y.querySelector("strong")!==null;return{text:y?.textContent?.trim()??"",isFilled:p}}),[h,k=null]=(n.firstElementChild?.firstElementChild?.textContent?.split("|")??[]).map(y=>y.trim());return[{type:"ProductCardLink",iconHref:h,iconAlt:k,title:r,href:t,subtitle:l,badges:v,daaLl:i,daaLh:o},[...e]]},we=n=>{if(!n)throw new c(z.elementNull);let e=[...n.classList];if(!e.includes("header"))throw new c(z.notAHeader);let a=n.querySelector("a")?.textContent??"",r=n.querySelector("a")?.getAttribute("daa-ll")??null,t=n.querySelector("a")?.getAttribute("daa-lh")??null;if(a==="")throw new c(z.noTitle);return[{type:"ProductCardHeader",title:a,classes:e,daaLl:r,daaLh:t},[]]},ke=n=>{if(!n)throw new c(z.elementNull);if(!n.classList.contains("blue"))throw new Error("Not a Blue Product Card");let e=n.querySelector("a"),[a,r]=_(e),t=e?.getAttribute("daa-ll")??null,i=e?.getAttribute("daa-lh")??null;return[{type:"ProductCardBlue",link:a,daaLl:t,daaLh:i},r]};var gn=n=>{switch(n.type){case"ProductCardHeader":return Ce(n);case"ProductCardLink":return Le(n);case"ProductCardBlue":return Ee(n);default:return console.error(n),""}},Ce=({title:n,classes:e,daaLl:a,daaLh:r})=>{let t=e.slice(1).map(o=>`feds-product-card--${o}`).join(" "),i=C(r,a??n);return`
  ...
  `},Ee=({link:n,daaLl:e,daaLh:a})=>{let r=C(a,e??n.text);return`
  <a href="${T(n.href)}" class="feds-product-card feds-product-card--blue"${r}>
    <div class="feds-product-card__content">
        <div class="feds-product-card__title">${n.text}</div>
      </div>
  </a>
`};var G={elementNull:"Error when parsing Brand. Element is null",noLinkSection:"Error when parsing Brand. No link section found",noLink:"Error when parsing Brand. No link found",noImageSection:"Error when parsing Brand. No image section found",missingImageSections:"Error when parsing Brand. Missing mobile or desktop image section",missingThemeImages:"Error when parsing Brand. Missing mobile or desktop image section"},fn=n=>{let e=new Set;if(n===null)throw new c(G.elementNull);let a=!!n.classList.contains("dark-bg"),[r,t]=n.querySelectorAll(":scope > div");if(r===void 0)throw new c(G.noLinkSection);let i=r.querySelector("a");if(i===null)throw new c(G.noLink);let o=i.getAttribute("href")??"",s=i.textContent?.trim()??"";t===void 0&&e.add(new g(G.noImageSection));let[l,d]=t?.querySelectorAll(":scope > div")??[];(l===void 0||d===void 0)&&e.add(new g(G.missingImageSections));let v=l?.querySelectorAll('a[href$=".svg"]'),h=d?.querySelectorAll('a[href$=".svg"]'),k=v?.[0]?.getAttribute("href")??"",y=v?.[0]?.textContent?.split("|")[1]?.trim()??"",p=v?.[1]?.getAttribute("href")??"",u=v?.[1]?.textContent?.split("|")[1]?.trim()??"",m=h?.[0]?.getAttribute("href")??"",f=h?.[0]?.textContent?.split("|")[1]?.trim()??"",b=h?.[1]?.getAttribute("href")??"",x=h?.[1]?.textContent?.split("|")[1]?.trim()??"";return(!k||!m||!p||!b)&&e.add(new g(G.missingThemeImages)),[{type:"Brand",data:{href:o,label:s,isDarkBg:a,imageData:{type:"svg",lightThemeImageSrc:m,lightThemeImageAlt:f,darkThemeImageSrc:b,darkThemeImageAlt:x,mobileLightThemeImageSrc:k,mobileLightThemeImageAlt:y,mobileDarkThemeImageSrc:p,mobileDarkThemeImageAlt:u}}},[...e]]};var Se=`
<?xml
...
`.trim(),Me=n=>{let{href:e,label:a,isDarkBg:r,imageData:t}=n,i=t.lightThemeImageSrc?.trim()||t.darkThemeImageSrc?.trim()||"",o=t.darkThemeImageSrc?.trim()||t.lightThemeImageSrc?.trim()||"",s=t.mobileLightThemeImageSrc?.trim()||t.mobileDarkThemeImageSrc?.trim()||"",l=t.mobileDarkThemeImageSrc?.trim()||t.mobileLightThemeImageSrc?.trim()||"",d=t.lightThemeImageAlt||t.darkThemeImageAlt||"",v=t.darkThemeImageAlt||t.lightThemeImageAlt||"",h=t.mobileLightThemeImageAlt||t.mobileDarkThemeImageAlt||"",k=t.mobileDarkThemeImageAlt||t.mobileLightThemeImageAlt||"",y=!!i,p=!!o,u=!!s,m=!!l,f=y?`<img src="${M(i)}" alt="${d}" />`:"",b=p?`<img src="${M(o)}" alt="${v}" />`:"",x=u?`<img src="${M(s)}" alt="${h}" />`:"",w=m?`<img src="${M(l)}" alt="${k}" />`:"";return`<div class="feds-brand-container${r?" feds-dark-bg":""}">
  ...
  </div>`.trim()},un=n=>{let{data:e}=n;return Me(e)};var mn=["appswitcher","help"],nn={cs:["cz"],da:["dk"],de:["at"],en:["africa","au","ca","ie","in","mt","ng","nz","sg","za"],es:["ar","cl","co","cr","ec","gt","la","mx","pe","pr"],et:["ee"],ja:["jp"],ko:["kr"],nb:["no"],pt:["br"],sl:["si"],sv:["se"],uk:["ua"],zh:["cn","tw"]},[K,Rn]=(()=>{let n,e,a,r=new Promise(t=>{e=t,a=setTimeout(()=>{n={},t(n)},5e3)});return[t=>{t&&!n&&(n=t,clearTimeout(a),e?.(n))},()=>r]})();function en(n,e=!1){let s=(/uc_carts=/.test(document.cookie)?n:n?.filter(d=>d!=="cart"))??[],l=s.length??3;if(e){let d=s.filter(h=>mn.includes(h)).length;return`calc(92px + ${d*32}px + ${d*.25}rem)`}return`calc(${l*32}px + ${(l-1)*.25}rem)`}var an=n=>{if(!n.prefix||n.prefix==="/")return"en_US";let e=n.prefix.replace("/","");if(e.includes("_")){let[r,t]=e.split("_").reverse();return`${r.toLowerCase()}_${t.toUpperCase()}`}if(e==="uk")return"en_GB";let a=Object.keys(nn).find(r=>nn[r].includes(e));return a?`${a.toLowerCase()}_${e.toUpperCase()}`:`${e.toLowerCase()}_${e.toUpperCase()}`},_e={Mac:"macOS",Win:"windows",Linux:"linux",CrOS:"chromeOS",Android:"android",iPad:"iPadOS",iPhone:"iOS"},rn=()=>{let n=navigator.userAgent;for(let[e,a]of Object.entries(_e))if(n.includes(e))return a;return"linux"},tn=async()=>{let n=window;return n.alloy?await n.alloy("getIdentity").then(e=>e?.identity?.ECID).catch(()=>{}):void 0};var Hn=()=>{try{return L().signInContext||{}}catch{return{}}},Pe=()=>{let n=L();return B("signin-cta-style")==="primary"||n?.unav?.profile?.signInCtaStyle==="primary"?"primary":"secondary"},Ae=()=>{let e=L()?.unav?.profile?.messageEventListener;return e||(a=>{let{name:r,payload:t,executeDefaultAction:i}=a.detail;if(!(!r||r!=="System"||!t||typeof i!="function"))switch(t.subType){case"AppInitiated":window.adobeProfile?.getUserProfile().then(o=>{K(o)}).catch(()=>{K({})});break;case"SignOut":i();break;case"ProfileSwitch":Promise.resolve(i()).then(o=>{o&&window.location.reload()});break;default:break}})};function ze(){let{unav:n}=L();return n?.unavHelpChildren||[{type:"Support"},{type:"Community"}]}var V=()=>{let n=L();return{profile:{name:"profile",attributes:{accountMenuContext:{sharedContextConfig:{enableLocalSection:!0,enableProfileSwitcher:!0,miniAppContext:{logger:{trace:()=>{},debug:()=>{},info:()=>{},warn:()=>{},error:()=>{}}},complexConfig:n?.unav?.profile?.complexConfig||null,...n?.unav?.profile?.config},messageEventListener:Ae()},signInCtaStyle:Pe(),isSignUpRequired:!1,callbacks:{onSignIn:()=>{window.adobeIMS?.signIn(Hn())},onSignUp:()=>{window.adobeIMS?.signIn(Hn())}}}},appswitcher:{name:"app-switcher"},notifications:{name:"notifications",attributes:{notificationsConfig:{applicationContext:{appID:n?.unav?.uncAppId||"adobecom",...n?.unav?.uncConfig}}}},help:{name:"help",attributes:{children:ze()}},jarvis:{name:"jarvis",attributes:{appid:n?.jarvis?.id,callbacks:n?.jarvis?.callbacks}},cart:{name:"cart"}}};var Dn=(n,e)=>{n[0]&&"attributes"in n[0]&&n[0].attributes&&typeof n[0].attributes=="object"&&"isSignUpRequired"in n[0].attributes&&(n[0].attributes.isSignUpRequired=e)},on=async(n,e)=>{try{let a=n.querySelector(".feds-utilities");if(!(a instanceof HTMLElement))return new g('missing ".feds-utilities" container');let r=new Set,t=document.head.querySelector('meta[name="universal-nav"]'),i=t instanceof HTMLMetaElement?t.content??"":"";t instanceof HTMLMetaElement||r.add(new g('metadata "universal-nav" is missing'));let o=i.trim();t instanceof HTMLMetaElement&&o.length===0&&r.add(new g('metadata "universal-nav" has no value'));let s=!window.adobeIMS?.isSignedInUser(),l=o.split(",").map(f=>f.trim()).filter(f=>Object.keys(V()).includes(f)||f==="signup");if(s){let f=en(l,s);a.style.setProperty("min-width",f)}let d;try{d=L()}catch{throw new Error("MiloConfig not available for UNAV initialization")}let v=an(d.locale),h=d.env.name==="prod"?"prod":"stage",k=await tn(),y=new URLSearchParams(window.location.search).get("unavVersion");/^\d+(\.\d+)?$/.test(y??"")||(y="1.5"),await Promise.all([dn(`https://${h}.adobeccstatic.com/unav/${y}/UniversalNav.js`),ln(`https://${h}.adobeccstatic.com/unav/${y}/UniversalNav.css`,!0)]);let p=()=>{let f=V(),b=[f.profile];return Dn(b,!1),l?.forEach(x=>{if(x==="profile")return;if(x==="signup"){Dn(b,!0);return}let w=f[x];w&&b.push(w)}),b},u=()=>({target:a,env:h,locale:v,countryCode:$n(d?.locale)?.country||"US",imsClientId:window?.adobeid?.client_id,theme:"light",analyticsContext:{consumer:{name:"adobecom",version:"1.0",platform:"Web",device:rn(),os_version:navigator.platform},event:{visitor_guid:k}},children:p(),isSectionDividerRequired:!!d?.unav?.showSectionDivider,showTrayExperience:!P.matches});await window?.UniversalNav?.(u()),s||a?.style.removeProperty("min-width");let m=f=>{window?.UniversalNav?.reload(u())};return P.addEventListener("change",()=>{m()}),{reloadUnav:m,errors:r}}catch(a){let r=a instanceof Error?a.message:"failed to load universal nav";return new g(r)}};function N(n,e){return[...n.querySelectorAll(e)]}function Y(n,e,a){N(n,e).forEach(r=>a?r.removeAttribute("tabindex"):r.setAttribute("tabindex","-1"))}var O={ArrowLeft:-1,ArrowRight:1,ArrowUp:-1,ArrowDown:1},Un=new Set(["ArrowLeft","ArrowRight"]),$e=new Set(["ArrowUp","ArrowDown"]),Ie='.tabs [role="tab"][aria-selected="true"]';function vn(n,e,a){return(n+e+a)%a}function Re(n,e,a,r){let t=O[a];if(Un.has(a)){let y=e+t;return y>=0&&y<n.length?y:null}let i=getComputedStyle(r).gridTemplateColumns.split(" ").length,o=[...r.children],s=y=>{let p=n[y].parentElement;return p?o.indexOf(p):-1},l=s(e)%i,d=Math.floor(s(e)/i)+(a==="ArrowDown"?1:-1),v=Math.floor((o.length-1)/i);if(d<0||d>v)return null;let h=null,k=1/0;for(let y=0;y<n.length;y++){let p=Math.abs(s(y)%i-l);Math.floor(s(y)/i)===d&&p<k&&(k=p,h=y)}return h}function hn(n){Y(n,'.tab-content [role="tabpanel"] a',!1);let e=[];N(n,".feds-popup[popover]").forEach(p=>{let u=()=>{p.matches(":popover-open")||Y(p,'[role="tabpanel"] a',!1)};p.addEventListener("toggle",u),e.push(()=>p.removeEventListener("toggle",u));let m=!1,f=x=>{x.key==="Tab"&&!x.shiftKey&&(m=!0)};p.addEventListener("keydown",f),e.push(()=>p.removeEventListener("keydown",f));let b=x=>{if(m&&!p.contains(x.relatedTarget)){if(p.hidePopover?.(),!P.matches){let w=p.closest(".feds-gnav-items");w?.classList.remove("subscreen-opening"),w?.classList.add("subscreen-closing")}m=!1}};p.addEventListener("focusout",b),e.push(()=>p.removeEventListener("focusout",b))});let a=(p,u)=>{p.focus(),u.preventDefault()},r=()=>n.querySelector(".feds-popup:popover-open"),t=p=>p.querySelector(Ie),i=p=>p.querySelector('[role="tabpanel"]:not([hidden])');function o(p){let u=r(),m=n.querySelector("#feds-menu-wrapper");if(!m)return!1;let f=m.querySelector(".feds-gnav-items"),b=u?u.querySelector(".feds-popup-back-button"):null,x=f?.classList.contains("subscreen-opening")===!0;if(u!==null&&x&&b!==null)return b.click(),p.preventDefault(),!0;let w=u??(m?.matches(":popover-open")?m:null);if(!w)return!1;w.hidePopover?.();let I=u?`[popovertarget="${w.id}"]`:".feds-nav-toggle";return n.querySelector(I)?.focus(),p.preventDefault(),!0}function s(p,u,m){if(!Un.has(u))return!1;let f=N(n,".feds-gnav-items > li > .feds-link"),b=f.indexOf(p);return b<0?!1:(a(f[vn(b,O[u],f.length)],m),!0)}function l(p,u,m,f){let b=N(u,'.tabs :is([role="tab"], .product-links a)'),x=b.indexOf(p);if(x<0)return!1;if(O[m]){let w=b[vn(x,O[m],b.length)];return w.matches('[role="tab"]')&&w.click(),a(w,f),!0}if(m==="Tab"&&!f.shiftKey&&p.matches('[aria-selected="true"]')){let w=i(u);if(!w)return!1;Y(w,"a",!0);let I=w.querySelector("a");return I&&a(I,f),!0}return!1}function d(p,u,m,f){let b=i(u);if(!b)return!1;let x=N(b,"a"),w=x.indexOf(p);if(w<0)return!1;if(O[m]){let I=Re(x,w,m,b);return I!==null?(a(x[I],f),!0):m==="ArrowUp"?(Y(b,"a",!1),a(t(u)??x[0],f),!0):!1}if(m==="Tab"&&!f.shiftKey){if(w+1<x.length)a(x[w+1],f);else return!1;return!0}if(m==="Tab"&&f.shiftKey){if(w>0)a(x[w-1],f);else{Y(b,"a",!1);let I=t(u)??N(u,'.tabs :is([role="tab"], .product-links a)')[0];I&&a(I,f)}return!0}return!1}function v(p,u,m,f){if(!$e.has(m))return!1;let b=N(u,".feds-gnav-cards a"),x=b.indexOf(p);return x<0?!1:(a(b[vn(x,O[m],b.length)],f),!0)}function h(p){let u=document.activeElement??p.target;if(p.key==="Escape"){o(p);return}let m=r();m&&(m.matches(":has(.product-list)")&&(l(u,m,p.key,p)||d(u,m,p.key,p))||m.matches(":has(.feds-gnav-cards)")&&v(u,m,p.key,p))||s(u,p.key,p)}let k=n.querySelector(".trap-focus-gnav"),y=p=>{n.querySelector(".feds-menu-active")&&(p.preventDefault(),n.querySelector(".feds-nav-toggle")?.focus())};return k?.addEventListener("focus",y),e.push(()=>k?.removeEventListener("focus",y)),n.addEventListener("keydown",h),e.push(()=>n.removeEventListener("keydown",h)),()=>e.forEach(p=>p())}var He="feds-milo",E=(n,e="default",a="e")=>{let{locale:r}=L(),t=B("gnav-source")??`${r.contentRoot??""}/gnav`;window.lana||console.warn("lana logging unavailable in the gnav"),window?.lana?.log(`${n} | gnav-source: ${t} | href: ${window.location.href}`,{clientId:He,sampleRate:1,tags:e,errorType:a})};var c=class n extends Error{constructor(e){super(e),Object.setPrototypeOf(this,n.prototype)}},g=class n extends Error{constructor(e,a="Minor"){super(e),Object.setPrototypeOf(this,n.prototype),a==="Critical"&&E(e)}};var Nn=n=>e=>{if(e===null)throw new Error("");let a=e.querySelector(De(n));if(!a)throw new Error("");let r=a.textContent??"",[t="",i=""]=r.split("|").map(h=>h.trim());if(t==="")throw new Error("");let o=a.getAttribute("href")??"";if(o==="")throw new Error("");let s=a.getAttribute("daa-ll"),l=a.getAttribute("aria-label")?.trim()??"",d=l!==""?l:i!==""?i:void 0,v=[];return[{type:n.type,text:t,href:o,ariaLabel:d,daaLl:typeof s=="string"&&s.trim()!==""?s:t},v]},bn=Nn({type:"PrimaryCTA"}),R=Nn({type:"SecondaryCTA"}),jn=n=>X(bn).or(R).eval(n),De=({type:n})=>{switch(n){case"PrimaryCTA":return"strong > a";case"SecondaryCTA":return"em > a";default:throw new Error("")}};var yn=({text:n,href:e,daaLl:a,ariaLabel:r,ariaAttrs:t})=>`
<a href="${T(e)}"
  class="feds-primary-cta"${W(t,r)}
  ${C(null,a??n)}
>
  ${n}
</a>
`,H=({text:n,href:e,daaLl:a,ariaLabel:r,ariaAttrs:t})=>`
<a href="${T(e)}" 
  class="feds-secondary-cta"${W(t,r)}
  ${C(null,a??n)}
>
  ${n}
</a>
`,qn=n=>n.type==="PrimaryCTA"?yn(n):H(n);var F=({text:n,href:e,daaLl:a,ariaLabel:r,ariaAttrs:t,svgIcon:i=""})=>`<a class="feds-link" href="${T(e)}"${W(t,r)}${C(null,a??n)}>${n}${i}</a>`;var Bn=n=>{let[e,a]=Ue(n);return[{type:"LinksCard",card:e},a]},Ue=n=>{let e=n.querySelector("h2, h3, h4")||null;if(!e)throw new c("Expected links card title");let a=n.querySelector("em > a"),r=[...n.querySelectorAll("a")].filter(l=>l!==a);if(r.length===0)throw new c("Expected at least one link");let[t,i]=A(r,_),[o,s]=(()=>{try{return R(n)}catch{return[null,[]]}})();return o&&(o.daaLl=`${e.textContent??""} - ${o?.daaLl}`),[{type:"LinksCardItem",title:e.textContent??"",links:t,footerCTA:o},[...i,...s]]};var Gn=(n,e="",a=new Map)=>{let r=[...n.querySelectorAll("li > div")],t=[...n.querySelectorAll("li > a")],[i,o]=A(r,Ne),[s,l]=A(t,_);return[{type:"ProductList",megaMenuTitle:e,categories:i,links:s,placeholders:a},[...o,...l]]},Ne=n=>{let e=n.firstElementChild;if(e?.nodeName!=="H2")throw new c("Expected H2");let a=e.textContent??"",r=e.textContent??"",t=En(e),[i,o]=A(t,cn);return[{type:"ProductCategory",name:a,daaLl:r,links:i},o]};var On=n=>{let[e,a]=je(n);return[{type:"FeaturedCard",card:e},a]},je=n=>{let e=n.querySelector("h5")||null;if(!e)throw new g("Eye brow element not found");let a=n.querySelector("h4")||null,r=a?.nextElementSibling||null;if(!a)throw new c("Expected title");if(!r)throw new c("Expected subtitle");let t=r.nextElementSibling?.firstElementChild||null;if(!t)throw new c("Expected card link after subtitle");let[i,o]=_(t),[s,l]=R(n);return[{type:"Card",title:a.textContent??"",subtitle:r.textContent??"",bodyLink:i,footerCTA:s,eyeBrow:e.textContent??""},[...l,...o]]};var $={MissingBackgroundImageSection:"Promo card is missing background image section",MissingBackgroundImage:"Promo card is missing background image",MissingBackgroundImageAlt:"Promo card background image is missing alt text",MissingBackgroundImageSrc:"Promo card background image is missing src",MissingContentSection:"Promo card is missing card details section",MissingIcon:"Promo card is missing icon",MissingIconSrc:"Promo card icon is missing src",MissingIconAlt:"Promo card icon is missing alt text",MissingTitleElement:"Promo card is missing title element",MissingTitleText:"Promo card is missing title text",MissingSecondaryCtaAnchor:"Promo card is missing secondary CTA anchor",MissingPriceLink:"Promo card is missing price link"},Fn=n=>{let[e,a]=n.querySelectorAll(":scope > div"),r=new Set;if(e===void 0)throw new c($.MissingBackgroundImageSection);let t=e.querySelector(":scope picture:not(:scope p picture) img")??null;t===null&&r.add(new g($.MissingBackgroundImage));let i=t?.getAttribute("alt")??"";i===""&&r.add(new g($.MissingBackgroundImageAlt));let o=t?.getAttribute("src")??"";if(o===""&&r.add(new g($.MissingBackgroundImageSrc)),a===void 0)throw new c($.MissingContentSection);let s=a.querySelector('a[href$=".svg"]')??null;s===null&&r.add(new g($.MissingIcon));let[l,d]=(s?.textContent?.split("|")??["",""]).map(x=>x.trim());l===""&&r.add(new g($.MissingIconSrc)),d===""&&r.add(new g($.MissingIconAlt));let v=a.querySelector('p > a:not([href$=".svg"])')??null,h=v?.textContent?.trim()??"",k=v?.getAttribute("href")??"",y=k?Ln(k):!1;v===null&&r.add(new g($.MissingPriceLink));let p=a.querySelector("p > strong")??null;if(p===null)throw new c($.MissingTitleElement);let u=p?.textContent??"";u===""&&r.add(new g($.MissingTitleText)),a.querySelector("em > a")===null&&r.add(new g($.MissingSecondaryCtaAnchor));let[f,b]=(()=>{try{return R(n)}catch{return[null,[]]}})();return b.forEach(x=>r.add(x)),f&&(f.daaLl=`${u} - ${f?.daaLl}`),[{type:"PromoCard",card:{bgImageAlt:i,bgImageSrc:o,iconAlt:d,iconSrc:l,title:u,cta:f,priceText:h,priceHref:k,isPriceMerchLink:y}},[...r]]};var Wn=n=>{let e=new Set;if(n===null)throw new c(Xn.elementNull);let a=n.querySelector("h2")?.textContent??"";a===""&&e.add(new g(Xn.noTitle));let r=(async()=>{try{let t=n.querySelector("a"),i=new URL(t?.href??""),o=await q(i);if(o instanceof c)throw new Error(o.message);let s=await Pn(o);if(s instanceof c)throw new Error(s.message);if(_n(i.href,s),n.classList.contains("product-list")){let l=await j();return Gn(s,a,l)}return qe(s,a)}catch(t){throw new c(t?.message)}})();if(r instanceof c)throw r;return[{type:"MegaMenu",title:a,content:r},[...e]]},Xn={elementNull:"Element is null",noTitle:"Large Menu has no Title"},qe=(n,e)=>{let a=[...n.children];if(a.length===0)throw new c("No mega menu items found (did you forget to add them correctly?)");let[r,t]=A(a,i=>Be(i));if(r.length===0)throw new c("Failed to parse gnav cards sections");return[{type:"GnavCards",megaMenuTitle:e,sections:r},t]},Be=n=>{let e=[...n.querySelectorAll(".featured-card, .links-card, .promo-card")];if(e.length===0)throw new c("Column contains no cards (did you forget to label them correctly?)");let[a,r]=A(e,t=>Ge(t));if(a.length===0)throw new c("Failed to parse cards in column");return[{type:"GnavColumn",cards:a},r]},Ge=n=>{if(n.classList.contains("featured-card"))return On(n);if(n.classList.contains("links-card"))return Bn(n);if(n.classList.contains("promo-card"))return Fn(n);throw new c("Unsupported gnav cards section")};var Zn=({card:n},e)=>Oe(n,e),Oe=({title:n,subtitle:e,eyeBrow:a,footerCTA:r,bodyLink:t},i)=>{let o=`featured-eyebrow-${S(a)}`;return`
  <div class="featured-card" tabindex="0" aria-label="${a} ${i}" ${C(a,"")} role="group">
    <div>
      ...
      <span>${F({...t,ariaAttrs:{"aria-describedby":o},svgIcon:D.chevronRight})}</span>
    </div>
...
`.trim()};var Kn=({card:n})=>Fe(n),Fe=({title:n,links:e,footerCTA:a})=>`
  <article class="links-card" ${C(n,"")}>
    ...
    <div class="links-card-footer">
      ${H({...a,ariaAttrs:{"aria-describedby":`links-card-${S(n)}`}})}
    </div>`}
  </article>
`.trim();var Vn=({card:n})=>Xe(n),Xe=({bgImageAlt:n,bgImageSrc:e,iconAlt:a,iconSrc:r,title:t,cta:i,priceText:o,priceHref:s,isPriceMerchLink:l})=>`
    ...
    <div class="promo-card__content">
      ...
      <div class="promo-card__text-content">
        ...
        ${i===null?"":`<div class="promo-card__cta">
                 ${H({...i,ariaAttrs:{"aria-describedby":`title-${S(t)}${l?` price-${S(t)}`:""}`}})}
               </div>`}
      </div>
    </div>
  </article>
`.trim();var We=(n,e)=>{switch(n.type){case"FeaturedCard":return Zn(n,e);case"LinksCard":return Kn(n);case"PromoCard":return Vn(n);default:}return""},Yn=({sections:n,megaMenuTitle:e})=>`
  <div class="feds-gnav-cards">
    ${n.map(a=>`<li>${a.cards.map(r=>We(r,e)).join("")}</li>`).join("")}
  </div>
`;var Jn=({categories:n,links:e,placeholders:a})=>{let r=`
    <ul class="tabs" role="tablist" aria-orientation="vertical">
      ${n.map(Ze).join("")}
      ${e.length?`<li class="product-links"><a class="feds-link" href="${T(e[e.length-1].href)}"${C(null,e[e.length-1].daaLl??e[e.length-1].text)}>${e[e.length-1].text}${D.chevronRight}</a></li>`:""}
    </ul>
  `.trim(),t=`
...
`,ne=(n,e)=>{let{megaMenuTitle:a}=n,r=`
        <button
          type="button"
  ...
  `,t=n.type==="ProductList"&&n.links.length>0?n.links[n.links.length-1]:null,i=`
    <div class="feds-popup-header">
      ...
      ${t?`<div class="product-links"><a class="feds-link" href="${T(t.href)}"${C(null,t.daaLl??t.text)}>${t.text}${D.chevronRight}</a></div>`:""}
    </div>
  `.trim(),o="";switch(n.type){case"ProductList":o=Jn(n);break;case"GnavCards":o=Yn(n);break;default:}return`${i}${o}`};var ee={elementNull:"Error when parsing text. Element is null",textContentNull:"Error when parsing text. Element has no textContent"},ae=n=>{if(n===null)return[{type:"Text",content:""},[new g(ee.elementNull,"Minor")]];let e=n.textContent;return e===null?[{type:"Text",content:""},[new g(ee.textContentNull,"Minor")]]:[{type:"Text",content:e},[]]};var re=({content:n})=>n;var te=n=>{if(n===null)throw new c(Ke.elementNull);let e=n.querySelector(".gnav-brand");if(e!==null)return fn(e);let a=n.querySelector(".large-menu");return a!==null?Wn(a):n.querySelector("strong")!==null?bn(n):n.querySelector("em")!==null?R(n):n.querySelector("a")===null?ae(n):_(n.querySelector("a"))},xn=(n,e)=>{switch(n.type){case"Text":return re(n);case"Link":return F(n);case"SecondaryCTA":return H(n);case"PrimaryCTA":return yn(n);case"Brand":return un(n);case"MegaMenu":return Qn(n,e);default:return console.error(`Failed to recognize component: ${n}`),""}},Ke={elementNull:"Element is null"};var oe=(n,e,a=new Map)=>{let[r,t]=A([...document.querySelectorAll(".breadcrumbs ul > li > a")??[]],_),[i,o]=A([...n.children],te),s=n.querySelector(".product-entry-cta"),[l,d]=(()=>{try{return jn(s)}catch{return[null,[]]}})(),v=!1,h=[t,o,d].flat();return{breadcrumbs:r,components:i,productCTA:l,localnav:v,errors:h,unavEnabled:e,placeholders:a}};var ie=n=>{let e=n.querySelector(".feds-skip-link"),a=o=>{let s=document.querySelector("#main-content");s instanceof HTMLElement&&(o.preventDefault(),s.hasAttribute("tabindex")||s.setAttribute("tabindex","-1"),setTimeout(()=>{s.focus(),s.scrollIntoView({behavior:"smooth",block:"start"})},100))};e?.addEventListener("click",a);let r=[...n.querySelectorAll('.tabs button[role="tab"]')],t=[...n.querySelectorAll(".tab-content ul")],i=r.map((o,s)=>()=>{let l=t[s].closest(":popover-open");if(r.forEach(h=>{h.setAttribute("aria-selected","false")}),t.forEach(h=>{h.setAttribute("hidden","true")}),t[s]?.removeAttribute("hidden"),o.setAttribute("aria-selected","true"),!l||!P.matches)return;let d=se();if(!d)return;let v=l?.clientHeight??0;d.style.height=`${v+72}px`});return r.forEach((o,s)=>{o.addEventListener("click",i[s])}),Ve(n),()=>{e?.removeEventListener("click",a),r.forEach((o,s)=>{o.removeEventListener("click",i[s])})}},se=()=>[...document.adoptedStyleSheets.flatMap(n=>[...n.cssRules])].find(n=>n?.selectorText==="header.global-navigation nav::after"),Ve=n=>{let e=[...n.querySelectorAll(".feds-gnav-items > li > button")],a=n.querySelector(".feds-gnav-items"),r=se(),t=new ResizeObserver(i=>{if(i.length<1)return;let o=n.querySelector(".feds-popup:popover-open");if(!o){r.style.height="100%";return}let l=o.clientHeight<1?"100%":`${o.clientHeight+72}px`;r.style.height=l});e.forEach(i=>{if(!r)return;let o=i.nextElementSibling;o&&(t.observe(o),o.addEventListener("toggle",s=>{if(s.newState!=="open"&&!n.querySelector(".feds-popup:popover-open")){if(r.style.height="100%",P.matches)return;a?.classList.remove("subscreen-opening"),a?.classList.add("subscreen-closing")}else r.style.height=`${o.clientHeight+72}px`}))}),e.forEach(i=>{i.addEventListener("click",()=>{if(P.matches||!a)return;let o=i.nextElementSibling;o&&(a.classList.remove("subscreen-closing"),a.classList.add("subscreen-opening"),o.querySelector(".feds-popup-back-button")?.addEventListener("click",()=>{a.classList.remove("subscreen-opening"),a.classList.add("subscreen-closing"),setTimeout(()=>o.hidePopover(),240)}))})}),P.addEventListener("change",()=>{a?.classList.remove("subscreen-opening"),a?.classList.remove("subscreen-closing")}),n.querySelector(".feds-nav-toggle")?.addEventListener("click",()=>{a?.classList.remove("subscreen-opening"),a?.classList.remove("subscreen-closing")})};var le=async n=>{let e=new Set,a=n.querySelectorAll("a.merch");if(a.length===0)return e;try{let r=L(),{base:t}=r;if(!t)return e.add(new g("base not found in config, cannot initialize merch links")),e;let i=await import(`${t}/blocks/merch/merch.js`),{default:o}=i;if(!o)return e.add(new g("decorateMerchLink not found in merch module")),e;a.forEach(s=>{o(s)})}catch(r){e.add(new g(`Error initializing merch links: ${r}`))}return e};var de=async({gnavSource:n,asideSource:e})=>{let a=await q(n);if(a instanceof c)return a;let r=await q(e);return{mainNav:a,aside:r}};var pe=new CSSStyleSheet;pe.replaceSync(String.raw`/**
...
`);document.adoptedStyleSheets=[...document.adoptedStyleSheets,pe];var ko=async n=>{let{gnavSource:e,mountpoint:a,unavEnabled:r,miloConfig:t,personalization:i}=n;if(!(e instanceof URL))throw E(`gnavSource is invalid: ${e}`),new c("gnavSource needs to be a URL object");try{pn(t)}catch(v){throw E(`Failed to initialize MiloConfig: ${v}`),new c(`Failed to initialize MiloConfig: ${v}`)}Sn(i),Tn(n.localizeLink??(v=>v)),Cn(wn(n));let o=await de(n);if(o instanceof c)throw E(o.message),o;let{mainNav:s,aside:l}=o;if(s instanceof c)throw E(s.message),s;let d=oe(s,r,await j());if(d instanceof c)throw E(d.message),d;return await Ye(d)(a),Qe(n)},Ye=n=>async e=>{let a=Je(n);document.querySelector("main")?.setAttribute("id","main-content"),e.innerHTML=a,e.classList.add("site-pivot"),e.querySelector("nav")?.showPopover();let r=[...e.querySelectorAll(".mega-menu ~ .feds-popup")];r.forEach(s=>{s.innerHTML=""});let i=n.components.filter(s=>s.type==="MegaMenu").map(s=>s.content),o=await Promise.all(i.map(async(s,l)=>{try{let[d,v]=await s;return r[l].innerHTML=ne(d,r[l].id),v}catch(d){return[d]}}).flat());return e},Je=({components:n,productCTA:e,unavEnabled:a,placeholders:r})=>`
<nav popover="manual" data-lenis-prevent>
  ...
  <ul>
    ${(()=>{let t=n.find(d=>d.type==="Brand")??null,i=n.filter(d=>d.type!=="Brand"),o=`
      ...
      `.trim(),s=t?xn(t):"",l=An(i,xn);return`
...
`,Qe=async n=>{let e=new Set,a=await on(n.mountpoint);a instanceof g?(e.add(a),E(a.message)):a.errors.forEach(o=>e.add(o)),ie(n.mountpoint),hn(n.mountpoint),na(n.mountpoint),ea(n.mountpoint),aa(n.mountpoint),ta(n.mountpoint),oa(n.mountpoint,n.mepMartech??"");let r=()=>{document.querySelector("nav[popover]")?.removeAttribute("popover"),Z(n.mountpoint)};document.querySelector(".dialog-modal")&&r(),document.addEventListener("click",o=>{o.target instanceof Element&&o.target.closest('a[href*="#openPrivacy"]')&&r()}),window.addEventListener("milo:modal:loaded",r),window.addEventListener("milo:modal:closed",()=>{let o=document.querySelector("nav");o?.setAttribute("popover","manual"),o?.showPopover?.()}),(await le(n.mountpoint)).forEach(o=>{e.add(o),E(o.message)});let i=a instanceof g?()=>{}:a.reloadUnav;return{closeEverything:ra,reloadUnav:i,errors:e,setGnavTopPosition:o=>{},getGnavTopPosition:()=>0}},na=n=>{let e=n.querySelector("#feds-menu-wrapper"),a=n.querySelector(".feds-nav-toggle");e?.addEventListener("toggle",()=>{let t=e.matches(":popover-open");a?.setAttribute("aria-expanded",String(t)),a?.setAttribute("daa-ll",t?"hamburgermenu|close":"hamburgermenu|open"),t&&e.classList.add("feds-menu-active")}),e?.addEventListener("transitionend",()=>{e.matches(":popover-open")||e.classList.remove("feds-menu-active")}),n.querySelectorAll(".feds-popup[popover]").forEach(t=>{t.addEventListener("toggle",()=>{let i=n.querySelector(`[popovertarget="${t.id}"]`),o=t.matches(":popover-open");i?.setAttribute("aria-expanded",String(o)),i?.setAttribute("daa-ll",o?"header|Close":"header|Open")})})},ea=n=>{P.addEventListener("change",()=>{Z(n)})},aa=n=>{[...n.querySelector(".feds-utilities #universal-nav")?.children??[]].forEach(e=>{e.addEventListener("click",()=>Z(n)),e.addEventListener("keydown",a=>{a.key==="Enter"&&Z(n)})})};var ra=()=>{},ta=n=>{let e=n.closest("header");if(!e)return;let a=n.querySelector("#feds-menu-wrapper"),r=()=>a?.matches(":popover-open")??!1,t=()=>window.scrollY>100,i=()=>{if(r()){e.classList.remove("feds-header-scrolled");return}if(t()){e.classList.add("feds-header-scrolled");return}e.classList.remove("feds-header-scrolled")};i(),window.addEventListener("scroll",i,{passive:!0}),a?.addEventListener("toggle",i)},oa=(n,e)=>{let a=n.closest("header");a!==null&&a.setAttribute("daa-lh",`gnav|${In()}${e}`)};export{ko as main,Qe as postRenderingTasks,Ye as renderGnav,Je as renderGnavString};
