var yn=async n=>{let{placeholders:e}=n,{locale:r}=C(),a=`${Z()}${r.prefix}/federal/globalnav/placeholders.json`,[o,i]=await Promise.all([e,ce(a)]);return new Map([...i,...o])},ce=async n=>{try{let e=await fetch(n);if(!e.ok)throw new u(`Federal placeholders not found at ${n}`);let r=de(await e.json());if(r instanceof u)throw r;return new Map(r.data.map(({key:t,value:a})=>[t,a]))}catch(e){if(e instanceof u)console.error(e.message);else{let r=new u(e.message);console.error(r.message)}return L(`Failed to fetch placeholders from ${n}`),new Map([])}},de=n=>{try{let{data:e}=n;if(!e.every(({key:t,value:a})=>typeof t=="string"&&typeof a=="string"))throw new Error("data is not valid");return n}catch(e){return new u(e.message)}};function xn(n,e){let r=/{{(.*?)}}|%7B%7B(.*?)%7D%7D/g;return r.test(n)?n.replace(r,(a,o,i)=>{let s=o??i??"";return e.get(s)??s}):n}var[wn,kn]=(()=>{let n;return[e=>{n||(n=e)},()=>{if(!n)throw new Error("Placeholders not initialized. Call setPlaceholders() first.");return n}]})();var A=window.matchMedia("(min-width: 1024px)"),$={brand:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" id="Layer_1" viewBox="0 0 64.57 35"><defs><style>.cls-1{fill: #eb1000;}</style></defs><path class="cls-1" d="M6.27,10.22h4.39l6.2,14.94h-4.64l-3.92-9.92-2.59,6.51h3.08l1.23,3.41H0l6.27-14.94ZM22.03,13.32c.45,0,.94.04,1.43.16v-3.7h3.88v14.72c-.89.4-2.81.89-4.73.89-3.48,0-6.47-1.98-6.47-5.93s2.88-6.13,5.89-6.13ZM22.52,22.19c.36,0,.65-.07.94-.16v-5.42c-.29-.11-.58-.16-.96-.16-1.27,0-2.45.94-2.45,2.92s1.2,2.81,2.47,2.81ZM34.25,13.32c3.23,0,5.98,2.18,5.98,6.02s-2.74,6.02-5.98,6.02-6-2.18-6-6.02,2.72-6.02,6-6.02ZM34.25,22.13c1.11,0,2.14-.89,2.14-2.79s-1.03-2.79-2.14-2.79-2.12.89-2.12,2.79.96,2.79,2.12,2.79ZM41.16,9.78h3.9v3.7c.47-.09.96-.16,1.45-.16,3.03,0,5.84,1.98,5.84,5.86,0,4.1-2.99,6.18-6.53,6.18-1.52,0-3.46-.31-4.66-.87v-14.72ZM45.91,22.17c1.34,0,2.56-.96,2.56-2.94,0-1.85-1.2-2.72-2.5-2.72-.36,0-.65.04-.91.16v5.35c.22.09.51.16.85.16ZM58.97,13.32c2.92,0,5.6,1.87,5.6,5.64,0,.51-.02,1-.09,1.49h-7.27c.4,1.32,1.56,1.94,3.01,1.94,1.18,0,2.27-.29,3.5-.82v2.97c-1.14.58-2.5.82-3.9.82-3.7,0-6.58-2.23-6.58-6.02s2.61-6.02,5.73-6.02ZM60.93,18.02c-.2-1.27-1.05-1.78-1.92-1.78s-1.58.54-1.87,1.78h3.79Z"/></svg>',company:'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="22" viewBox="0 0 24 22" fill="none"><path d="M14.2353 21.6209L12.4925 16.7699H8.11657L11.7945 7.51237L17.3741 21.6209H24L15.1548 0.379395H8.90929L0 21.6209H14.2353Z" fill="#EB1000"/></svg>',search:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" focusable="false"><path d="M14 2A8 8 0 0 0 7.4 14.5L2.4 19.4a1.5 1.5 0 0 0 2.1 2.1L9.5 16.6A8 8 0 1 0 14 2Zm0 14.1A6.1 6.1 0 1 1 20.1 10 6.1 6.1 0 0 1 14 16.1Z"></path></svg>',home:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" height="25" viewBox="0 0 18 18" width="25"><path fill="#6E6E6E" d="M17.666,10.125,9.375,1.834a.53151.53151,0,0,0-.75,0L.334,10.125a.53051.53051,0,0,0,0,.75l.979.9785A.5.5,0,0,0,1.6665,12H2v4.5a.5.5,0,0,0,.5.5h4a.5.5,0,0,0,.5-.5v-5a.5.5,0,0,1,.5-.5h3a.5.5,0,0,1,.5.5v5a.5.5,0,0,0,.5.5h4a.5.5,0,0,0,.5-.5V12h.3335a.5.5,0,0,0,.3535-.1465l.979-.9785A.53051.53051,0,0,0,17.666,10.125Z"/></svg>',chevronLeft:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" focusable="false"><path d="M12.5 4l-5 6 5 6" stroke="currentColor" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>',chevronRight:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="3" height="6" viewBox="0 0 3 6" focusable="false"><path d="M.5.5 2.5 3 .5 5.5" stroke="currentColor" stroke-width="1" fill="none"/></svg>',chevronDown:'<svg class="chevron-down" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="6" height="3.375" viewBox="0 0 6 3.375" focusable="false"><path d="M.5.5 3 2.875 5.5.5" stroke="currentColor" stroke-width="1" fill="none"/></svg>'},pe=["/tools/ost?","/miniplans"],Cn=n=>pe.some(e=>n.includes(e));var Ln=n=>{let e=[],r=n.nextElementSibling??null;for(;r!==null;)e.push(r),r=r.nextElementSibling??null;return e},G=n=>({eval:n,or:e=>G(r=>{try{return n(r)}catch{return e(r)}})}),M=(n,e)=>n.reduce(([r,t],a)=>{try{let[o,i]=e(a);return[[...r,o],[...t,...i]]}catch(o){return o instanceof d?[r,[o,...t]]:[r,t]}},[[],[]]),[En,ge]=(()=>{let n,e=!1;return[r=>{e||(n=r,e=!0)},()=>{if(!n)throw new Error("PersonalizationConfig not initialized. Call setPersonalizationConfig() first.");return n}]})(),[Tn,Mn]=(()=>{let n=e=>e;return[e=>{n=e},()=>n]})(),E=n=>{try{return Mn()(n)}catch{return n}},D=async n=>{try{if(n===null)return new d("URL is null");let e=`${n.origin}${n.pathname.replace(/(\.html$|$)/,".plain.html")}${n.hash}`,r=Mn()(e),t=H(r),a=await fetch(t);if(!a.ok)return L(`Request for ${t} failed`),new d(`Request for ${t} failed`);let o=await a.text(),i=await kn(),s=xn(o,i),{body:l}=new DOMParser().parseFromString(s,"text/html");try{let{handleCommands:c,commands:m}=ge();c(m,l)}catch(c){L(`Personalization not applied: ${c?.message}`)}return l}catch(e){return new d(e?.message)}},z,Z=()=>{if(z)return z;let n=["https://www.adobe.com","https://business.adobe.com","https://blog.adobe.com","https://milo.adobe.com","https://news.adobe.com","graybox.adobe.com"];if(z)return z;let e=window.location.origin;z=n.some(a=>{let o=e.replace(".stage","");return a.startsWith("https://")?o===a:o.endsWith(a)})?e:"https://www.adobe.com";let t=window.location.hostname.includes(".aem.")?"aem":"hlx";return(e.includes("localhost")||e.includes(`.${t}.`))&&(z=`https://main--federal--adobecom.aem.${e.endsWith(".live")?"live":"page"}`),z},H=(n="")=>{if(n.includes("c2-poc--milo--adobecom"))return n.replace("c2-poc--milo--adobecom","main--federal--adobecom");if(n.includes("c2-poc-feds-gnav--milo--adobecom"))return n.replace("c2-poc-feds-gnav--milo--adobecom","main--federal--adobecom");if(n.includes("localhost:3000"))return n.replace("localhost:3000","main--federal--adobecom.aem.page");if(typeof n!="string"||!n.includes("/federal/"))return n;if(n.startsWith("/"))return`${Z()}${n}`;try{let{pathname:e,search:r,hash:t}=new URL(n);return`${Z()}${e}${r}${t}`}catch(e){let r=e instanceof Error?e.message:String(e);console.warn(`getFederatedUrl errored parsing the URL: ${n}: ${r}`)}return n},Sn=(n,e)=>{let r=(t,a)=>{let o=`${t}[${a}^="./media_"]`;e.querySelectorAll(o).forEach(s=>{let l=s.getAttribute(a);if(!(l===null||l===""))try{let c=H(new URL(l,new URL(n,window.location.href)).href);s.setAttribute(a,c)}catch(c){console.warn(`[MediaPathError]: Failed to process relative media path (${l}) for ${t}`,c)}})};r("img","src"),r("source","srcset")},Pn=async n=>{let e=async(r,t)=>{if(r instanceof d)return r;try{let o=[...r.querySelectorAll('a[href*="#_inline"]')].map(async i=>{try{if(t.has(i.href))return;let s=H(i.href),l=new URL(s),c=await D(l);if(t.add(i.href),c instanceof d)throw c;await e(c,t),i.replaceWith(...c.children);return}catch{return}},[]);return await Promise.all(o),r}catch(a){return new d(JSON.stringify(a))}};return e(n,new Set)},An=(n,e)=>n.map((r,t)=>`<li>${e(r,t)}</li>`).join(""),X=n=>{let e=n.normalize("NFKC").toLocaleLowerCase().trim().replace(/[^\p{L}\p{N}\p{M}]+/gu,"-").replace(/^-+|-+$/g,"");return e===""?"id":/^\p{N}/u.test(e)?`id-${e}`:e},k=(n,e)=>{let r=n!==null&&n!==""?` daa-lh="${n}"`:"",t=e!==null&&e!==""?` daa-ll="${e}"`:"";return`${r}${t}`};function ue(n,{id:e,as:r,callback:t,crossorigin:a,rel:o,fetchpriority:i}={rel:"stylesheet"}){let s=document.head.querySelector(`link[href="${n}"]`);if(s)return t?.("noop"),s;let l=document.createElement("link");return l.setAttribute("rel",o),e!==void 0&&l.setAttribute("id",e),r!==void 0&&l.setAttribute("as",r),a!==void 0&&l.setAttribute("crossorigin",a),i!==void 0&&l.setAttribute("fetchpriority",i),l.setAttribute("href",n),t&&(l.onload=c=>t(c.type),l.onerror=c=>t(typeof c=="string"?"error":c.type)),document.head.appendChild(l),l}function fe(n,e){return ue(n,{rel:"stylesheet",callback:e})}function on(n,e=!1){e&&fe(n)}var sn=(n,e,{mode:r,id:t}={})=>new Promise((a,o)=>{let i=document.querySelector(`head > script[src="${n}"]`);if(!i){let{head:c}=document;i=document.createElement("script"),i.setAttribute("src",n),t!=null&&i.setAttribute("id",t),e!=null&&i.setAttribute("type",e),r&&["async","defer"].includes(r)&&i.setAttribute(r,""),c.append(i)}let s=i.dataset.loaded;if(s!=null){a(i);return}let l=c=>{i.removeEventListener("load",l),i.removeEventListener("error",l),c.type==="error"?o(new Error(`error loading script: ${i.src}`)):c.type==="load"&&(i.dataset.loaded="true",a(i))};i.addEventListener("load",l),i.addEventListener("error",l)});function N(n,e=document){let r=n&&n.includes(":")?"property":"name";return e.head.querySelector(`meta[${r}="${n}"]`)?.content??null}var me=n=>{let e=n,r=o=>o==null||typeof o!="object";if(r(e)||r(e.locale)||typeof e.locale.prefix!="string"||r(e.env)||typeof e.env.name!="string")return!1;if(e.unav!==void 0){if(typeof e.unav!="object"||e.unav===null)return!1;let o=e.unav;if(o.profile!==void 0){if(typeof o.profile!="object"||o.profile===null)return!1;let i=o.profile;if(i.signInCtaStyle!==void 0&&i.signInCtaStyle!=="primary"&&i.signInCtaStyle!=="secondary"||i.messageEventListener!==void 0&&typeof i.messageEventListener!="function")return!1}}return!(e.jarvis!==void 0&&(typeof e.jarvis!="object"||e.jarvis===null||typeof e.jarvis.id!="string"))},[ln,C]=(()=>{let n,e=!1;return[r=>{if(!e){if(!me(r))throw new Error("MiloConfig validation failed: Invalid structure");n=r,e=!0}},()=>{if(!n)throw new Error("MiloConfig not initialized. Call setMiloConfig() first.");return n}]})(),ve={en:"US","en-gb":"GB","es-mx":"MX","fr-ca":"CA",da:"DK",et:"EE",ar:"DZ",el:"GR",iw:"IL",he:"IL",id:"ID",ms:"MY",nb:"NO",sl:"SI",sv:"SE",cs:"CZ",uk:"UA",hi:"IN","zh-hans":"CN","zh-hant":"TW",ja:"JP",ko:"KR",fil:"PH",th:"TH",vi:"VN"},_n={ar:"AR_es",be_en:"BE_en",be_fr:"BE_fr",be_nl:"BE_nl",br:"BR_pt",ca:"CA_en",ch_de:"CH_de",ch_fr:"CH_fr",ch_it:"CH_it",cl:"CL_es",co:"CO_es",la:"DO_es",mx:"MX_es",pe:"PE_es",africa:"MU_en",dk:"DK_da",de:"DE_de",ee:"EE_et",eg_ar:"EG_ar",eg_en:"EG_en",es:"ES_es",fr:"FR_fr",gr_el:"GR_el",gr_en:"GR_en",ie:"IE_en",il_he:"IL_iw",it:"IT_it",lv:"LV_lv",lt:"LT_lt",lu_de:"LU_de",lu_en:"LU_en",lu_fr:"LU_fr",my_en:"MY_en",my_ms:"MY_ms",hu:"HU_hu",mt:"MT_en",mena_en:"DZ_en",mena_ar:"DZ_ar",nl:"NL_nl",no:"NO_nb",pl:"PL_pl",pt:"PT_pt",ro:"RO_ro",si:"SI_sl",sk:"SK_sk",fi:"FI_fi",se:"SE_sv",tr:"TR_tr",uk:"GB_en",at:"AT_de",cz:"CZ_cs",bg:"BG_bg",ru:"RU_ru",ua:"UA_uk",au:"AU_en",in_en:"IN_en",in_hi:"IN_hi",id_en:"ID_en",id_id:"ID_id",nz:"NZ_en",sa_ar:"SA_ar",sa_en:"SA_en",sg:"SG_en",cn:"CN_zh-Hans",tw:"TW_zh-Hant",hk_zh:"HK_zh-hant",jp:"JP_ja",kr:"KR_ko",za:"ZA_en",ng:"NG_en",cr:"CR_es",ec:"EC_es",pr:"US_es",gt:"GT_es",cis_en:"TM_en",cis_ru:"TM_ru",sea:"SG_en",th_en:"TH_en",th_th:"TH_th"};function he(n){let e=ve[n];return!e&&_n[n]&&(e=n),!e&&n.includes("-")&&([e]=n.split("-")),e||"US"}var an="langstore/";function In(n){let r=(n?.prefix||"US_en").replace("/","")??"",[t="US",a="en"]=(_n[r]??r).split("_",2);if(r.startsWith(an)||window.location.pathname.startsWith(`/${an}`)){let o=r.replace(an,"").toLowerCase();t=he(o),a=o}return t=t.toUpperCase(),a=a.toLowerCase(),{language:a,country:t,locale:`${a}_${t}`}}var K=n=>{let e=n.querySelector("#feds-menu-wrapper");e?.classList.remove("feds-menu-active"),e?.hidePopover?.(),n.querySelector(".feds-popup:popover-open")?.hidePopover?.()};function $n(){let n=N("gnav-source")?.split("#")[0]?.split("/").pop()?.trim();if(n!==void 0&&n!==""&&n!=="gnav")return n;let e=window.adobeid?.client_id;return typeof e=="string"&&e!==""?e:""}var V={elementNull:"Error when parsing Link. Element is null",notAnchor:"Cannot parse non-anchor as Link",textContentNotFound:"Error when parsing Link. Element has no textContent",hrefNotFound:"Element has no href"},T=n=>{if(n===null)throw new d(V.elementNull);if(n.tagName!=="A")throw new d(V.notAnchor);let[e,r]=n?.textContent?.split("|").map(o=>o.trim())??["",""];if(e==="")throw new d(V.textContentNotFound);let t=n?.getAttribute("href")??"";if(t==="")throw new d(V.hrefNotFound);let a=n.getAttribute("daa-ll");return[{type:"Link",text:e,href:t,daaLl:a,ariaLabel:r},[]]};var cn=n=>{if(!n)throw new d(S.elementNull);if(!n.classList.contains("product-card"))throw new d(S.notAProductCard);return G(ye).or(be).or(xe).eval(n)},S={elementNull:"Element not found",noTitleAnchor:"Title anchor not found",noHref:"Title Anchor has no href",noTitle:"Title text not found",noSubtitleP:"Subtitle <p> not found",noSubtitle:"Subtitle text not found",notAHeader:"Expected a Header class",notAProductCard:"Expected a product-card class"},be=n=>{let e=new Set;if(!n)throw new d(S.elementNull);let r=n.querySelector("p a")??n.querySelector("div ~ div > a");if(!r)throw new d(S.noTitleAnchor);let t=r.textContent??"";t===""&&e.add(new u(S.noTitle));let a=r.getAttribute("href")??"";a===""&&e.add(new u(S.noHref));let o=r.getAttribute("daa-ll"),i=r.getAttribute("daa-lh"),s=r?.closest("p")?.nextElementSibling;s||e.add(new u(S.noSubtitleP));let l=s?.textContent??"";l===""&&e.add(new u(S.noSubtitle));let c=n.querySelectorAll(":scope > div:nth-child(2) > :first-child p")??[],m=Array.from(c).map(p=>{let f=p.querySelector("strong")!==null;return{text:p?.textContent?.trim()??"",isFilled:f}}),[b,g=null]=(n.firstElementChild?.firstElementChild?.textContent?.split("|")??[]).map(p=>p.trim());return[{type:"ProductCardLink",iconHref:b,iconAlt:g,title:t,href:a,subtitle:l,badges:m,daaLl:o,daaLh:i},[...e]]},ye=n=>{if(!n)throw new d(S.elementNull);let e=[...n.classList];if(!e.includes("header"))throw new d(S.notAHeader);let r=n.querySelector("a")?.textContent??"",t=n.querySelector("a")?.getAttribute("daa-ll")??null,a=n.querySelector("a")?.getAttribute("daa-lh")??null;if(r==="")throw new d(S.noTitle);return[{type:"ProductCardHeader",title:r,classes:e,daaLl:t,daaLh:a},[]]},xe=n=>{if(!n)throw new d(S.elementNull);if(!n.classList.contains("blue"))throw new Error("Not a Blue Product Card");let e=n.querySelector("a"),[r,t]=T(e),a=e?.getAttribute("daa-ll")??null,o=e?.getAttribute("daa-lh")??null;return[{type:"ProductCardBlue",link:r,daaLl:a,daaLh:o},t]};var dn=n=>{switch(n.type){case"ProductCardHeader":return we(n);case"ProductCardLink":return ke(n);case"ProductCardBlue":return Ce(n);default:return console.error(n),""}},we=({title:n,classes:e,daaLl:r,daaLh:t})=>{let a=e.slice(1).map(i=>`feds-product-card--${i}`).join(" "),o=k(t,r??n);return`
  ...
  `},ke=({iconHref:n,iconAlt:e,title:r,href:t,subtitle:a,badges:o=[],daaLl:i,daaLh:s})=>{let l=e!==null&&n!==null,c=k(s,i??r),m=l?`
    ...
    <a class="feds-product-card" href="${E(t)}"${c}>
...
`};var B={elementNull:"Error when parsing Brand. Element is null",noLinkSection:"Error when parsing Brand. No link section found",noLink:"Error when parsing Brand. No link found",noImageSection:"Error when parsing Brand. No image section found",missingImageSections:"Error when parsing Brand. Missing mobile or desktop image section",missingThemeImages:"Error when parsing Brand. Missing mobile or desktop image section"},pn=n=>{let e=new Set;if(n===null)throw new d(B.elementNull);let r=!!n.classList.contains("dark-bg"),[t,a]=n.querySelectorAll(":scope > div");if(t===void 0)throw new d(B.noLinkSection);let o=t.querySelector("a");if(o===null)throw new d(B.noLink);let i=o.getAttribute("href")??"",s=o.textContent?.trim()??"";a===void 0&&e.add(new u(B.noImageSection));let[l,c]=a?.querySelectorAll(":scope > div")??[];(l===void 0||c===void 0)&&e.add(new u(B.missingImageSections));let m=l?.querySelectorAll('a[href$=".svg"]'),b=c?.querySelectorAll('a[href$=".svg"]'),g=m?.[0]?.getAttribute("href")??"",p=m?.[0]?.textContent?.split("|")[1]?.trim()??"",f=m?.[1]?.getAttribute("href")??"",v=m?.[1]?.textContent?.split("|")[1]?.trim()??"",y=b?.[0]?.getAttribute("href")??"",h=b?.[0]?.textContent?.split("|")[1]?.trim()??"",x=b?.[1]?.getAttribute("href")??"",w=b?.[1]?.textContent?.split("|")[1]?.trim()??"";return(!g||!y||!f||!x)&&e.add(new u(B.missingThemeImages)),[{type:"Brand",data:{href:i,label:s,isDarkBg:r,imageData:{type:"svg",lightThemeImageSrc:y,lightThemeImageAlt:h,darkThemeImageSrc:x,darkThemeImageAlt:w,mobileLightThemeImageSrc:g,mobileLightThemeImageAlt:p,mobileDarkThemeImageSrc:f,mobileDarkThemeImageAlt:v}}},[...e]]};var Le=`
<?xml
...
`.trim(),Te=n=>{let{href:e,label:r,isDarkBg:t,imageData:a}=n,o=a.lightThemeImageSrc?.trim()||a.darkThemeImageSrc?.trim()||"",i=a.darkThemeImageSrc?.trim()||a.lightThemeImageSrc?.trim()||"",s=a.mobileLightThemeImageSrc?.trim()||a.mobileDarkThemeImageSrc?.trim()||"",l=a.mobileDarkThemeImageSrc?.trim()||a.mobileLightThemeImageSrc?.trim()||"",c=a.lightThemeImageAlt||a.darkThemeImageAlt||"",m=a.darkThemeImageAlt||a.lightThemeImageAlt||"",b=a.mobileLightThemeImageAlt||a.mobileDarkThemeImageAlt||"",g=a.mobileDarkThemeImageAlt||a.mobileLightThemeImageAlt||"",p=!!o,f=!!i,v=!!s,y=!!l,h=p?`<img src="${H(o)}" alt="${c}" />`:"",x=f?`<img src="${H(i)}" alt="${m}" />`:"",w=v?`<img src="${H(s)}" alt="${b}" />`:"",U=y?`<img src="${H(l)}" alt="${g}" />`:"";return`<div class="feds-brand-container${t?" feds-dark-bg":""}">
...
`,Bn=n=>n.type==="PrimaryCTA"?hn(n):I(n);var j=({text:n,href:e,daaLl:r,svgIcon:t=""})=>`<a class="feds-link" href="${E(e)}"${k(null,r??n)}>${n}${t}</a>`;var qn=n=>{let[e,r]=ze(n);return[{type:"LinksCard",card:e},r]},ze=n=>{let e=n.querySelector("h2, h3, h4")||null;if(!e)throw new d("Expected links card title");let r=n.querySelector("em > a"),t=[...n.querySelectorAll("a")].filter(l=>l!==r);if(t.length===0)throw new d("Expected at least one link");let[a,o]=M(t,T),[i,s]=(()=>{try{return _(n)}catch{return[null,[]]}})();return i&&(i.daaLl=`${e.textContent??""} - ${i?.daaLl}`),[{type:"LinksCardItem",title:e.textContent??"",links:a,footerCTA:i},[...o,...s]]};var jn=n=>{let e=[...n.querySelectorAll("li > div")],r=[...n.querySelectorAll("li > a")],[t,a]=M(e,Ue),[o,i]=M(r,T);return[{type:"ProductList",categories:t,links:o},[...a,...i]]},Ue=n=>{let e=n.firstElementChild;if(e?.nodeName!=="H2")throw new d("Expected H2");let r=e.textContent??"",t=e.textContent??"",a=Ln(e),[o,i]=M(a,cn);return[{type:"ProductCategory",name:r,daaLl:t,links:o},i]};var Gn=n=>{let[e,r]=De(n);return[{type:"FeaturedCard",card:e},r]},De=n=>{let e=n.querySelector("h5")||null;if(!e)throw new u("Eye brow element not found");let r=n.querySelector("h4")||null,t=r?.nextElementSibling||null;if(!r)throw new d("Expected title");if(!t)throw new d("Expected subtitle");let a=t.nextElementSibling?.firstElementChild||null;if(!a)throw new d("Expected card link after subtitle");let[o,i]=T(a),[s,l]=_(n);return[{type:"Card",title:r.textContent??"",subtitle:t.textContent??"",bodyLink:o,footerCTA:s,eyeBrow:e.textContent??""},[...l,...i]]};var P={MissingBackgroundImageSection:"Promo card is missing background image section",MissingBackgroundImage:"Promo card is missing background image",MissingBackgroundImageAlt:"Promo card background image is missing alt text",MissingBackgroundImageSrc:"Promo card background image is missing src",MissingContentSection:"Promo card is missing card details section",MissingIcon:"Promo card is missing icon",MissingIconSrc:"Promo card icon is missing src",MissingIconAlt:"Promo card icon is missing alt text",MissingTitleElement:"Promo card is missing title element",MissingTitleText:"Promo card is missing title text",MissingSecondaryCtaAnchor:"Promo card is missing secondary CTA anchor",MissingPriceLink:"Promo card is missing price link"},On=n=>{let[e,r]=n.querySelectorAll(":scope > div"),t=new Set;if(e===void 0)throw new d(P.MissingBackgroundImageSection);let a=e.querySelector(":scope picture:not(:scope p picture) img")??null;a===null&&t.add(new u(P.MissingBackgroundImage));let o=a?.getAttribute("alt")??"";o===""&&t.add(new u(P.MissingBackgroundImageAlt));let i=a?.getAttribute("src")??"";if(i===""&&t.add(new u(P.MissingBackgroundImageSrc)),r===void 0)throw new d(P.MissingContentSection);let s=r.querySelector('a[href$=".svg"]')??null;s===null&&t.add(new u(P.MissingIcon));let[l,c]=(s?.textContent?.split("|")??["",""]).map(w=>w.trim());l===""&&t.add(new u(P.MissingIconSrc)),c===""&&t.add(new u(P.MissingIconAlt));let m=r.querySelector('p > a:not([href$=".svg"])')??null,b=m?.textContent?.trim()??"",g=m?.getAttribute("href")??"",p=g?Cn(g):!1;m===null&&t.add(new u(P.MissingPriceLink));let f=r.querySelector("p > strong")??null;if(f===null)throw new d(P.MissingTitleElement);let v=f?.textContent??"";v===""&&t.add(new u(P.MissingTitleText)),r.querySelector("em > a")===null&&t.add(new u(P.MissingSecondaryCtaAnchor));let[h,x]=(()=>{try{return _(n)}catch{return[null,[]]}})();return x.forEach(w=>t.add(w)),h&&(h.daaLl=`${v} - ${h?.daaLl}`),[{type:"PromoCard",card:{bgImageAlt:o,bgImageSrc:i,iconAlt:c,iconSrc:l,title:v,cta:h,priceText:b,priceHref:g,isPriceMerchLink:p}},[...t]]};var Wn=n=>{let e=new Set;if(n===null)throw new d(Fn.elementNull);let r=n.querySelector("h2")?.textContent??"";r===""&&e.add(new u(Fn.noTitle));let t=(async()=>{try{let a=n.querySelector("a"),o=new URL(a?.href??""),i=await D(o);if(i instanceof d)throw new Error(i.message);let s=await Pn(i);if(s instanceof d)throw new Error(s.message);return Sn(o.href,s),n.classList.contains("product-list")?jn(s):Ne(s)}catch(a){throw new d(a?.message)}})();if(t instanceof d)throw t;return[{type:"MegaMenu",title:r,content:t},[...e]]},Fn={elementNull:"Element is null",noTitle:"Large Menu has no Title"},Ne=n=>{let e=[...n.children];if(e.length===0)throw new d("No mega menu items found (did you forget to add them correctly?)");let[r,t]=M(e,a=>Be(a));if(r.length===0)throw new d("Failed to parse gnav cards sections");return[{type:"GnavCards",sections:r},t]},Be=n=>{let e=[...n.querySelectorAll(".featured-card, .links-card, .promo-card")];if(e.length===0)throw new d("Column contains no cards (did you forget to label them correctly?)");let[r,t]=M(e,a=>qe(a));if(r.length===0)throw new d("Failed to parse cards in column");return[{type:"GnavColumn",cards:r},t]},qe=n=>{if(n.classList.contains("featured-card"))return Gn(n);if(n.classList.contains("links-card"))return qn(n);if(n.classList.contains("promo-card"))return On(n);throw new d("Unsupported gnav cards section")};var Zn=({card:n})=>je(n),je=({title:n,subtitle:e,eyeBrow:r,footerCTA:t,bodyLink:a})=>`
...
@media (min-width: 1920px) {
  header.global-navigation nav {
    &:has(:popover-open) {
      padding-left: calc(var(--s2a-spacing-md) + (100vw - 1920px) *  0.5);
      padding-right: calc((100vw - 1920px) *  0.5);
      margin-left: 0;
      margin-right: 0;
    }
    & .feds-popup > div {
...
.feds-brand {
  ...
  padding-right: var(--s2a-spacing-sm);
  column-gap: 10px;
}
...
`,le=document.createElement("style");le.textContent=Ke;document.head.appendChild(le);var yo=async n=>{let{gnavSource:e,mountpoint:r,unavEnabled:t,miloConfig:a,personalization:o}=n;if(!(e instanceof URL))throw L(`gnavSource is invalid: ${e}`),new d("gnavSource needs to be a URL object");try{ln(a)}catch(m){throw L(`Failed to initialize MiloConfig: ${m}`),new d(`Failed to initialize MiloConfig: ${m}`)}En(o),Tn(n.localizeLink??(m=>m)),wn(yn(n));let i=await se(n);if(i instanceof d)throw L(i.message),i;let{mainNav:s,aside:l}=i;if(s instanceof d)throw L(s.message),s;let c=ae(s,t);if(c instanceof d)throw L(c.message),c;return await Ve(c)(r),Je(n)},Ve=n=>async e=>{let r=Ye(n);e.innerHTML=r,e.classList.add("site-pivot");let t=[...e.querySelectorAll(".mega-menu ~ .feds-popup")];t.forEach(s=>{s.innerHTML=""});let a=n.components.filter(s=>s.type==="MegaMenu"),o=a.map(s=>s.content),i=await Promise.all(o.map(async(s,l)=>{let[c,m]=await s,b=a[l].title;return t[l].innerHTML=Qn(c,t[l].id,b),m}).flat());return e},Ye=({components:n,productCTA:e,unavEnabled:r})=>`
<nav>
  <ul>
