...
`};var j={elementNull:"Error when parsing Brand. Element is null",noLinkSection:"Error when parsing Brand. No link section found",noLink:"Error when parsing Brand. No link found",noImageSection:"Error when parsing Brand. No image section found",missingImageSections:"Error when parsing Brand. Missing mobile or desktop image section",missingThemeImages:"Error when parsing Brand. Missing mobile or desktop image section"},cn=n=>{let e=new Set;if(n===null)throw new p(j.elementNull);let a=!!n.classList.contains("dark-bg"),[r,t]=n.querySelectorAll(":scope > div");if(r===void 0)throw new p(j.noLinkSection);let i=r.querySelector("a");if(i===null)throw new p(j.noLink);let o=i.getAttribute("href")??"",s=i.textContent?.trim()??"";t===void 0&&e.add(new u(j.noImageSection));let[l,d]=t?.querySelectorAll(":scope > div")??[];(l===void 0||d===void 0)&&e.add(new u(j.missingImageSections));let v=l?.querySelectorAll('a[href$=".svg"]'),y=d?.querySelectorAll('a[href$=".svg"]'),g=v?.[0]?.getAttribute("href")??"",c=v?.[0]?.textContent?.split("|")[1]?.trim()??"",f=v?.[1]?.getAttribute("href")??"",h=v?.[1]?.textContent?.split("|")[1]?.trim()??"",x=y?.[0]?.getAttribute("href")??"",m=y?.[0]?.textContent?.split("|")[1]?.trim()??"",b=y?.[1]?.getAttribute("href")??"",w=y?.[1]?.textContent?.split("|")[1]?.trim()??"";return(!g||!x||!f||!b)&&e.add(new u(j.missingThemeImages)),[{type:"Brand",data:{href:o,label:s,isDarkBg:a,imageData:{type:"svg",lightThemeImageSrc:x,lightThemeImageAlt:m,darkThemeImageSrc:b,darkThemeImageAlt:w,mobileLightThemeImageSrc:g,mobileLightThemeImageAlt:c,mobileDarkThemeImageSrc:f,mobileDarkThemeImageAlt:h}}},[...e]]};var Ee=`
<?xml
...
`.trim(),Te=n=>{let{href:e,label:a,isDarkBg:r,imageData:t}=n,i=t.lightThemeImageSrc?.trim()||t.darkThemeImageSrc?.trim()||"",o=t.darkThemeImageSrc?.trim()||t.lightThemeImageSrc?.trim()||"",s=t.mobileLightThemeImageSrc?.trim()||t.mobileDarkThemeImageSrc?.trim()||"",l=t.mobileDarkThemeImageSrc?.trim()||t.mobileLightThemeImageSrc?.trim()||"",d=t.lightThemeImageAlt||t.darkThemeImageAlt||"",v=t.darkThemeImageAlt||t.lightThemeImageAlt||"",y=t.mobileLightThemeImageAlt||t.mobileDarkThemeImageAlt||"",g=t.mobileDarkThemeImageAlt||t.mobileLightThemeImageAlt||"",c=!!i,f=!!o,h=!!s,x=!!l,m=c?`<img src="${R(i)}" alt="${d}" />`:"",b=f?`<img src="${R(o)}" alt="${v}" />`:"",w=h?`<img src="${R(s)}" alt="${y}" />`:"",D=x?`<img src="${R(l)}" alt="${g}" />`:"";return`<div class="feds-brand-container${r?" feds-dark-bg":""}">
  ...
  </div>`.trim()},gn=n=>{let{data:e}=n;return Te(e)};var fn=["appswitcher","help"],Y={cs:["cz"],da:["dk"],de:["at"],en:["africa","au","ca","ie","in","mt","ng","nz","sg","za"],es:["ar","cl","co","cr","ec","gt","la","mx","pe","pr"],et:["ee"],ja:["jp"],ko:["kr"],nb:["no"],pt:["br"],sl:["si"],sv:["se"],uk:["ua"],zh:["cn","tw"]},[F,Rn]=(()=>{let n,e,a,r=new Promise(t=>{e=t,a=setTimeout(()=>{n={},t(n)},5e3)});return[t=>{t&&!n&&(n=t,clearTimeout(a),e?.(n))},()=>r]})();function J(n,e=!1){let s=(/uc_carts=/.test(document.cookie)?n:n?.filter(d=>d!=="cart"))??[],l=s.length??3;if(e){let d=s.filter(y=>fn.includes(y)).length;return`calc(92px + ${d*32}px + ${d*.25}rem)`}return`calc(${l*32}px + ${(l-1)*.25}rem)`}var Q=n=>{if(!n.prefix||n.prefix==="/")return"en_US";let e=n.prefix.replace("/","");if(e.includes("_")){let[r,t]=e.split("_").reverse();return`${r.toLowerCase()}_${t.toUpperCase()}`}if(e==="uk")return"en_GB";let a=Object.keys(Y).find(r=>Y[r].includes(e));return a?`${a.toLowerCase()}_${e.toUpperCase()}`:`${e.toLowerCase()}_${e.toUpperCase()}`},_e={Mac:"macOS",Win:"windows",Linux:"linux",CrOS:"chromeOS",Android:"android",iPad:"iPadOS",iPhone:"iOS"},nn=()=>{let n=navigator.userAgent;for(let[e,a]of Object.entries(_e))if(n.includes(e))return a;return"linux"},en=async()=>{let n=window;return n.alloy?await n.alloy("getIdentity").then(e=>e?.identity?.ECID).catch(()=>{}):void 0};var $n=()=>{try{return C().signInContext||{}}catch{return{}}},Me=()=>{let n=C();return N("signin-cta-style")==="primary"||n?.unav?.profile?.signInCtaStyle==="primary"?"primary":"secondary"},Pe=()=>{let e=C()?.unav?.profile?.messageEventListener;return e||(a=>{let{name:r,payload:t,executeDefaultAction:i}=a.detail;if(!(!r||r!=="System"||!t||typeof i!="function"))switch(t.subType){case"AppInitiated":window.adobeProfile?.getUserProfile().then(o=>{F(o)}).catch(()=>{F({})});break;case"SignOut":i();break;case"ProfileSwitch":Promise.resolve(i()).then(o=>{o&&window.location.reload()});break;default:break}})};function Ae(){let{unav:n}=C();return n?.unavHelpChildren||[{type:"Support"},{type:"Community"}]}var X=()=>{let n=C();return{profile:{name:"profile",attributes:{accountMenuContext:{sharedContextConfig:{enableLocalSection:!0,enableProfileSwitcher:!0,miniAppContext:{logger:{trace:()=>{},debug:()=>{},info:()=>{},warn:()=>{},error:()=>{}}},complexConfig:n?.unav?.profile?.complexConfig||null,...n?.unav?.profile?.config},messageEventListener:Pe()},signInCtaStyle:Me(),isSignUpRequired:!1,callbacks:{onSignIn:()=>{window.adobeIMS?.signIn($n())},onSignUp:()=>{window.adobeIMS?.signIn($n())}}}},appswitcher:{name:"app-switcher"},notifications:{name:"notifications",attributes:{notificationsConfig:{applicationContext:{appID:n?.unav?.uncAppId||"adobecom",...n?.unav?.uncConfig}}}},help:{name:"help",attributes:{children:Ae()}},jarvis:{name:"jarvis",attributes:{appid:n?.jarvis?.id,callbacks:n?.jarvis?.callbacks}},cart:{name:"cart"}}};var Hn=(n,e)=>{n[0]&&"attributes"in n[0]&&n[0].attributes&&typeof n[0].attributes=="object"&&"isSignUpRequired"in n[0].attributes&&(n[0].attributes.isSignUpRequired=e)},an=async(n,e)=>{try{let a=n.querySelector(".feds-utilities");if(!(a instanceof HTMLElement))return new u('missing ".feds-utilities" container');let r=new Set,t=document.head.querySelector('meta[name="universal-nav"]'),i=t instanceof HTMLMetaElement?t.content??"":"";t instanceof HTMLMetaElement||r.add(new u('metadata "universal-nav" is missing'));let o=i.trim();t instanceof HTMLMetaElement&&o.length===0&&r.add(new u('metadata "universal-nav" has no value'));let s=!window.adobeIMS?.isSignedInUser(),l=o.split(",").map(m=>m.trim()).filter(m=>Object.keys(X()).includes(m)||m==="signup");if(s){let m=J(l,s);a.style.setProperty("min-width",m)}let d;try{d=C()}catch{throw new Error("MiloConfig not available for UNAV initialization")}let v=Q(d.locale),y=d.env.name==="prod"?"prod":"stage",g=await en(),c=new URLSearchParams(window.location.search).get("unavVersion");/^\d+(\.\d+)?$/.test(c??"")||(c="1.5"),await Promise.all([sn(`https://${y}.adobeccstatic.com/unav/${c}/UniversalNav.js`),on(`https://${y}.adobeccstatic.com/unav/${c}/UniversalNav.css`,!0)]);let f=()=>{let m=X(),b=[m.profile];return Hn(b,!1),l?.forEach(w=>{if(w==="profile")return;if(w==="signup"){Hn(b,!0);return}let D=m[w];D&&b.push(D)}),b},h=()=>({target:a,env:y,locale:v,countryCode:zn(d?.locale)?.country||"US",imsClientId:window?.adobeid?.client_id,theme:"light",analyticsContext:{consumer:{name:"adobecom",version:"1.0",platform:"Web",device:nn(),os_version:navigator.platform},event:{visitor_guid:g}},children:f(),isSectionDividerRequired:!!d?.unav?.showSectionDivider,showTrayExperience:!P.matches});await window?.UniversalNav?.(h()),s||a?.style.removeProperty("min-width");let x=m=>{window?.UniversalNav?.reload(h())};return P.addEventListener("change",()=>{x()}),{reloadUnav:x,errors:r}}catch(a){let r=a instanceof Error?a.message:"failed to load universal nav";return new u(r)}};function $(n,e){return[...n.querySelectorAll(e)]}function W(n,e,a){$(n,e).forEach(r=>a?r.removeAttribute("tabindex"):r.setAttribute("tabindex","-1"))}var B={ArrowLeft:-1,ArrowRight:1,ArrowUp:-1,ArrowDown:1},Dn=new Set(["ArrowLeft","ArrowRight"]),ze=new Set(["ArrowUp","ArrowDown"]),Ie='.tabs [role="tab"][aria-selected="true"]';function un(n,e,a){return(n+e+a)%a}function Re(n,e,a,r){let t=B[a];if(Dn.has(a)){let c=e+t;return c>=0&&c<n.length?c:null}let i=getComputedStyle(r).gridTemplateColumns.split(" ").length,o=[...r.children],s=c=>{let f=n[c].parentElement;return f?o.indexOf(f):-1},l=s(e)%i,d=Math.floor(s(e)/i)+(a==="ArrowDown"?1:-1),v=Math.floor((o.length-1)/i);if(d<0||d>v)return null;let y=null,g=1/0;for(let c=0;c<n.length;c++){let f=Math.abs(s(c)%i-l);Math.floor(s(c)/i)===d&&f<g&&(g=f,y=c)}return y}function mn(n){W(n,'.tab-content [role="tabpanel"] a',!1);let e=[];$(n,".feds-popup[popover]").forEach(g=>{let c=()=>{g.matches(":popover-open")||W(g,'[role="tabpanel"] a',!1)};g.addEventListener("toggle",c),e.push(()=>g.removeEventListener("toggle",c))});let a=(g,c)=>{g.focus(),c.preventDefault()},r=()=>n.querySelector(".feds-popup:popover-open"),t=g=>g.querySelector(Ie),i=g=>g.querySelector('[role="tabpanel"]:not([hidden])');function o(g){let c=r(),f=n.querySelector("#feds-menu-wrapper");if(!f)return!1;let h=f.querySelector(".feds-gnav-items"),x=c?c.querySelector(".feds-popup-back-button"):null,m=h?.classList.contains("subscreen-opening")===!0;if(c!==null&&m&&x!==null)return x.click(),g.preventDefault(),!0;let b=c??(f?.matches(":popover-open")?f:null);if(!b)return!1;b.hidePopover?.();let w=c?`[popovertarget="${b.id}"]`:".feds-nav-toggle";return n.querySelector(w)?.focus(),g.preventDefault(),!0}function s(g,c,f){if(!Dn.has(c))return!1;let h=$(n,".feds-gnav-items > li > .feds-link"),x=h.indexOf(g);return x<0?!1:(a(h[un(x,B[c],h.length)],f),!0)}function l(g,c,f,h){let x=$(c,'.tabs :is([role="tab"], .product-links a)'),m=x.indexOf(g);if(m<0)return!1;if(B[f]){let b=x[un(m,B[f],x.length)];return b.matches('[role="tab"]')&&b.click(),a(b,h),!0}if(f==="Tab"&&!h.shiftKey&&g.matches('[aria-selected="true"]')){let b=i(c);if(!b)return!1;W(b,"a",!0);let w=b.querySelector("a");return w&&a(w,h),!0}return!1}function d(g,c,f,h){let x=i(c);if(!x)return!1;let m=$(x,"a"),b=m.indexOf(g);if(b<0)return!1;if(B[f]){let w=Re(m,b,f,x);return w!==null?(a(m[w],h),!0):f==="ArrowUp"?(W(x,"a",!1),a(t(c)??m[0],h),!0):!1}if(f==="Tab"&&!h.shiftKey){if(b+1<m.length)a(m[b+1],h);else{let w=$(c,'.tabs [role="tab"]'),D=t(c),rn=w[w.indexOf(D)+1]??c.querySelector(".product-links a");if(rn)a(rn,h);else return!1}return!0}if(f==="Tab"&&h.shiftKey){if(b>0)a(m[b-1],h);else{W(x,"a",!1);let w=t(c)??$(c,'.tabs :is([role="tab"], .product-links a)')[0];w&&a(w,h)}return!0}return!1}function v(g,c,f,h){if(!ze.has(f))return!1;let x=$(c,".feds-gnav-cards a"),m=x.indexOf(g);return m<0?!1:(a(x[un(m,B[f],x.length)],h),!0)}function y(g){let c=document.activeElement??g.target;if(g.key==="Escape"){o(g);return}let f=r();f&&(f.matches(":has(.product-list)")&&(l(c,f,g.key,g)||d(c,f,g.key,g))||f.matches(":has(.feds-gnav-cards)")&&v(c,f,g.key,g))||s(c,g.key,g)}return n.addEventListener("keydown",y),e.push(()=>n.removeEventListener("keydown",y)),()=>e.forEach(g=>g())}var $e="feds-milo",L=(n,e="default",a="e")=>{let{locale:r}=C(),t=N("gnav-source")??`${r.contentRoot??""}/gnav`;window.lana||console.warn("lana logging unavailable in the gnav"),window?.lana?.log(`${n} | gnav-source: ${t} | href: ${window.location.href}`,{clientId:$e,sampleRate:1,tags:e,errorType:a})};var p=class n extends Error{constructor(e){super(e),Object.setPrototypeOf(this,n.prototype)}},u=class n extends Error{constructor(e,a="Minor"){super(e),Object.setPrototypeOf(this,n.prototype),a==="Critical"&&L(e)}};var Un=n=>e=>{if(e===null)throw new Error("");let a=e.querySelector(He(n));if(!a)throw new Error("");let r=a.textContent??"",[t="",i=""]=r.split("|").map(y=>y.trim());if(t==="")throw new Error("");let o=a.getAttribute("href")??"";if(o==="")throw new Error("");let s=a.getAttribute("daa-ll"),l=a.getAttribute("aria-label")?.trim()??"",d=l!==""?l:i!==""?i:void 0,v=[];return[{type:n.type,text:t,href:o,ariaLabel:d,daaLl:typeof s=="string"&&s.trim()!==""?s:t},v]},vn=Un({type:"PrimaryCTA"}),A=Un({type:"SecondaryCTA"}),Nn=n=>G(vn).or(A).eval(n),He=({type:n})=>{switch(n){case"PrimaryCTA":return"strong > a";case"SecondaryCTA":return"em > a";default:throw new Error("")}};var hn=({text:n,href:e,daaLl:a,ariaLabel:r})=>`
<a href="${E(e)}"
...
`,jn=n=>n.type==="PrimaryCTA"?hn(n):z(n);var q=({text:n,href:e,daaLl:a,svgIcon:r=""})=>`<a class="feds-link" href="${E(e)}"${k(null,a??n)}>${n}${r}</a>`;var Bn=n=>{let[e,a]=De(n);return[{type:"LinksCard",card:e},a]},De=n=>{let e=n.querySelector("h2, h3, h4")||null;if(!e)throw new p("Expected links card title");let a=n.querySelector("em > a"),r=[...n.querySelectorAll("a")].filter(l=>l!==a);if(r.length===0)throw new p("Expected at least one link");let[t,i]=T(r,S),[o,s]=(()=>{try{return A(n)}catch{return[null,[]]}})();return o&&(o.daaLl=`${e.textContent??""} - ${o?.daaLl}`),[{type:"LinksCardItem",title:e.textContent??"",links:t,footerCTA:o},[...i,...s]]};var qn=n=>{let e=[...n.querySelectorAll("li > div")],a=[...n.querySelectorAll("li > a")],[r,t]=T(e,Ue),[i,o]=T(a,S);return[{type:"ProductList",categories:r,links:i},[...t,...o]]},Ue=n=>{let e=n.firstElementChild;if(e?.nodeName!=="H2")throw new p("Expected H2");let a=e.textContent??"",r=e.textContent??"",t=Ln(e),[i,o]=T(t,dn);return[{type:"ProductCategory",name:a,daaLl:r,links:i},o]};var Gn=n=>{let[e,a]=Ne(n);return[{type:"FeaturedCard",card:e},a]},Ne=n=>{let e=n.querySelector("h5")||null;if(!e)throw new u("Eye brow element not found");let a=n.querySelector("h4")||null,r=a?.nextElementSibling||null;if(!a)throw new p("Expected title");if(!r)throw new p("Expected subtitle");let t=r.nextElementSibling?.firstElementChild||null;if(!t)throw new p("Expected card link after subtitle");let[i,o]=S(t),[s,l]=A(n);return[{type:"Card",title:a.textContent??"",subtitle:r.textContent??"",bodyLink:i,footerCTA:s,eyeBrow:e.textContent??""},[...l,...o]]};var M={MissingBackgroundImageSection:"Promo card is missing background image section",MissingBackgroundImage:"Promo card is missing background image",MissingBackgroundImageAlt:"Promo card background image is missing alt text",MissingBackgroundImageSrc:"Promo card background image is missing src",MissingContentSection:"Promo card is missing card details section",MissingIcon:"Promo card is missing icon",MissingIconSrc:"Promo card icon is missing src",MissingIconAlt:"Promo card icon is missing alt text",MissingTitleElement:"Promo card is missing title element",MissingTitleText:"Promo card is missing title text",MissingSecondaryCtaAnchor:"Promo card is missing secondary CTA anchor",MissingPriceLink:"Promo card is missing price link"},On=n=>{let[e,a]=n.querySelectorAll(":scope > div"),r=new Set;if(e===void 0)throw new p(M.MissingBackgroundImageSection);let t=e.querySelector(":scope picture:not(:scope p picture) img")??null;t===null&&r.add(new u(M.MissingBackgroundImage));let i=t?.getAttribute("alt")??"";i===""&&r.add(new u(M.MissingBackgroundImageAlt));let o=t?.getAttribute("src")??"";if(o===""&&r.add(new u(M.MissingBackgroundImageSrc)),a===void 0)throw new p(M.MissingContentSection);let s=a.querySelector('a[href$=".svg"]')??null;s===null&&r.add(new u(M.MissingIcon));let[l,d]=(s?.textContent?.split("|")??["",""]).map(w=>w.trim());l===""&&r.add(new u(M.MissingIconSrc)),d===""&&r.add(new u(M.MissingIconAlt));let v=a.querySelector('p > a:not([href$=".svg"])')??null,y=v?.textContent?.trim()??"",g=v?.getAttribute("href")??"",c=g?Cn(g):!1;v===null&&r.add(new u(M.MissingPriceLink));let f=a.querySelector("p > strong")??null;if(f===null)throw new p(M.MissingTitleElement);let h=f?.textContent??"";h===""&&r.add(new u(M.MissingTitleText)),a.querySelector("em > a")===null&&r.add(new u(M.MissingSecondaryCtaAnchor));let[m,b]=(()=>{try{return A(n)}catch{return[null,[]]}})();return b.forEach(w=>r.add(w)),m&&(m.daaLl=`${h} - ${m?.daaLl}`),[{type:"PromoCard",card:{bgImageAlt:i,bgImageSrc:o,iconAlt:d,iconSrc:l,title:h,cta:m,priceText:y,priceHref:g,isPriceMerchLink:c}},[...r]]};var Xn=n=>{let e=new Set;if(n===null)throw new p(Fn.elementNull);let a=n.querySelector("h2")?.textContent??"";a===""&&e.add(new u(Fn.noTitle));let r=(async()=>{try{let t=n.querySelector("a"),i=new URL(t?.href??""),o=await U(i);if(o instanceof p)throw new Error(o.message);let s=await Mn(o);if(s instanceof p)throw new Error(s.message);return _n(i.href,s),n.classList.contains("product-list")?qn(s):je(s)}catch(t){throw new p(t?.message)}})();if(r instanceof p)throw r;return[{type:"MegaMenu",title:a,content:r},[...e]]},Fn={elementNull:"Element is null",noTitle:"Large Menu has no Title"},je=n=>{let e=[...n.children];if(e.length===0)throw new p("No mega menu items found (did you forget to add them correctly?)");let[a,r]=T(e,t=>Be(t));if(a.length===0)throw new p("Failed to parse gnav cards sections");return[{type:"GnavCards",sections:a},r]},Be=n=>{let e=[...n.querySelectorAll(".featured-card, .links-card, .promo-card")];if(e.length===0)throw new p("Column contains no cards (did you forget to label them correctly?)");let[a,r]=T(e,t=>qe(t));if(a.length===0)throw new p("Failed to parse cards in column");return[{type:"GnavColumn",cards:a},r]},qe=n=>{if(n.classList.contains("featured-card"))return Gn(n);if(n.classList.contains("links-card"))return Bn(n);if(n.classList.contains("promo-card"))return On(n);throw new p("Unsupported gnav cards section")};var Wn=({card:n})=>Ge(n),Ge=({title:n,subtitle:e,eyeBrow:a,footerCTA:r,bodyLink:t})=>`
...
`.trim();var Vn=({card:n})=>Fe(n),Fe=({bgImageAlt:n,bgImageSrc:e,iconAlt:a,iconSrc:r,title:t,cta:i,priceText:o,priceHref:s,isPriceMerchLink:l})=>`
...
`;var Yn=({categories:n,links:e})=>{let a=`
  ...
  <div id="${V(n)}" popover class="feds-popup">
  </div>
`,Qn=(n,e,a)=>{let r=`
        <button
          type="button"
  ...
  `.trim(),o="";switch(n.type){case"ProductList":o=Yn(n);break;case"GnavCards":o=Kn(n);break;default:}return`${i}${o}`};var ne={elementNull:"Error when parsing text. Element is null",textContentNull:"Error when parsing text. Element has no textContent"},ee=n=>{if(n===null)return[{type:"Text",content:""},[new u(ne.elementNull,"Minor")]];let e=n.textContent;return e===null?[{type:"Text",content:""},[new u(ne.textContentNull,"Minor")]]:[{type:"Text",content:e},[]]};var ae=({content:n})=>n;var re=n=>{if(n===null)throw new p(Ze.elementNull);let e=n.querySelector(".gnav-brand");if(e!==null)return cn(e);let a=n.querySelector(".large-menu");return a!==null?Xn(a):n.querySelector("strong")!==null?vn(n):n.querySelector("em")!==null?A(n):n.querySelector("a")===null?ee(n):S(n.querySelector("a"))},bn=(n,e)=>{switch(n.type){case"Text":return ae(n);case"Link":return q(n);case"SecondaryCTA":return z(n);case"PrimaryCTA":return hn(n);case"Brand":return gn(n);case"MegaMenu":return Jn(n,e);default:return console.error(`Failed to recognize component: ${n}`),""}},Ze={elementNull:"Element is null"};var te=(n,e)=>{let[a,r]=T([...document.querySelectorAll(".breadcrumbs ul > li > a")??[]],S),[t,i]=T([...n.children],re),o=n.querySelector(".product-entry-cta"),[s,l]=(()=>{try{return Nn(o)}catch{return[null,[]]}})(),d=!1,v=[r,i,l].flat();return{breadcrumbs:a,components:t,productCTA:s,localnav:d,errors:v,unavEnabled:e}};var oe=n=>{let e=[...n.querySelectorAll('.tabs button[role="tab"]')],a=[...n.querySelectorAll(".tab-content ul")],r=e.map((t,i)=>()=>{let o=a[i].closest(":popover-open");if(e.forEach(d=>{d.setAttribute("aria-selected","false")}),a.forEach(d=>{d.setAttribute("hidden","true")}),a[i]?.removeAttribute("hidden"),t.setAttribute("aria-selected","true"),!o||!P.matches)return;let s=ie();if(!s)return;let l=o?.clientHeight??0;s.style.height=`${l+72}px`});return e.forEach((t,i)=>{t.addEventListener("click",r[i])}),Ve(n),()=>{e.forEach((t,i)=>{t.removeEventListener("click",r[i])})}},ie=()=>[...document.adoptedStyleSheets.flatMap(n=>[...n.cssRules])].find(n=>n?.selectorText==="header.global-navigation nav::after"),Ve=n=>{let e=[...n.querySelectorAll(".feds-gnav-items > li > button")],a=n.querySelector(".feds-gnav-items"),r=ie(),t=new ResizeObserver(i=>{if(i.length<1)return;let o=n.querySelector(".feds-popup:popover-open");if(!o){r.style.height="100%";return}let l=o.clientHeight<1?"100%":`${o.clientHeight+72}px`;r.style.height=l});e.forEach(i=>{if(!r)return;let o=i.nextElementSibling;o&&(t.observe(o),o.addEventListener("toggle",s=>{s.newState!=="open"&&!n.querySelector(".feds-popup:popover-open")?r.style.height="100%":r.style.height=`${o.clientHeight+72}px`}))}),e.forEach(i=>{i.addEventListener("click",()=>{if(P.matches||!a)return;let o=i.nextElementSibling;o&&(a.classList.remove("subscreen-closing"),a.classList.add("subscreen-opening"),o.querySelector(".feds-popup-back-button")?.addEventListener("click",()=>{a.classList.remove("subscreen-opening"),a.classList.add("subscreen-closing"),setTimeout(()=>o.hidePopover(),240)}))})}),P.addEventListener("change",()=>{a?.classList.remove("subscreen-opening"),a?.classList.remove("subscreen-closing")}),n.querySelector(".feds-nav-toggle")?.addEventListener("click",()=>{a?.classList.remove("subscreen-opening"),a?.classList.remove("subscreen-closing")})};var se=async n=>{let e=new Set,a=n.querySelectorAll("a.merch");if(a.length===0)return e;try{let r=C(),{base:t}=r;if(!t)return e.add(new u("base not found in config, cannot initialize merch links")),e;let i=await import(`${t}/blocks/merch/merch.js`),{default:o}=i;if(!o)return e.add(new u("decorateMerchLink not found in merch module")),e;a.forEach(s=>{o(s)})}catch(r){e.add(new u(`Error initializing merch links: ${r}`))}return e};var le=async({gnavSource:n,asideSource:e})=>{let a=await U(n);if(a instanceof p)return a;let r=await U(e);return{mainNav:a,aside:r}};var de=new CSSStyleSheet;de.replaceSync(String.raw`/**
...
<nav popover="manual" data-lenis-prevent>
  <ul>
    ${(()=>{let r=n.find(l=>l.type==="Brand")??null,t=n.filter(l=>l.type!=="Brand"),i=`
      ...
      `.trim(),o=r?bn(r):"",s=Pn(t,bn);return`
...
`,Je=async n=>{let e=new Set,a=await an(n.mountpoint);a instanceof u?(e.add(a),L(a.message)):a.errors.forEach(o=>e.add(o)),oe(n.mountpoint),mn(n.mountpoint),Qe(n.mountpoint),na(n.mountpoint),ea(n.mountpoint),ra(n.mountpoint),ta(n.mountpoint,n.mepMartech??"");let r=()=>{document.querySelector("nav[popover]")?.removeAttribute("popover"),O(n.mountpoint)};document.querySelector(".dialog-modal")&&r(),document.addEventListener("click",o=>{o.target instanceof Element&&o.target.closest('a[href*="#openPrivacy"]')&&r()}),window.addEventListener("milo:modal:loaded",r),window.addEventListener("milo:modal:closed",()=>{let o=document.querySelector("nav");o?.setAttribute("popover","manual"),o?.showPopover?.()}),(await se(n.mountpoint)).forEach(o=>{e.add(o),L(o.message)});let i=a instanceof u?()=>{}:a.reloadUnav;return{closeEverything:aa,reloadUnav:i,errors:e,setGnavTopPosition:o=>{},getGnavTopPosition:()=>0}},Qe=n=>{let e=n.querySelector("#feds-menu-wrapper"),a=n.querySelector(".feds-nav-toggle");e?.addEventListener("toggle",()=>{let t=e.matches(":popover-open");a?.setAttribute("aria-expanded",String(t)),a?.setAttribute("daa-ll",t?"hamburgermenu|close":"hamburgermenu|open"),e.setAttribute("aria-hidden",String(!t)),t&&e.classList.add("feds-menu-active")}),e?.addEventListener("transitionend",()=>{e.matches(":popover-open")||e.classList.remove("feds-menu-active")}),n.querySelectorAll(".feds-popup[popover]").forEach(t=>{t.addEventListener("toggle",()=>{let i=n.querySelector(`[popovertarget="${t.id}"]`),o=t.matches(":popover-open");i?.setAttribute("aria-expanded",String(o)),i?.setAttribute("daa-ll",o?"header|Close":"header|Open")})})},na=n=>{P.addEventListener("change",()=>{O(n)})},ea=n=>{[...n.querySelector(".feds-utilities #universal-nav")?.children??[]].forEach(e=>{e.addEventListener("click",()=>O(n)),e.addEventListener("keydown",a=>{a.key==="Enter"&&O(n)})})};var aa=()=>{},ra=n=>{let e=n.closest("header");if(!e)return;let a=n.querySelector("#feds-menu-wrapper"),r=()=>a?.matches(":popover-open")??!1,t=()=>window.scrollY>100,i=()=>{if(r()){e.classList.remove("feds-header-scrolled");return}if(t()){e.classList.add("feds-header-scrolled");return}e.classList.remove("feds-header-scrolled")};i(),window.addEventListener("scroll",i,{passive:!0}),a?.addEventListener("toggle",i)},ta=(n,e)=>{let a=n.closest("header");a!==null&&a.setAttribute("daa-lh",`gnav|${In()}${e}`)};export{yo as main,Je as postRenderingTasks,Ke as renderGnav,Ye as renderGnavString};
