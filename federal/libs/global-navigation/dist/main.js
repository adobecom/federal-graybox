...
`};var B={elementNull:"Error when parsing Brand. Element is null",noLinkSection:"Error when parsing Brand. No link section found",noLink:"Error when parsing Brand. No link found",noImageSection:"Error when parsing Brand. No image section found",missingImageSections:"Error when parsing Brand. Missing mobile or desktop image section",missingThemeImages:"Error when parsing Brand. Missing mobile or desktop image section"},pn=n=>{let e=new Set;if(n===null)throw new c(B.elementNull);let r=!!n.classList.contains("dark-bg"),[t,a]=n.querySelectorAll(":scope > div");if(t===void 0)throw new c(B.noLinkSection);let o=t.querySelector("a");if(o===null)throw new c(B.noLink);let i=o.getAttribute("href")??"",s=o.textContent?.trim()??"";a===void 0&&e.add(new u(B.noImageSection));let[l,d]=a?.querySelectorAll(":scope > div")??[];(l===void 0||d===void 0)&&e.add(new u(B.missingImageSections));let m=l?.querySelectorAll('a[href$=".svg"]'),b=d?.querySelectorAll('a[href$=".svg"]'),g=m?.[0]?.getAttribute("href")??"",p=m?.[0]?.textContent?.split("|")[1]?.trim()??"",f=m?.[1]?.getAttribute("href")??"",v=m?.[1]?.textContent?.split("|")[1]?.trim()??"",y=b?.[0]?.getAttribute("href")??"",h=b?.[0]?.textContent?.split("|")[1]?.trim()??"",x=b?.[1]?.getAttribute("href")??"",w=b?.[1]?.textContent?.split("|")[1]?.trim()??"";return(!g||!y||!f||!x)&&e.add(new u(B.missingThemeImages)),[{type:"Brand",data:{href:i,label:s,isDarkBg:r,imageData:{type:"svg",lightThemeImageSrc:y,lightThemeImageAlt:h,darkThemeImageSrc:x,darkThemeImageAlt:w,mobileLightThemeImageSrc:g,mobileLightThemeImageAlt:p,mobileDarkThemeImageSrc:f,mobileDarkThemeImageAlt:v}}},[...e]]};var Ee=`
<?xml
...
`.trim(),Se=n=>{let{href:e,label:r,isDarkBg:t,imageData:a}=n,o=a.lightThemeImageSrc?.trim()||a.darkThemeImageSrc?.trim()||"",i=a.darkThemeImageSrc?.trim()||a.lightThemeImageSrc?.trim()||"",s=a.mobileLightThemeImageSrc?.trim()||a.mobileDarkThemeImageSrc?.trim()||"",l=a.mobileDarkThemeImageSrc?.trim()||a.mobileLightThemeImageSrc?.trim()||"",d=a.lightThemeImageAlt||a.darkThemeImageAlt||"",m=a.darkThemeImageAlt||a.lightThemeImageAlt||"",b=a.mobileLightThemeImageAlt||a.mobileDarkThemeImageAlt||"",g=a.mobileDarkThemeImageAlt||a.mobileLightThemeImageAlt||"",p=!!o,f=!!i,v=!!s,y=!!l,h=p?`<img src="${R(o)}" alt="${d}" />`:"",x=f?`<img src="${R(i)}" alt="${m}" />`:"",w=v?`<img src="${R(s)}" alt="${b}" />`:"",U=y?`<img src="${R(l)}" alt="${g}" />`:"";return`<div class="feds-brand-container${t?" feds-dark-bg":""}">
  ...
  </div>`.trim()},gn=n=>{let{data:e}=n;return Se(e)};var un=["appswitcher","help"],Y={cs:["cz"],da:["dk"],de:["at"],en:["africa","au","ca","ie","in","mt","ng","nz","sg","za"],es:["ar","cl","co","cr","ec","gt","la","mx","pe","pr"],et:["ee"],ja:["jp"],ko:["kr"],nb:["no"],pt:["br"],sl:["si"],sv:["se"],uk:["ua"],zh:["cn","tw"]},[O,Rn]=(()=>{let n,e,r,t=new Promise(a=>{e=a,r=setTimeout(()=>{n={},a(n)},5e3)});return[a=>{a&&!n&&(n=a,clearTimeout(r),e?.(n))},()=>t]})();function J(n,e=!1){let s=(/uc_carts=/.test(document.cookie)?n:n?.filter(d=>d!=="cart"))??[],l=s.length??3;if(e){let d=s.filter(b=>un.includes(b)).length;return`calc(92px + ${d*32}px + ${d*.25}rem)`}return`calc(${l*32}px + ${(l-1)*.25}rem)`}var Q=n=>{if(!n.prefix||n.prefix==="/")return"en_US";let e=n.prefix.replace("/","");if(e.includes("_")){let[t,a]=e.split("_").reverse();return`${t.toLowerCase()}_${a.toUpperCase()}`}if(e==="uk")return"en_GB";let r=Object.keys(Y).find(t=>Y[t].includes(e));return r?`${r.toLowerCase()}_${e.toUpperCase()}`:`${e.toLowerCase()}_${e.toUpperCase()}`},Me={Mac:"macOS",Win:"windows",Linux:"linux",CrOS:"chromeOS",Android:"android",iPad:"iPadOS",iPhone:"iOS"},nn=()=>{let n=navigator.userAgent;for(let[e,r]of Object.entries(Me))if(n.includes(e))return r;return"linux"},en=async()=>{let n=window;return n.alloy?await n.alloy("getIdentity").then(e=>e?.identity?.ECID).catch(()=>{}):void 0};var Hn=()=>{try{return C().signInContext||{}}catch{return{}}},Pe=()=>{let n=C();return N("signin-cta-style")==="primary"||n?.unav?.profile?.signInCtaStyle==="primary"?"primary":"secondary"},Ae=()=>{let e=C()?.unav?.profile?.messageEventListener;return e||(r=>{let{name:t,payload:a,executeDefaultAction:o}=r.detail;if(!(!t||t!=="System"||!a||typeof o!="function"))switch(a.subType){case"AppInitiated":window.adobeProfile?.getUserProfile().then(i=>{O(i)}).catch(()=>{O({})});break;case"SignOut":o();break;case"ProfileSwitch":Promise.resolve(o()).then(i=>{i&&window.location.reload()});break;default:break}})};function _e(){let{unav:n}=C();return n?.unavHelpChildren||[{type:"Support"},{type:"Community"}]}var F=()=>{let n=C();return{profile:{name:"profile",attributes:{accountMenuContext:{sharedContextConfig:{enableLocalSection:!0,enableProfileSwitcher:!0,miniAppContext:{logger:{trace:()=>{},debug:()=>{},info:()=>{},warn:()=>{},error:()=>{}}},complexConfig:n?.unav?.profile?.complexConfig||null,...n?.unav?.profile?.config},messageEventListener:Ae()},signInCtaStyle:Pe(),isSignUpRequired:!1,callbacks:{onSignIn:()=>{window.adobeIMS?.signIn(Hn())},onSignUp:()=>{window.adobeIMS?.signIn(Hn())}}}},appswitcher:{name:"app-switcher"},notifications:{name:"notifications",attributes:{notificationsConfig:{applicationContext:{appID:n?.unav?.uncAppId||"adobecom",...n?.unav?.uncConfig}}}},help:{name:"help",attributes:{children:_e()}},jarvis:{name:"jarvis",attributes:{appid:n?.jarvis?.id,callbacks:n?.jarvis?.callbacks}},cart:{name:"cart"}}};var zn=(n,e)=>{n[0]&&"attributes"in n[0]&&n[0].attributes&&typeof n[0].attributes=="object"&&"isSignUpRequired"in n[0].attributes&&(n[0].attributes.isSignUpRequired=e)},rn=async(n,e)=>{try{let r=n.querySelector(".feds-utilities");if(!(r instanceof HTMLElement))return new u('missing ".feds-utilities" container');let t=new Set,a=document.head.querySelector('meta[name="universal-nav"]'),o=a instanceof HTMLMetaElement?a.content??"":"";a instanceof HTMLMetaElement||t.add(new u('metadata "universal-nav" is missing'));let i=o.trim();a instanceof HTMLMetaElement&&i.length===0&&t.add(new u('metadata "universal-nav" has no value'));let s=!window.adobeIMS?.isSignedInUser(),l=i.split(",").map(h=>h.trim()).filter(h=>Object.keys(F()).includes(h)||h==="signup");if(s){let h=J(l,s);r.style.setProperty("min-width",h)}let d;try{d=C()}catch{throw new Error("MiloConfig not available for UNAV initialization")}let m=Q(d.locale),b=d.env.name==="prod"?"prod":"stage",g=await en(),p=new URLSearchParams(window.location.search).get("unavVersion");/^\d+(\.\d+)?$/.test(p??"")||(p="1.5"),await Promise.all([sn(`https://${b}.adobeccstatic.com/unav/${p}/UniversalNav.js`),on(`https://${b}.adobeccstatic.com/unav/${p}/UniversalNav.css`,!0)]);let f=()=>{let h=F(),x=[h.profile];return zn(x,!1),l?.forEach(w=>{if(w==="profile")return;if(w==="signup"){zn(x,!0);return}let U=h[w];U&&x.push(U)}),x},v=()=>({target:r,env:b,locale:m,countryCode:In(d?.locale)?.country||"US",imsClientId:window?.adobeid?.client_id,theme:"light",analyticsContext:{consumer:{name:"adobecom",version:"1.0",platform:"Web",device:nn(),os_version:navigator.platform},event:{visitor_guid:g}},children:f(),isSectionDividerRequired:!!d?.unav?.showSectionDivider,showTrayExperience:!A.matches});await window?.UniversalNav?.(v()),s||r?.style.removeProperty("min-width");let y=h=>{window?.UniversalNav?.reload(v())};return A.addEventListener("change",()=>{y()}),{reloadUnav:y,errors:t}}catch(r){let t=r instanceof Error?r.message:"failed to load universal nav";return new u(t)}};function H(n,e){return[...n.querySelectorAll(e)]}function W(n,e,r){H(n,e).forEach(t=>r?t.removeAttribute("tabindex"):t.setAttribute("tabindex","-1"))}var q={ArrowLeft:-1,ArrowRight:1,ArrowUp:-1,ArrowDown:1},Un=new Set(["ArrowLeft","ArrowRight"]),Ie=new Set(["ArrowUp","ArrowDown"]),$e='.tabs [role="tab"][aria-selected="true"]';function fn(n,e,r){return(n+e+r)%r}function Re(n,e,r,t){let a=q[r];if(Un.has(r)){let p=e+a;return p>=0&&p<n.length?p:null}let o=getComputedStyle(t).gridTemplateColumns.split(" ").length,i=[...t.children],s=p=>{let f=n[p].parentElement;return f?i.indexOf(f):-1},l=s(e)%o,d=Math.floor(s(e)/o)+(r==="ArrowDown"?1:-1),m=Math.floor((i.length-1)/o);if(d<0||d>m)return null;let b=null,g=1/0;for(let p=0;p<n.length;p++){let f=Math.abs(s(p)%o-l);Math.floor(s(p)/o)===d&&f<g&&(g=f,b=p)}return b}function mn(n){W(n,'.tab-content [role="tabpanel"] a',!1);let e=[];H(n,".feds-popup[popover]").forEach(g=>{let p=()=>{g.matches(":popover-open")||W(g,'[role="tabpanel"] a',!1)};g.addEventListener("toggle",p),e.push(()=>g.removeEventListener("toggle",p))});let r=(g,p)=>{g.focus(),p.preventDefault()},t=()=>n.querySelector(".feds-popup:popover-open"),a=g=>g.querySelector($e),o=g=>g.querySelector('[role="tabpanel"]:not([hidden])');function i(g){let p=t(),f=n.querySelector("#feds-menu-wrapper");if(!f)return!1;let v=p??(f?.matches(":popover-open")?f:null);if(!v)return!1;v.hidePopover?.();let y=p?`[popovertarget="${v.id}"]`:".feds-nav-toggle";return n.querySelector(y)?.focus(),g.preventDefault(),!0}function s(g,p,f){if(!Un.has(p))return!1;let v=H(n,".feds-gnav-items > li > .feds-link"),y=v.indexOf(g);return y<0?!1:(r(v[fn(y,q[p],v.length)],f),!0)}function l(g,p,f,v){let y=H(p,'.tabs :is([role="tab"], .product-links a)'),h=y.indexOf(g);if(h<0)return!1;if(q[f]){let x=y[fn(h,q[f],y.length)];return x.matches('[role="tab"]')&&x.click(),r(x,v),!0}if(f==="Tab"&&!v.shiftKey&&g.matches('[aria-selected="true"]')){let x=o(p);if(!x)return!1;W(x,"a",!0);let w=x.querySelector("a");return w&&r(w,v),!0}return!1}function d(g,p,f,v){let y=o(p);if(!y)return!1;let h=H(y,"a"),x=h.indexOf(g);if(x<0)return!1;if(q[f]){let w=Re(h,x,f,y);return w!==null?(r(h[w],v),!0):f==="ArrowUp"?(W(y,"a",!1),r(a(p)??h[0],v),!0):!1}if(f==="Tab"&&!v.shiftKey){if(x+1<h.length)r(h[x+1],v);else{let w=H(p,'.tabs [role="tab"]'),U=a(p),tn=w[w.indexOf(U)+1]??p.querySelector(".product-links a");if(tn)r(tn,v);else return!1}return!0}if(f==="Tab"&&v.shiftKey){if(x>0)r(h[x-1],v);else{W(y,"a",!1);let w=a(p)??H(p,'.tabs :is([role="tab"], .product-links a)')[0];w&&r(w,v)}return!0}return!1}function m(g,p,f,v){if(!Ie.has(f))return!1;let y=H(p,".feds-gnav-cards a"),h=y.indexOf(g);return h<0?!1:(r(y[fn(h,q[f],y.length)],v),!0)}function b(g){let p=document.activeElement??g.target;if(g.key==="Escape"){i(g);return}let f=t();f&&(f.matches(":has(.product-list)")&&(l(p,f,g.key,g)||d(p,f,g.key,g))||f.matches(":has(.feds-gnav-cards)")&&m(p,f,g.key,g))||s(p,g.key,g)}return n.addEventListener("keydown",b),e.push(()=>n.removeEventListener("keydown",b)),()=>e.forEach(g=>g())}var He="feds-milo",L=(n,e="default",r="e")=>{let{locale:t}=C(),a=N("gnav-source")??`${t.contentRoot??""}/gnav`;window.lana||console.warn("lana logging unavailable in the gnav"),window?.lana?.log(`${n} | gnav-source: ${a} | href: ${window.location.href}`,{clientId:He,sampleRate:1,tags:e,errorType:r})};var c=class n extends Error{constructor(e){super(e),Object.setPrototypeOf(this,n.prototype)}},u=class n extends Error{constructor(e,r="Minor"){super(e),Object.setPrototypeOf(this,n.prototype),r==="Critical"&&L(e)}};var Dn=n=>e=>{if(e===null)throw new Error("");let r=e.querySelector(ze(n));if(!r)throw new Error("");let t=r.textContent??"",[a="",o=""]=t.split("|").map(b=>b.trim());if(a==="")throw new Error("");let i=r.getAttribute("href")??"";if(i==="")throw new Error("");let s=r.getAttribute("daa-ll"),l=r.getAttribute("aria-label")?.trim()??"",d=l!==""?l:o!==""?o:void 0,m=[];return[{type:n.type,text:a,href:i,ariaLabel:d,daaLl:typeof s=="string"&&s.trim()!==""?s:a},m]},vn=Dn({type:"PrimaryCTA"}),_=Dn({type:"SecondaryCTA"}),Nn=n=>G(vn).or(_).eval(n),ze=({type:n})=>{switch(n){case"PrimaryCTA":return"strong > a";case"SecondaryCTA":return"em > a";default:throw new Error("")}};var hn=({text:n,href:e,daaLl:r,ariaLabel:t})=>`
<a href="${E(e)}"
...
`,Bn=n=>n.type==="PrimaryCTA"?hn(n):I(n);var j=({text:n,href:e,daaLl:r,svgIcon:t=""})=>`<a class="feds-link" href="${E(e)}"${k(null,r??n)}>${n}${t}</a>`;var qn=n=>{let[e,r]=Ue(n);return[{type:"LinksCard",card:e},r]},Ue=n=>{let e=n.querySelector("h2, h3, h4")||null;if(!e)throw new c("Expected links card title");let r=n.querySelector("em > a"),t=[...n.querySelectorAll("a")].filter(l=>l!==r);if(t.length===0)throw new c("Expected at least one link");let[a,o]=S(t,T),[i,s]=(()=>{try{return _(n)}catch{return[null,[]]}})();return i&&(i.daaLl=`${e.textContent??""} - ${i?.daaLl}`),[{type:"LinksCardItem",title:e.textContent??"",links:a,footerCTA:i},[...o,...s]]};var jn=n=>{let e=[...n.querySelectorAll("li > div")],r=[...n.querySelectorAll("li > a")],[t,a]=S(e,De),[o,i]=S(r,T);return[{type:"ProductList",categories:t,links:o},[...a,...i]]},De=n=>{let e=n.firstElementChild;if(e?.nodeName!=="H2")throw new c("Expected H2");let r=e.textContent??"",t=e.textContent??"",a=Ln(e),[o,i]=S(a,dn);return[{type:"ProductCategory",name:r,daaLl:t,links:o},i]};var Gn=n=>{let[e,r]=Ne(n);return[{type:"FeaturedCard",card:e},r]},Ne=n=>{let e=n.querySelector("h5")||null;if(!e)throw new u("Eye brow element not found");let r=n.querySelector("h4")||null,t=r?.nextElementSibling||null;if(!r)throw new c("Expected title");if(!t)throw new c("Expected subtitle");let a=t.nextElementSibling?.firstElementChild||null;if(!a)throw new c("Expected card link after subtitle");let[o,i]=T(a),[s,l]=_(n);return[{type:"Card",title:r.textContent??"",subtitle:t.textContent??"",bodyLink:o,footerCTA:s,eyeBrow:e.textContent??""},[...l,...i]]};var P={MissingBackgroundImageSection:"Promo card is missing background image section",MissingBackgroundImage:"Promo card is missing background image",MissingBackgroundImageAlt:"Promo card background image is missing alt text",MissingBackgroundImageSrc:"Promo card background image is missing src",MissingContentSection:"Promo card is missing card details section",MissingIcon:"Promo card is missing icon",MissingIconSrc:"Promo card icon is missing src",MissingIconAlt:"Promo card icon is missing alt text",MissingTitleElement:"Promo card is missing title element",MissingTitleText:"Promo card is missing title text",MissingSecondaryCtaAnchor:"Promo card is missing secondary CTA anchor",MissingPriceLink:"Promo card is missing price link"},On=n=>{let[e,r]=n.querySelectorAll(":scope > div"),t=new Set;if(e===void 0)throw new c(P.MissingBackgroundImageSection);let a=e.querySelector(":scope picture:not(:scope p picture) img")??null;a===null&&t.add(new u(P.MissingBackgroundImage));let o=a?.getAttribute("alt")??"";o===""&&t.add(new u(P.MissingBackgroundImageAlt));let i=a?.getAttribute("src")??"";if(i===""&&t.add(new u(P.MissingBackgroundImageSrc)),r===void 0)throw new c(P.MissingContentSection);let s=r.querySelector('a[href$=".svg"]')??null;s===null&&t.add(new u(P.MissingIcon));let[l,d]=(s?.textContent?.split("|")??["",""]).map(w=>w.trim());l===""&&t.add(new u(P.MissingIconSrc)),d===""&&t.add(new u(P.MissingIconAlt));let m=r.querySelector('p > a:not([href$=".svg"])')??null,b=m?.textContent?.trim()??"",g=m?.getAttribute("href")??"",p=g?Cn(g):!1;m===null&&t.add(new u(P.MissingPriceLink));let f=r.querySelector("p > strong")??null;if(f===null)throw new c(P.MissingTitleElement);let v=f?.textContent??"";v===""&&t.add(new u(P.MissingTitleText)),r.querySelector("em > a")===null&&t.add(new u(P.MissingSecondaryCtaAnchor));let[h,x]=(()=>{try{return _(n)}catch{return[null,[]]}})();return x.forEach(w=>t.add(w)),h&&(h.daaLl=`${v} - ${h?.daaLl}`),[{type:"PromoCard",card:{bgImageAlt:o,bgImageSrc:i,iconAlt:d,iconSrc:l,title:v,cta:h,priceText:b,priceHref:g,isPriceMerchLink:p}},[...t]]};var Wn=n=>{let e=new Set;if(n===null)throw new c(Fn.elementNull);let r=n.querySelector("h2")?.textContent??"";r===""&&e.add(new u(Fn.noTitle));let t=(async()=>{try{let a=n.querySelector("a"),o=new URL(a?.href??""),i=await D(o);if(i instanceof c)throw new Error(i.message);let s=await Pn(i);if(s instanceof c)throw new Error(s.message);return Mn(o.href,s),n.classList.contains("product-list")?jn(s):Be(s)}catch(a){throw new c(a?.message)}})();if(t instanceof c)throw t;return[{type:"MegaMenu",title:r,content:t},[...e]]},Fn={elementNull:"Element is null",noTitle:"Large Menu has no Title"},Be=n=>{let e=[...n.children];if(e.length===0)throw new c("No mega menu items found (did you forget to add them correctly?)");let[r,t]=S(e,a=>qe(a));if(r.length===0)throw new c("Failed to parse gnav cards sections");return[{type:"GnavCards",sections:r},t]},qe=n=>{let e=[...n.querySelectorAll(".featured-card, .links-card, .promo-card")];if(e.length===0)throw new c("Column contains no cards (did you forget to label them correctly?)");let[r,t]=S(e,a=>je(a));if(r.length===0)throw new c("Failed to parse cards in column");return[{type:"GnavColumn",cards:r},t]},je=n=>{if(n.classList.contains("featured-card"))return Gn(n);if(n.classList.contains("links-card"))return qn(n);if(n.classList.contains("promo-card"))return On(n);throw new c("Unsupported gnav cards section")};var Zn=({card:n})=>Ge(n),Ge=({title:n,subtitle:e,eyeBrow:r,footerCTA:t,bodyLink:a})=>`
  <article class="featured-card" ${k(r,"")}>
    <div>
      <div class="featured-eyebrow">${r}</div>
      <h4>${n}</h4>
      <div class="featured-subtitle">${e}</div>
      <span>${j({...a,svgIcon:$.chevronRight})}</span>
    </div>
    <div class="footer-container">
      ${I(t)}
    </div>
  </article>
`.trim();var Xn=({card:n})=>Oe(n),Oe=({title:n,links:e,footerCTA:r})=>`
...
`,Qn=(n,e,r)=>{let t=`
  ...
  `.trim(),i="";switch(n.type){case"ProductList":i=Yn(n);break;case"GnavCards":i=Vn(n);break;default:}return`${o}${i}`};var ne={elementNull:"Error when parsing text. Element is null",textContentNull:"Error when parsing text. Element has no textContent"},ee=n=>{if(n===null)return[{type:"Text",content:""},[new u(ne.elementNull,"Minor")]];let e=n.textContent;return e===null?[{type:"Text",content:""},[new u(ne.textContentNull,"Minor")]]:[{type:"Text",content:e},[]]};var re=({content:n})=>n;var te=n=>{if(n===null)throw new c(Xe.elementNull);let e=n.querySelector(".gnav-brand");if(e!==null)return pn(e);let r=n.querySelector(".large-menu");return r!==null?Wn(r):n.querySelector("strong")!==null?vn(n):n.querySelector("em")!==null?_(n):n.querySelector("a")===null?ee(n):T(n.querySelector("a"))},bn=(n,e)=>{switch(n.type){case"Text":return re(n);case"Link":return j(n);case"SecondaryCTA":return I(n);case"PrimaryCTA":return hn(n);case"Brand":return gn(n);case"MegaMenu":return Jn(n,e);default:return console.error(`Failed to recognize component: ${n}`),""}},Xe={elementNull:"Element is null"};var ae=(n,e)=>{let[r,t]=S([...document.querySelectorAll(".breadcrumbs ul > li > a")??[]],T),[a,o]=S([...n.children],te),i=n.querySelector(".product-entry-cta"),[s,l]=(()=>{try{return Nn(i)}catch{return[null,[]]}})(),d=!1,m=[t,o,l].flat();return{breadcrumbs:r,components:a,productCTA:s,localnav:d,errors:m,unavEnabled:e}};var oe=n=>{let e=[...n.querySelectorAll('.tabs button[role="tab"]')],r=[...n.querySelectorAll(".tab-content ul")],t=e.map((a,o)=>()=>{let i=r[o].closest(":popover-open");if(e.forEach(d=>{d.setAttribute("aria-selected","false")}),r.forEach(d=>{d.setAttribute("hidden","true")}),r[o]?.removeAttribute("hidden"),a.setAttribute("aria-selected","true"),!A.matches)return;let s=ie();if(!s)return;let l=i?.clientHeight??0;s.style.height=`${l+72}px`});return e.forEach((a,o)=>{a.addEventListener("click",t[o])}),Ke(n),()=>{e.forEach((a,o)=>{a.removeEventListener("click",t[o])})}},ie=()=>[...document.adoptedStyleSheets.flatMap(n=>[...n.cssRules])].find(n=>n?.selectorText==="header.global-navigation nav::after"),Ke=n=>{let e=[...n.querySelectorAll(".feds-gnav-items > li > button")],r=n.querySelector(".feds-gnav-items"),t=ie();e.forEach(a=>{if(!t)return;let o=a.nextElementSibling;o&&o.addEventListener("toggle",i=>{if(i.newState==="open"){let s=o.offsetHeight??0;t.style.height=`${s+72}px`}else{if(t.style.height="100%",A.matches)return;r?.classList.remove("subscreen-opening"),r?.classList.add("subscreen-closing")}})}),window.addEventListener("resize",()=>{if(!t)return;let a=n.querySelector(".feds-popup:popover-open");if(!a)return;let o=a.offsetHeight??0;t.style.height=`${o+72}px`}),e.forEach(a=>{a.addEventListener("click",()=>{if(A.matches||!r)return;let o=a.nextElementSibling;o&&(r.classList.remove("subscreen-closing"),r.classList.add("subscreen-opening"),o.querySelector(".feds-popup-back-button")?.addEventListener("click",()=>{r.classList.remove("subscreen-opening"),r.classList.add("subscreen-closing"),setTimeout(()=>o.hidePopover(),240)}))})}),A.addEventListener("change",()=>{r?.classList.remove("subscreen-opening"),r?.classList.remove("subscreen-closing")}),n.querySelector(".feds-nav-toggle")?.addEventListener("click",()=>{r?.classList.remove("subscreen-opening"),r?.classList.remove("subscreen-closing")})};var se=async n=>{let e=new Set,r=n.querySelectorAll("a.merch");if(r.length===0)return e;try{let t=C(),{base:a}=t;if(!a)return e.add(new u("base not found in config, cannot initialize merch links")),e;let o=await import(`${a}/blocks/merch/merch.js`),{default:i}=o;if(!i)return e.add(new u("decorateMerchLink not found in merch module")),e;r.forEach(s=>{i(s)})}catch(t){e.add(new u(`Error initializing merch links: ${t}`))}return e};var le=async({gnavSource:n,asideSource:e})=>{let r=await D(n);if(r instanceof c)return r;let t=await D(e);return{mainNav:r,aside:t}};var Ve=`/**
...
`,de=document.createElement("style");de.textContent=Ve;document.head.appendChild(de);var xo=async n=>{let{gnavSource:e,mountpoint:r,unavEnabled:t,miloConfig:a,personalization:o}=n;if(!(e instanceof URL))throw L(`gnavSource is invalid: ${e}`),new c("gnavSource needs to be a URL object");try{ln(a)}catch(m){throw L(`Failed to initialize MiloConfig: ${m}`),new c(`Failed to initialize MiloConfig: ${m}`)}En(o),Tn(n.localizeLink??(m=>m)),wn(yn(n));let i=await le(n);if(i instanceof c)throw L(i.message),i;let{mainNav:s,aside:l}=i;if(s instanceof c)throw L(s.message),s;let d=ae(s,t);if(d instanceof c)throw L(d.message),d;return await Ye(d)(r),Qe(n)},Ye=n=>async e=>{let r=Je(n);e.innerHTML=r,e.classList.add("site-pivot"),e.querySelector("nav")?.showPopover();let t=[...e.querySelectorAll(".mega-menu ~ .feds-popup")];t.forEach(s=>{s.innerHTML=""});let a=n.components.filter(s=>s.type==="MegaMenu"),o=a.map(s=>s.content),i=await Promise.all(o.map(async(s,l)=>{let[d,m]=await s,b=a[l].title;return t[l].innerHTML=Qn(d,t[l].id,b),m}).flat());return e},Je=({components:n,productCTA:e,unavEnabled:r})=>`
<nav popover="manual">
  <ul>
