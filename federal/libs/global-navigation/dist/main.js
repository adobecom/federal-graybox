...
`,qn=n=>n.type==="PrimaryCTA"?yn(n):R(n);var F=({text:n,href:e,daaLl:a,ariaLabel:r,ariaAttrs:t,svgIcon:i=""})=>`<a class="feds-link" href="${T(e)}"${W(t,r)}${C(null,a??n)}>${n}${i}</a>`;var Bn=n=>{let[e,a]=Ue(n);return[{type:"LinksCard",card:e},a]},Ue=n=>{let e=n.querySelector("h2, h3, h4")||null;if(!e)throw new c("Expected links card title");let a=n.querySelector("em > a"),r=[...n.querySelectorAll("a")].filter(l=>l!==a);if(r.length===0)throw new c("Expected at least one link");let[t,i]=P(r,M),[o,s]=(()=>{try{return I(n)}catch{return[null,[]]}})();return o&&(o.daaLl=`${e.textContent??""} - ${o?.daaLl}`),[{type:"LinksCardItem",title:e.textContent??"",links:t,footerCTA:o},[...i,...s]]};var Gn=(n,e="",a=new Map)=>{let r=[...n.querySelectorAll("li > div")],t=[...n.querySelectorAll("li > a")],[i,o]=P(r,Ne),[s,l]=P(t,M);return[{type:"ProductList",megaMenuTitle:e,categories:i,links:s,placeholders:a},[...o,...l]]},Ne=n=>{let e=n.firstElementChild;if(e?.nodeName!=="H2")throw new c("Expected H2");let a=e.textContent??"",r=e.textContent??"",t=En(e),[i,o]=P(t,cn);return[{type:"ProductCategory",name:a,daaLl:r,links:i},o]};var On=n=>{let[e,a]=je(n);return[{type:"FeaturedCard",card:e},a]},je=n=>{let e=n.querySelector("h5")||null;if(!e)throw new g("Eye brow element not found");let a=n.querySelector("h4")||null,r=a?.nextElementSibling||null;if(!a)throw new c("Expected title");if(!r)throw new c("Expected subtitle");let t=r.nextElementSibling?.firstElementChild||null;if(!t)throw new c("Expected card link after subtitle");let[i,o]=M(t),[s,l]=I(n);return[{type:"Card",title:a.textContent??"",subtitle:r.textContent??"",bodyLink:i,footerCTA:s,eyeBrow:e.textContent??""},[...l,...o]]};var z={MissingBackgroundImageSection:"Promo card is missing background image section",MissingBackgroundImage:"Promo card is missing background image",MissingBackgroundImageAlt:"Promo card background image is missing alt text",MissingBackgroundImageSrc:"Promo card background image is missing src",MissingContentSection:"Promo card is missing card details section",MissingIcon:"Promo card is missing icon",MissingIconSrc:"Promo card icon is missing src",MissingIconAlt:"Promo card icon is missing alt text",MissingTitleElement:"Promo card is missing title element",MissingTitleText:"Promo card is missing title text",MissingSecondaryCtaAnchor:"Promo card is missing secondary CTA anchor",MissingPriceLink:"Promo card is missing price link"},Fn=n=>{let[e,a]=n.querySelectorAll(":scope > div"),r=new Set;if(e===void 0)throw new c(z.MissingBackgroundImageSection);let t=e.querySelector(":scope picture:not(:scope p picture) img")??null;t===null&&r.add(new g(z.MissingBackgroundImage));let i=t?.getAttribute("alt")??"";i===""&&r.add(new g(z.MissingBackgroundImageAlt));let o=t?.getAttribute("src")??"";if(o===""&&r.add(new g(z.MissingBackgroundImageSrc)),a===void 0)throw new c(z.MissingContentSection);let s=a.querySelector('a[href$=".svg"]')??null;s===null&&r.add(new g(z.MissingIcon));let[l,d]=(s?.textContent?.split("|")??["",""]).map(x=>x.trim());l===""&&r.add(new g(z.MissingIconSrc)),d===""&&r.add(new g(z.MissingIconAlt));let v=a.querySelector('p > a:not([href$=".svg"])')??null,h=v?.textContent?.trim()??"",k=v?.getAttribute("href")??"",y=k?Ln(k):!1;v===null&&r.add(new g(z.MissingPriceLink));let p=a.querySelector("p > strong")??null;if(p===null)throw new c(z.MissingTitleElement);let u=p?.textContent??"";u===""&&r.add(new g(z.MissingTitleText)),a.querySelector("em > a")===null&&r.add(new g(z.MissingSecondaryCtaAnchor));let[f,b]=(()=>{try{return I(n)}catch{return[null,[]]}})();return b.forEach(x=>r.add(x)),f&&(f.daaLl=`${u} - ${f?.daaLl}`),[{type:"PromoCard",card:{bgImageAlt:i,bgImageSrc:o,iconAlt:d,iconSrc:l,title:u,cta:f,priceText:h,priceHref:k,isPriceMerchLink:y}},[...r]]};var Wn=n=>{let e=new Set;if(n===null)throw new c(Xn.elementNull);let a=n.querySelector("h2")?.textContent??"";a===""&&e.add(new g(Xn.noTitle));let r=(async()=>{try{let t=n.querySelector("a"),i=new URL(t?.href??""),o=await q(i);if(o instanceof c)throw new Error(o.message);let s=await Pn(o);if(s instanceof c)throw new Error(s.message);if(_n(i.href,s),n.classList.contains("product-list")){let l=await j();return Gn(s,a,l)}return qe(s,a)}catch(t){throw new c(t?.message)}})();if(r instanceof c)throw r;return[{type:"MegaMenu",title:a,content:r},[...e]]},Xn={elementNull:"Element is null",noTitle:"Large Menu has no Title"},qe=(n,e)=>{let a=[...n.children];if(a.length===0)throw new c("No mega menu items found (did you forget to add them correctly?)");let[r,t]=P(a,i=>Be(i));if(r.length===0)throw new c("Failed to parse gnav cards sections");return[{type:"GnavCards",megaMenuTitle:e,sections:r},t]},Be=n=>{let e=[...n.querySelectorAll(".featured-card, .links-card, .promo-card")];if(e.length===0)throw new c("Column contains no cards (did you forget to label them correctly?)");let[a,r]=P(e,t=>Ge(t));if(a.length===0)throw new c("Failed to parse cards in column");return[{type:"GnavColumn",cards:a},r]},Ge=n=>{if(n.classList.contains("featured-card"))return On(n);if(n.classList.contains("links-card"))return Bn(n);if(n.classList.contains("promo-card"))return Fn(n);throw new c("Unsupported gnav cards section")};var Zn=({card:n},e)=>Oe(n,e),Oe=({title:n,subtitle:e,eyeBrow:a,footerCTA:r,bodyLink:t},i)=>{let o=`featured-eyebrow-${S(a)}`;return`
