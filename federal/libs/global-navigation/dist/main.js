...
`};var q={elementNull:"Error when parsing Brand. Element is null",noLinkSection:"Error when parsing Brand. No link section found",noLink:"Error when parsing Brand. No link found",noImageSection:"Error when parsing Brand. No image section found",missingImageSections:"Error when parsing Brand. Missing mobile or desktop image section",missingThemeImages:"Error when parsing Brand. Missing mobile or desktop image section"},pn=n=>{let e=new Set;if(n===null)throw new c(q.elementNull);let r=!!n.classList.contains("dark-bg"),[t,a]=n.querySelectorAll(":scope > div");if(t===void 0)throw new c(q.noLinkSection);let o=t.querySelector("a");if(o===null)throw new c(q.noLink);let i=o.getAttribute("href")??"",s=o.textContent?.trim()??"";a===void 0&&e.add(new f(q.noImageSection));let[l,d]=a?.querySelectorAll(":scope > div")??[];(l===void 0||d===void 0)&&e.add(new f(q.missingImageSections));let v=l?.querySelectorAll('a[href$=".svg"]'),y=d?.querySelectorAll('a[href$=".svg"]'),g=v?.[0]?.getAttribute("href")??"",p=v?.[0]?.textContent?.split("|")[1]?.trim()??"",u=v?.[1]?.getAttribute("href")??"",h=v?.[1]?.textContent?.split("|")[1]?.trim()??"",x=y?.[0]?.getAttribute("href")??"",m=y?.[0]?.textContent?.split("|")[1]?.trim()??"",b=y?.[1]?.getAttribute("href")??"",w=y?.[1]?.textContent?.split("|")[1]?.trim()??"";return(!g||!x||!u||!b)&&e.add(new f(q.missingThemeImages)),[{type:"Brand",data:{href:i,label:s,isDarkBg:r,imageData:{type:"svg",lightThemeImageSrc:x,lightThemeImageAlt:m,darkThemeImageSrc:b,darkThemeImageAlt:w,mobileLightThemeImageSrc:g,mobileLightThemeImageAlt:p,mobileDarkThemeImageSrc:u,mobileDarkThemeImageAlt:h}}},[...e]]};var Ee=`
<?xml
...
`.trim(),Se=n=>{let{href:e,label:r,isDarkBg:t,imageData:a}=n,o=a.lightThemeImageSrc?.trim()||a.darkThemeImageSrc?.trim()||"",i=a.darkThemeImageSrc?.trim()||a.lightThemeImageSrc?.trim()||"",s=a.mobileLightThemeImageSrc?.trim()||a.mobileDarkThemeImageSrc?.trim()||"",l=a.mobileDarkThemeImageSrc?.trim()||a.mobileLightThemeImageSrc?.trim()||"",d=a.lightThemeImageAlt||a.darkThemeImageAlt||"",v=a.darkThemeImageAlt||a.lightThemeImageAlt||"",y=a.mobileLightThemeImageAlt||a.mobileDarkThemeImageAlt||"",g=a.mobileDarkThemeImageAlt||a.mobileLightThemeImageAlt||"",p=!!o,u=!!i,h=!!s,x=!!l,m=p?`<img src="${R(o)}" alt="${d}" />`:"",b=u?`<img src="${R(i)}" alt="${v}" />`:"",w=h?`<img src="${R(s)}" alt="${y}" />`:"",U=x?`<img src="${R(l)}" alt="${g}" />`:"";return`<div class="feds-brand-container${t?" feds-dark-bg":""}">
...
`,qn=n=>n.type==="PrimaryCTA"?hn(n):I(n);var O=({text:n,href:e,daaLl:r,svgIcon:t=""})=>`<a class="feds-link" href="${E(e)}"${k(null,r??n)}>${n}${t}</a>`;var Bn=n=>{let[e,r]=Ue(n);return[{type:"LinksCard",card:e},r]},Ue=n=>{let e=n.querySelector("h2, h3, h4")||null;if(!e)throw new c("Expected links card title");let r=n.querySelector("em > a"),t=[...n.querySelectorAll("a")].filter(l=>l!==r);if(t.length===0)throw new c("Expected at least one link");let[a,o]=S(t,T),[i,s]=(()=>{try{return _(n)}catch{return[null,[]]}})();return i&&(i.daaLl=`${e.textContent??""} - ${i?.daaLl}`),[{type:"LinksCardItem",title:e.textContent??"",links:a,footerCTA:i},[...o,...s]]};var On=n=>{let e=[...n.querySelectorAll("li > div")],r=[...n.querySelectorAll("li > a")],[t,a]=S(e,De),[o,i]=S(r,T);return[{type:"ProductList",categories:t,links:o},[...a,...i]]},De=n=>{let e=n.firstElementChild;if(e?.nodeName!=="H2")throw new c("Expected H2");let r=e.textContent??"",t=e.textContent??"",a=Ln(e),[o,i]=S(a,dn);return[{type:"ProductCategory",name:r,daaLl:t,links:o},i]};var jn=n=>{let[e,r]=Ne(n);return[{type:"FeaturedCard",card:e},r]},Ne=n=>{let e=n.querySelector("h5")||null;if(!e)throw new f("Eye brow element not found");let r=n.querySelector("h4")||null,t=r?.nextElementSibling||null;if(!r)throw new c("Expected title");if(!t)throw new c("Expected subtitle");let a=t.nextElementSibling?.firstElementChild||null;if(!a)throw new c("Expected card link after subtitle");let[o,i]=T(a),[s,l]=_(n);return[{type:"Card",title:r.textContent??"",subtitle:t.textContent??"",bodyLink:o,footerCTA:s,eyeBrow:e.textContent??""},[...l,...i]]};var P={MissingBackgroundImageSection:"Promo card is missing background image section",MissingBackgroundImage:"Promo card is missing background image",MissingBackgroundImageAlt:"Promo card background image is missing alt text",MissingBackgroundImageSrc:"Promo card background image is missing src",MissingContentSection:"Promo card is missing card details section",MissingIcon:"Promo card is missing icon",MissingIconSrc:"Promo card icon is missing src",MissingIconAlt:"Promo card icon is missing alt text",MissingTitleElement:"Promo card is missing title element",MissingTitleText:"Promo card is missing title text",MissingSecondaryCtaAnchor:"Promo card is missing secondary CTA anchor",MissingPriceLink:"Promo card is missing price link"},Gn=n=>{let[e,r]=n.querySelectorAll(":scope > div"),t=new Set;if(e===void 0)throw new c(P.MissingBackgroundImageSection);let a=e.querySelector(":scope picture:not(:scope p picture) img")??null;a===null&&t.add(new f(P.MissingBackgroundImage));let o=a?.getAttribute("alt")??"";o===""&&t.add(new f(P.MissingBackgroundImageAlt));let i=a?.getAttribute("src")??"";if(i===""&&t.add(new f(P.MissingBackgroundImageSrc)),r===void 0)throw new c(P.MissingContentSection);let s=r.querySelector('a[href$=".svg"]')??null;s===null&&t.add(new f(P.MissingIcon));let[l,d]=(s?.textContent?.split("|")??["",""]).map(w=>w.trim());l===""&&t.add(new f(P.MissingIconSrc)),d===""&&t.add(new f(P.MissingIconAlt));let v=r.querySelector('p > a:not([href$=".svg"])')??null,y=v?.textContent?.trim()??"",g=v?.getAttribute("href")??"",p=g?Cn(g):!1;v===null&&t.add(new f(P.MissingPriceLink));let u=r.querySelector("p > strong")??null;if(u===null)throw new c(P.MissingTitleElement);let h=u?.textContent??"";h===""&&t.add(new f(P.MissingTitleText)),r.querySelector("em > a")===null&&t.add(new f(P.MissingSecondaryCtaAnchor));let[m,b]=(()=>{try{return _(n)}catch{return[null,[]]}})();return b.forEach(w=>t.add(w)),m&&(m.daaLl=`${h} - ${m?.daaLl}`),[{type:"PromoCard",card:{bgImageAlt:o,bgImageSrc:i,iconAlt:d,iconSrc:l,title:h,cta:m,priceText:y,priceHref:g,isPriceMerchLink:p}},[...t]]};var Wn=n=>{let e=new Set;if(n===null)throw new c(Fn.elementNull);let r=n.querySelector("h2")?.textContent??"";r===""&&e.add(new f(Fn.noTitle));let t=(async()=>{try{let a=n.querySelector("a"),o=new URL(a?.href??""),i=await D(o);if(i instanceof c)throw new Error(i.message);let s=await Pn(i);if(s instanceof c)throw new Error(s.message);return Mn(o.href,s),n.classList.contains("product-list")?On(s):qe(s)}catch(a){throw new c(a?.message)}})();if(t instanceof c)throw t;return[{type:"MegaMenu",title:r,content:t},[...e]]},Fn={elementNull:"Element is null",noTitle:"Large Menu has no Title"},qe=n=>{let e=[...n.children];if(e.length===0)throw new c("No mega menu items found (did you forget to add them correctly?)");let[r,t]=S(e,a=>Be(a));if(r.length===0)throw new c("Failed to parse gnav cards sections");return[{type:"GnavCards",sections:r},t]},Be=n=>{let e=[...n.querySelectorAll(".featured-card, .links-card, .promo-card")];if(e.length===0)throw new c("Column contains no cards (did you forget to label them correctly?)");let[r,t]=S(e,a=>Oe(a));if(r.length===0)throw new c("Failed to parse cards in column");return[{type:"GnavColumn",cards:r},t]},Oe=n=>{if(n.classList.contains("featured-card"))return jn(n);if(n.classList.contains("links-card"))return Bn(n);if(n.classList.contains("promo-card"))return Gn(n);throw new c("Unsupported gnav cards section")};var Zn=({card:n})=>je(n),je=({title:n,subtitle:e,eyeBrow:r,footerCTA:t,bodyLink:a})=>`
...
`.trim();var Kn=({card:n})=>Fe(n),Fe=({bgImageAlt:n,bgImageSrc:e,iconAlt:r,iconSrc:t,title:a,cta:o,priceText:i,priceHref:s,isPriceMerchLink:l})=>`
...
`,Qn=(n,e,r)=>{let t=`
  ...
  `.trim(),i="";switch(n.type){case"ProductList":i=Yn(n);break;case"GnavCards":i=Vn(n);break;default:}return`${o}${i}`};var ne={elementNull:"Error when parsing text. Element is null",textContentNull:"Error when parsing text. Element has no textContent"},ee=n=>{if(n===null)return[{type:"Text",content:""},[new f(ne.elementNull,"Minor")]];let e=n.textContent;return e===null?[{type:"Text",content:""},[new f(ne.textContentNull,"Minor")]]:[{type:"Text",content:e},[]]};var re=({content:n})=>n;var te=n=>{if(n===null)throw new c(Xe.elementNull);let e=n.querySelector(".gnav-brand");if(e!==null)return pn(e);let r=n.querySelector(".large-menu");return r!==null?Wn(r):n.querySelector("strong")!==null?vn(n):n.querySelector("em")!==null?_(n):n.querySelector("a")===null?ee(n):T(n.querySelector("a"))},bn=(n,e)=>{switch(n.type){case"Text":return re(n);case"Link":return O(n);case"SecondaryCTA":return I(n);case"PrimaryCTA":return hn(n);case"Brand":return gn(n);case"MegaMenu":return Jn(n,e);default:return console.error(`Failed to recognize component: ${n}`),""}},Xe={elementNull:"Element is null"};var ae=(n,e)=>{let[r,t]=S([...document.querySelectorAll(".breadcrumbs ul > li > a")??[]],T),[a,o]=S([...n.children],te),i=n.querySelector(".product-entry-cta"),[s,l]=(()=>{try{return Nn(i)}catch{return[null,[]]}})(),d=!1,v=[t,o,l].flat();return{breadcrumbs:r,components:a,productCTA:s,localnav:d,errors:v,unavEnabled:e}};var oe=n=>{let e=[...n.querySelectorAll('.tabs button[role="tab"]')],r=[...n.querySelectorAll(".tab-content ul")],t=e.map((a,o)=>()=>{let i=r[o].closest(":popover-open");if(e.forEach(d=>{d.setAttribute("aria-selected","false")}),r.forEach(d=>{d.setAttribute("hidden","true")}),r[o]?.removeAttribute("hidden"),a.setAttribute("aria-selected","true"),!i||!A.matches)return;let s=ie();if(!s)return;let l=i?.clientHeight??0;s.style.height=`${l+72}px`});return e.forEach((a,o)=>{a.addEventListener("click",t[o])}),Ke(n),()=>{e.forEach((a,o)=>{a.removeEventListener("click",t[o])})}},ie=()=>[...document.adoptedStyleSheets.flatMap(n=>[...n.cssRules])].find(n=>n?.selectorText==="header.global-navigation nav::after"),Ke=n=>{let e=[...n.querySelectorAll(".feds-gnav-items > li > button")],r=n.querySelector(".feds-gnav-items"),t=ie(),a=new ResizeObserver(o=>{if(o.length<1)return;let i=n.querySelector(".feds-popup:popover-open");if(!i){t.style.height="100%";return}let l=i.clientHeight<1?"100%":`${i.clientHeight+72}px`;t.style.height=l});e.forEach(o=>{if(!t)return;let i=o.nextElementSibling;i&&(a.observe(i),i.addEventListener("toggle",s=>{s.newState!=="open"&&!n.querySelector(".feds-popup:popover-open")?t.style.height="100%":t.style.height=`${i.clientHeight+72}px`}))}),e.forEach(o=>{o.addEventListener("click",()=>{if(A.matches||!r)return;let i=o.nextElementSibling;i&&(r.classList.remove("subscreen-closing"),r.classList.add("subscreen-opening"),i.querySelector(".feds-popup-back-button")?.addEventListener("click",()=>{r.classList.remove("subscreen-opening"),r.classList.add("subscreen-closing"),setTimeout(()=>i.hidePopover(),240)}))})}),A.addEventListener("change",()=>{r?.classList.remove("subscreen-opening"),r?.classList.remove("subscreen-closing")}),n.querySelector(".feds-nav-toggle")?.addEventListener("click",()=>{r?.classList.remove("subscreen-opening"),r?.classList.remove("subscreen-closing")})};var se=async n=>{let e=new Set,r=n.querySelectorAll("a.merch");if(r.length===0)return e;try{let t=C(),{base:a}=t;if(!a)return e.add(new f("base not found in config, cannot initialize merch links")),e;let o=await import(`${a}/blocks/merch/merch.js`),{default:i}=o;if(!i)return e.add(new f("decorateMerchLink not found in merch module")),e;r.forEach(s=>{i(s)})}catch(t){e.add(new f(`Error initializing merch links: ${t}`))}return e};var le=async({gnavSource:n,asideSource:e})=>{let r=await D(n);if(r instanceof c)return r;let t=await D(e);return{mainNav:r,aside:t}};var Ve=`/**
...
`,de=document.createElement("style");de.textContent=Ve;document.head.appendChild(de);var xo=async n=>{let{gnavSource:e,mountpoint:r,unavEnabled:t,miloConfig:a,personalization:o}=n;if(!(e instanceof URL))throw L(`gnavSource is invalid: ${e}`),new c("gnavSource needs to be a URL object");try{ln(a)}catch(v){throw L(`Failed to initialize MiloConfig: ${v}`),new c(`Failed to initialize MiloConfig: ${v}`)}En(o),Tn(n.localizeLink??(v=>v)),wn(yn(n));let i=await le(n);if(i instanceof c)throw L(i.message),i;let{mainNav:s,aside:l}=i;if(s instanceof c)throw L(s.message),s;let d=ae(s,t);if(d instanceof c)throw L(d.message),d;return await Ye(d)(r),Qe(n)},Ye=n=>async e=>{let r=Je(n);e.innerHTML=r,e.classList.add("site-pivot");let t=[...e.querySelectorAll(".mega-menu ~ .feds-popup")];t.forEach(s=>{s.innerHTML=""});let a=n.components.filter(s=>s.type==="MegaMenu"),o=a.map(s=>s.content),i=await Promise.all(o.map(async(s,l)=>{let[d,v]=await s,y=a[l].title;return t[l].innerHTML=Qn(d,t[l].id,y),v}).flat());return e},Je=({components:n,productCTA:e,unavEnabled:r})=>`
<nav>
  <ul>
...
`,Qe=async n=>{let e=new Set,r=await rn(n.mountpoint);r instanceof f?(e.add(r),L(r.message)):r.errors.forEach(o=>e.add(o)),oe(n.mountpoint),mn(n.mountpoint),nr(n.mountpoint),er(n.mountpoint),rr(n.mountpoint),ar(n.mountpoint),or(n.mountpoint,n.mepMartech??""),window.addEventListener("milo:modal:loaded",()=>{document.querySelector("nav[popover]")?.removeAttribute("popover")}),window.addEventListener("milo:modal:closed",()=>{let o=document.querySelector("nav");o?.setAttribute("popover","manual"),o?.showPopover?.()}),(await se(n.mountpoint)).forEach(o=>{e.add(o),L(o.message)});let a=r instanceof f?()=>{}:r.reloadUnav;return{closeEverything:tr,reloadUnav:a,errors:e,setGnavTopPosition:o=>{},getGnavTopPosition:()=>0}},nr=n=>{let e=n.querySelector("#feds-menu-wrapper"),r=n.querySelector(".feds-nav-toggle");e?.addEventListener("toggle",()=>{let a=e.matches(":popover-open");r?.setAttribute("aria-expanded",String(a)),r?.setAttribute("daa-ll",a?"hamburgermenu|close":"hamburgermenu|open"),e.setAttribute("aria-hidden",String(!a)),a&&e.classList.add("feds-menu-active")}),e?.addEventListener("transitionend",()=>{e.matches(":popover-open")||e.classList.remove("feds-menu-active")}),n.querySelectorAll(".feds-popup[popover]").forEach(a=>{a.addEventListener("toggle",()=>{let o=n.querySelector(`[popovertarget="${a.id}"]`),i=a.matches(":popover-open");o?.setAttribute("aria-expanded",String(i)),o?.setAttribute("daa-ll",i?"header|Close":"header|Open")})})},er=n=>{A.addEventListener("change",()=>{K(n)})},rr=n=>{[...n.querySelector(".feds-utilities #universal-nav")?.children??[]].forEach(e=>{e.addEventListener("click",()=>K(n)),e.addEventListener("keydown",r=>{r.key==="Enter"&&K(n)})})};var tr=()=>{},ar=n=>{let e=n.closest("header");if(!e)return;let r=n.querySelector("#feds-menu-wrapper"),t=()=>r?.matches(":popover-open")??!1,a=()=>window.scrollY>100,o=()=>{if(t()){e.classList.remove("feds-header-scrolled");return}if(a()){e.classList.add("feds-header-scrolled");return}e.classList.remove("feds-header-scrolled")};o(),window.addEventListener("scroll",o,{passive:!0}),r?.addEventListener("toggle",o)},or=(n,e)=>{let r=n.closest("header");r!==null&&r.setAttribute("daa-lh",`gnav|${$n()}${e}`)};export{xo as main,Qe as postRenderingTasks,Ye as renderGnav,Je as renderGnavString};
